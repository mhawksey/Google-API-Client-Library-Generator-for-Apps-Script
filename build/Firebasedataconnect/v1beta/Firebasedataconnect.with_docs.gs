...
class Firebasedataconnect {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.executeGraphql = (params) => this._makeRequest('v1beta/{+name}:executeGraphql', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.executeGraphqlRead = (params) => this._makeRequest('v1beta/{+name}:executeGraphqlRead', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.executeQuery = (params) => this._makeRequest('v1beta/{+name}:executeQuery', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.executeMutation = (params) => this._makeRequest('v1beta/{+name}:executeMutation', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.list = (params) => this._makeRequest('v1beta/{+parent}/connectors', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.create = (params) => this._makeRequest('v1beta/{+parent}/connectors', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.connectors.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.schemas.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.schemas.list = (params) => this._makeRequest('v1beta/{+parent}/schemas', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.schemas.create = (params) => this._makeRequest('v1beta/{+parent}/schemas', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.schemas.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.schemas.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
  }
