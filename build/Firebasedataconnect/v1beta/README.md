# Firebase SQL Connect API - Apps Script Client Library

Auto-generated client library for using the **Firebase SQL Connect API (version: v1beta)** in Google Apps Script.

## Metadata

- **Last Checked:** Tue, 30 Jun 2026 23:53:50 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:53:50 GMT
...
#### `projects.locations.services.generateQuery()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The resource name of the service in which to generate the query. Format: projects/{project}/locations/{location}/services/{service} |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.services.generateSchema()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The resource name of the service in which to generate the schema. Format: projects/{project}/locations/{location}/services/{service} |
| `params.requestBody` | `object` | Yes | The request body. |
