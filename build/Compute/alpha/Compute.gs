...
class Compute {
  ...
  constructor(config = {}) {
    ...
    this._servicePath = 'compute/alpha/';
    ...
    this.globalAddresses.getOwnerInstance = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/addresses/getOwnerInstance', 'GET', apiParams, clientConfig);
    ...
    this.folderZoneVmExtensionPolicies = {};
    this.folderZoneVmExtensionPolicies.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensionPolicies', 'GET', apiParams, clientConfig);
    this.folderZoneVmExtensionPolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensionPolicies/{vmExtensionPolicy}', 'DELETE', apiParams, clientConfig);
    this.folderZoneVmExtensionPolicies.getVmExtension = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensions/{extensionName}', 'GET', apiParams, clientConfig);
    this.folderZoneVmExtensionPolicies.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensionPolicies', 'POST', apiParams, clientConfig);
    this.folderZoneVmExtensionPolicies.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensionPolicies/{vmExtensionPolicy}', 'GET', apiParams, clientConfig);
    this.folderZoneVmExtensionPolicies.update = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensionPolicies/{vmExtensionPolicy}', 'PATCH', apiParams, clientConfig);
    this.folderZoneVmExtensionPolicies.listVmExtensions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/vmExtensions', 'GET', apiParams, clientConfig);

    this.projects = {};
    this.projects.setDefaultServiceAccount = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/setDefaultServiceAccount', 'POST', apiParams, clientConfig);
    ...
    this.snapshots.updateKmsKey = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshots/{snapshot}/updateKmsKey', 'POST', apiParams, clientConfig);
    ...
    this.snapshots.getEffectiveRecycleBinRule = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshots/{snapshot}/getEffectiveRecycleBinRule', 'GET', apiParams, clientConfig);
    ...
    this.interconnectAttachmentGroups.createMembers = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/interconnectAttachmentGroups/{interconnectAttachmentGroup}/createMembers', 'POST', apiParams, clientConfig);
    ...
    this.regionInstantSnapshotGroups.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups', 'GET', apiParams, clientConfig);
    this.regionInstantSnapshotGroups.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    this.regionInstantSnapshotGroups.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    this.regionInstantSnapshotGroups.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{instantSnapshotGroup}', 'DELETE', apiParams, clientConfig);
    this.regionInstantSnapshotGroups.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{resource}/testIamPermissions', 'POST', apiParams, clientConfig);
    this.regionInstantSnapshotGroups.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups', 'POST', apiParams, clientConfig);
    this.regionInstantSnapshotGroups.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{instantSnapshotGroup}', 'GET', apiParams, clientConfig);

    this.zoneFolderOperations = {};
    this.zoneFolderOperations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/operations', 'GET', apiParams, clientConfig);
    this.zoneFolderOperations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/zones/{zone}/operations/{operation}', 'GET', apiParams, clientConfig);
    ...
    this.licenseCodes.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/licenseCodes/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    this.licenseCodes.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/licenseCodes/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    ...
    this.snapshotRecycleBinPolicy = {};
    this.snapshotRecycleBinPolicy.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotRecycleBinPolicy', 'PATCH', apiParams, clientConfig);
    this.snapshotRecycleBinPolicy.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotRecycleBinPolicy', 'GET', apiParams, clientConfig);

    this.recoverableSnapshots = {};
    this.recoverableSnapshots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{recoverableSnapshot}', 'GET', apiParams, clientConfig);
    this.recoverableSnapshots.recover = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{recoverableSnapshot}/recover', 'POST', apiParams, clientConfig);
    this.recoverableSnapshots.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{recoverableSnapshot}', 'DELETE', apiParams, clientConfig);
    this.recoverableSnapshots.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/aggregated/recoverableSnapshots', 'GET', apiParams, clientConfig);
    this.recoverableSnapshots.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{resource}/testIamPermissions', 'POST', apiParams, clientConfig);
    this.recoverableSnapshots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots', 'GET', apiParams, clientConfig);
    this.recoverableSnapshots.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    this.recoverableSnapshots.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    ...
    this.organizationRollouts = {};
    this.organizationRollouts.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts', 'GET', apiParams, clientConfig);
    this.organizationRollouts.pause = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts/{rollout}/pause', 'POST', apiParams, clientConfig);
    this.organizationRollouts.advance = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts/{rollout}/advance', 'POST', apiParams, clientConfig);
    this.organizationRollouts.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts/{rollout}', 'DELETE', apiParams, clientConfig);
    this.organizationRollouts.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts/{rollout}', 'PATCH', apiParams, clientConfig);
    this.organizationRollouts.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts/{rollout}', 'GET', apiParams, clientConfig);
    this.organizationRollouts.resume = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rollouts/{rollout}/resume', 'POST', apiParams, clientConfig);
    ...
    this.zoneOrganizationOperations = {};
    this.zoneOrganizationOperations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/operations/{operation}', 'GET', apiParams, clientConfig);
    this.zoneOrganizationOperations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/operations', 'GET', apiParams, clientConfig);
    ...
    this.organizationSnapshotRecycleBinPolicy.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/snapshotRecycleBinPolicy', 'GET', apiParams, clientConfig);
    this.organizationSnapshotRecycleBinPolicy.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/snapshotRecycleBinPolicy', 'PATCH', apiParams, clientConfig);
    ...
    this.regionDisks.updateKmsKey = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/disks/{disk}/updateKmsKey', 'POST', apiParams, clientConfig);
    ...
    this.regionDisks.waitForReplicationCatchUp = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/disks/{disk}/waitForReplicationCatchUp', 'POST', apiParams, clientConfig);
    ...
    this.regionDisks.getAsyncReplicationStatus = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/disks/{disk}/getAsyncReplicationStatus', 'GET', apiParams, clientConfig);
    ...
    this.instances.listVmExtensionStates = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instances/{instance}/vmExtensionStates', 'GET', apiParams, clientConfig);
    ...
    this.instances.getVmExtensionState = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instances/{instance}/vmExtensionStates/{extensionName}', 'GET', apiParams, clientConfig);
    ...
    this.organizationZoneVmExtensionPolicies = {};
    this.organizationZoneVmExtensionPolicies.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensionPolicies', 'GET', apiParams, clientConfig);
    this.organizationZoneVmExtensionPolicies.getVmExtension = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensions/{extensionName}', 'GET', apiParams, clientConfig);
    this.organizationZoneVmExtensionPolicies.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensionPolicies', 'POST', apiParams, clientConfig);
    this.organizationZoneVmExtensionPolicies.update = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensionPolicies/{vmExtensionPolicy}', 'PATCH', apiParams, clientConfig);
    this.organizationZoneVmExtensionPolicies.listVmExtensions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensions', 'GET', apiParams, clientConfig);
    this.organizationZoneVmExtensionPolicies.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensionPolicies/{vmExtensionPolicy}', 'GET', apiParams, clientConfig);
    ...
    this.storagePools.setLabels = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/storagePools/{resource}/setLabels', 'POST', apiParams, clientConfig);
    ...
    this.regionCommitments.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/commitments/{commitment}/cancel', 'POST', apiParams, clientConfig);
    this.regionCommitments.calculateCancellationFee = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/commitments/{commitment}/calculateCancellationFee', 'POST', apiParams, clientConfig);
    ...
    this.folderGlobalVmExtensionPolicies = {};
    this.folderGlobalVmExtensionPolicies.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensionPolicies', 'GET', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/aggregated/vmExtensionPolicies', 'GET', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensionPolicies/{globalVmExtensionPolicy}/delete', 'POST', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.getVmExtension = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensions/{extensionName}', 'GET', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensionPolicies', 'POST', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensionPolicies/{globalVmExtensionPolicy}', 'GET', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.update = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensionPolicies/{globalVmExtensionPolicy}', 'PATCH', apiParams, clientConfig);
    this.folderGlobalVmExtensionPolicies.listVmExtensions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/vmExtensions', 'GET', apiParams, clientConfig);
    ...
    this.reservationSubBlocks.getVersion = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{+parentName}/reservationSubBlocks/{reservationSubBlock}/getVersion', 'POST', apiParams, clientConfig);
    this.reservationSubBlocks.update = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{+parentName}/reservationSubBlocks/{reservationSubBlock}', 'PATCH', apiParams, clientConfig);
    ...
    this.firewallPolicies.forceStartProgressiveRollout = async (apiParams = {}, clientConfig = {}) => this._makeRequest('locations/global/firewallPolicies/{firewallPolicy}/forceStartProgressiveRollout', 'POST', apiParams, clientConfig);
    ...
    this.instantSnapshotGroups = {};
    this.instantSnapshotGroups.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups', 'GET', apiParams, clientConfig);
    this.instantSnapshotGroups.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    this.instantSnapshotGroups.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    this.instantSnapshotGroups.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{instantSnapshotGroup}', 'DELETE', apiParams, clientConfig);
    this.instantSnapshotGroups.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/testIamPermissions', 'POST', apiParams, clientConfig);
    this.instantSnapshotGroups.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups', 'POST', apiParams, clientConfig);
    this.instantSnapshotGroups.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{instantSnapshotGroup}', 'GET', apiParams, clientConfig);
    ...
    this.orgVmExtensionPolicies = {};
    this.orgVmExtensionPolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/zones/{zone}/vmExtensionPolicies/{vmExtensionPolicy}', 'DELETE', apiParams, clientConfig);
    ...
    this.networks.listIpAddresses = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/networks/{network}/listIpAddresses', 'GET', apiParams, clientConfig);
    ...
    this.networks.listIpOwners = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/networks/{network}/listIpOwners', 'GET', apiParams, clientConfig);
    ...
    this.rollouts.resume = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/rollouts/{rollout}/resume', 'POST', apiParams, clientConfig);
    ...
    this.rollouts.pause = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/rollouts/{rollout}/pause', 'POST', apiParams, clientConfig);
    this.rollouts.advance = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/rollouts/{rollout}/advance', 'POST', apiParams, clientConfig);
    ...
    this.snapshotGroups = {};
    this.snapshotGroups.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    this.snapshotGroups.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups', 'GET', apiParams, clientConfig);
    this.snapshotGroups.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    this.snapshotGroups.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups/{resource}/testIamPermissions', 'POST', apiParams, clientConfig);
    this.snapshotGroups.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups/{snapshotGroup}', 'DELETE', apiParams, clientConfig);
    this.snapshotGroups.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups', 'POST', apiParams, clientConfig);
    this.snapshotGroups.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/snapshotGroups/{snapshotGroup}', 'GET', apiParams, clientConfig);
    ...
    this.globalVmExtensionPolicies.listVmExtensions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/vmExtensions', 'GET', apiParams, clientConfig);
    ...
    this.globalVmExtensionPolicies.getVmExtension = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/vmExtensions/{extensionName}', 'GET', apiParams, clientConfig);
    ...
    this.regionSnapshots.updateKmsKey = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/snapshots/{snapshot}/updateKmsKey', 'POST', apiParams, clientConfig);
    ...
    this.networkFirewallPolicies.patchAssociation = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/firewallPolicies/{firewallPolicy}/patchAssociation', 'POST', apiParams, clientConfig);
    ...
    this.zoneVmExtensionPolicies.getVmExtension = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/vmExtensions/{extensionName}', 'GET', apiParams, clientConfig);
    ...
    this.zoneVmExtensionPolicies.listVmExtensions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/vmExtensions', 'GET', apiParams, clientConfig);
    ...
    this.haControllers = {};
    this.haControllers.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/haControllers', 'GET', apiParams, clientConfig);
    this.haControllers.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/aggregated/haControllers', 'GET', apiParams, clientConfig);
    this.haControllers.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/haControllers/{haController}', 'DELETE', apiParams, clientConfig);
    this.haControllers.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/haControllers', 'POST', apiParams, clientConfig);
    this.haControllers.failover = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/haControllers/{haController}/failover', 'POST', apiParams, clientConfig);
    this.haControllers.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/haControllers/{haController}', 'GET', apiParams, clientConfig);
    this.haControllers.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/haControllers/{haController}', 'PATCH', apiParams, clientConfig);
    ...
    this.globalFolderOperations = {};
    this.globalFolderOperations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/operations/{operation}', 'GET', apiParams, clientConfig);
    this.globalFolderOperations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+folder}/global/operations', 'GET', apiParams, clientConfig);
    ...
    this.routers = {};
    this.routers.getNamedSet = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/getNamedSet', 'GET', apiParams, clientConfig);
    ...
    this.routers.patchNamedSet = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/patchNamedSet', 'POST', apiParams, clientConfig);
    this.routers.updateNamedSet = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/updateNamedSet', 'POST', apiParams, clientConfig);
    ...
    this.routers.deleteNamedSet = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/deleteNamedSet', 'POST', apiParams, clientConfig);
    ...
    this.routers.listNamedSets = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/listNamedSets', 'GET', apiParams, clientConfig);
    ...
    this.zoneQueuedResources = {};
    this.zoneQueuedResources.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources', 'GET', apiParams, clientConfig);
    this.zoneQueuedResources.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/aggregated/queuedResources', 'GET', apiParams, clientConfig);
    this.zoneQueuedResources.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources/{queuedResource}', 'DELETE', apiParams, clientConfig);
    this.zoneQueuedResources.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources', 'POST', apiParams, clientConfig);
    this.zoneQueuedResources.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources/{queuedResource}', 'GET', apiParams, clientConfig);
    this.zoneQueuedResources.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources/{queuedResource}/cancel', 'POST', apiParams, clientConfig);
    ...
    this.instanceGroupManagers.configureAcceleratorTopologies = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/configureAcceleratorTopologies', 'POST', apiParams, clientConfig);
    ...
    this.regionRecoverableSnapshots = {};
    this.regionRecoverableSnapshots.recover = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots/{recoverableSnapshot}/recover', 'POST', apiParams, clientConfig);
    this.regionRecoverableSnapshots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots/{recoverableSnapshot}', 'GET', apiParams, clientConfig);
    this.regionRecoverableSnapshots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots', 'GET', apiParams, clientConfig);
    this.regionRecoverableSnapshots.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    this.regionRecoverableSnapshots.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    this.regionRecoverableSnapshots.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots/{recoverableSnapshot}', 'DELETE', apiParams, clientConfig);
    this.regionRecoverableSnapshots.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/recoverableSnapshots/{resource}/testIamPermissions', 'POST', apiParams, clientConfig);
    ...
    this.interconnectAttachments.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/interconnectAttachments/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    ...
    this.interconnectAttachments.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/interconnectAttachments/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.organizationGlobalVmExtensionPolicies = {};
    this.organizationGlobalVmExtensionPolicies.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/aggregated/vmExtensionPolicies', 'GET', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensionPolicies/{globalVmExtensionPolicy}/delete', 'POST', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.getVmExtension = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensions/{extensionName}', 'GET', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensionPolicies', 'GET', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensionPolicies/{globalVmExtensionPolicy}', 'GET', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.update = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensionPolicies/{globalVmExtensionPolicy}', 'PATCH', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.listVmExtensions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensions', 'GET', apiParams, clientConfig);
    this.organizationGlobalVmExtensionPolicies.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/vmExtensionPolicies', 'POST', apiParams, clientConfig);
    ...
    this.regionCompositeHealthChecks.getHealth = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks/{compositeHealthCheck}/getHealth', 'GET', apiParams, clientConfig);

    this.regionNotificationEndpoints = {};
    this.regionNotificationEndpoints.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/aggregated/notificationEndpoints', 'GET', apiParams, clientConfig);
    ...
    this.organizationRolloutPlans = {};
    this.organizationRolloutPlans.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rolloutPlans/{rolloutPlan}', 'DELETE', apiParams, clientConfig);
    this.organizationRolloutPlans.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rolloutPlans/{rolloutPlan}', 'GET', apiParams, clientConfig);
    this.organizationRolloutPlans.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rolloutPlans', 'GET', apiParams, clientConfig);
    this.organizationRolloutPlans.insert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+organization}/global/rolloutPlans', 'POST', apiParams, clientConfig);
    ...
    this.regionHealthSources.getHealth = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/healthSources/{healthSource}/getHealth', 'GET', apiParams, clientConfig);
    ...
    this.regionHealthCheckServices.aggregatedList = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/aggregated/healthCheckServices', 'GET', apiParams, clientConfig);
    ...
    this.reservationSlots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{+parentName}/reservationSlots', 'GET', apiParams, clientConfig);
    this.reservationSlots.getVersion = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{+parentName}/reservationSlots/{reservationSlot}/getVersion', 'POST', apiParams, clientConfig);
    this.reservationSlots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{+parentName}/reservationSlots/{reservationSlot}', 'GET', apiParams, clientConfig);
    this.reservationSlots.update = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{+parentName}/reservationSlots/{reservationSlot}', 'POST', apiParams, clientConfig);
    ...
    this.disks.updateKmsKey = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/disks/{disk}/updateKmsKey', 'POST', apiParams, clientConfig);
    ...
    this.disks.getAsyncReplicationStatus = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/disks/{disk}/getAsyncReplicationStatus', 'GET', apiParams, clientConfig);
    this.disks.convert = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/disks/{disk}/convert', 'POST', apiParams, clientConfig);
    ...
    this.disks.waitForReplicationCatchUp = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/disks/{disk}/waitForReplicationCatchUp', 'POST', apiParams, clientConfig);
    ...
    this.interconnects.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/interconnects/{resource}/setIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.interconnects.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/interconnects/{resource}/getIamPolicy', 'GET', apiParams, clientConfig);
    ...
    this.imageViews = {};
    this.imageViews.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/imageViews/{resourceId}', 'GET', apiParams, clientConfig);
    this.imageViews.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/imageViews', 'GET', apiParams, clientConfig);
    ...
    this.reliabilityRisks.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/reliabilityRisks', 'GET', apiParams, clientConfig);
    this.reliabilityRisks.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/reliabilityRisks/{reliabilityRisk}', 'GET', apiParams, clientConfig);
    ...
    this.regionMultiMigMembers = {};
    this.regionMultiMigMembers.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/multiMigs/{multiMig}/multiMigMembers/{multiMigMember}', 'GET', apiParams, clientConfig);
    this.regionMultiMigMembers.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/multiMigs/{multiMig}/multiMigMembers', 'GET', apiParams, clientConfig);

    this.advice = {};
    this.advice.capacityHistory = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/advice/capacityHistory', 'POST', apiParams, clientConfig);
    ...
    this.advice.capacity = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/advice/capacity', 'POST', apiParams, clientConfig);
    ...
    this.hosts = {};
    this.hosts.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{association}/hosts', 'GET', apiParams, clientConfig);
    this.hosts.getVersion = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{association}/hosts/{host}/getVersion', 'POST', apiParams, clientConfig);
    this.hosts.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/zones/{zone}/{association}/hosts/{host}', 'GET', apiParams, clientConfig);

    this.projectViews = {};
    this.projectViews.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/regions/{region}/projectViews', 'GET', apiParams, clientConfig);
