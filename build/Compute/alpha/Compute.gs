...
class Compute {
  ...
  constructor(config = {}) {
    ...
    this.globalAddresses.getOwnerInstance = (params) => this._makeRequest('projects/{project}/global/addresses/getOwnerInstance', 'GET', params);
    ...
    this.disks.waitForReplicationCatchUp = (params) => this._makeRequest('projects/{project}/zones/{zone}/disks/{disk}/waitForReplicationCatchUp', 'POST', params);
    ...
    this.disks.getAsyncReplicationStatus = (params) => this._makeRequest('projects/{project}/zones/{zone}/disks/{disk}/getAsyncReplicationStatus', 'GET', params);
    ...
    this.regionDisks.getAsyncReplicationStatus = (params) => this._makeRequest('projects/{project}/regions/{region}/disks/{disk}/getAsyncReplicationStatus', 'GET', params);
    this.regionDisks.waitForReplicationCatchUp = (params) => this._makeRequest('projects/{project}/regions/{region}/disks/{disk}/waitForReplicationCatchUp', 'POST', params);
    ...
    this.networkFirewallPolicies.patchAssociation = (params) => this._makeRequest('projects/{project}/global/firewallPolicies/{firewallPolicy}/patchAssociation', 'POST', params);
    ...
    this.zoneQueuedResources.list = (params) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources', 'GET', params);
    this.zoneQueuedResources.aggregatedList = (params) => this._makeRequest('projects/{project}/aggregated/queuedResources', 'GET', params);
    this.zoneQueuedResources.get = (params) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources/{queuedResource}', 'GET', params);
    this.zoneQueuedResources.insert = (params) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources', 'POST', params);
    this.zoneQueuedResources.cancel = (params) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources/{queuedResource}/cancel', 'POST', params);
    this.zoneQueuedResources.delete = (params) => this._makeRequest('projects/{project}/zones/{zone}/queuedResources/{queuedResource}', 'DELETE', params);
    ...
    this.regionBackendBuckets.list = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets', 'GET', params);
    this.regionBackendBuckets.listUsable = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/listUsable', 'GET', params);
    this.regionBackendBuckets.get = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/{backendBucket}', 'GET', params);
    this.regionBackendBuckets.insert = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets', 'POST', params);
    this.regionBackendBuckets.delete = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/{backendBucket}', 'DELETE', params);
    this.regionBackendBuckets.patch = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/{backendBucket}', 'PATCH', params);
    this.regionBackendBuckets.getIamPolicy = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/{resource}/getIamPolicy', 'GET', params);
    this.regionBackendBuckets.setIamPolicy = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/{resource}/setIamPolicy', 'POST', params);
    this.regionBackendBuckets.testIamPermissions = (params) => this._makeRequest('projects/{project}/regions/{region}/backendBuckets/{resource}/testIamPermissions', 'POST', params);
    ...
    this.regionCompositeHealthChecks.aggregatedList = (params) => this._makeRequest('projects/{project}/aggregated/compositeHealthChecks', 'GET', params);
    this.regionCompositeHealthChecks.list = (params) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks', 'GET', params);
    this.regionCompositeHealthChecks.get = (params) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks/{compositeHealthCheck}', 'GET', params);
    this.regionCompositeHealthChecks.insert = (params) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks', 'POST', params);
    this.regionCompositeHealthChecks.delete = (params) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks/{compositeHealthCheck}', 'DELETE', params);
    this.regionCompositeHealthChecks.patch = (params) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks/{compositeHealthCheck}', 'PATCH', params);
    this.regionCompositeHealthChecks.testIamPermissions = (params) => this._makeRequest('projects/{project}/regions/{region}/compositeHealthChecks/{resource}/testIamPermissions', 'POST', params);

    this.advice = {};
    this.advice.calendarMode = (params) => this._makeRequest('projects/{project}/regions/{region}/advice/calendarMode', 'POST', params);
    this.advice.capacity = (params) => this._makeRequest('projects/{project}/regions/{region}/advice/capacity', 'POST', params);
    ...
    this.regionCommitments.cancel = (params) => this._makeRequest('projects/{project}/regions/{region}/commitments/{commitment}/cancel', 'POST', params);
    this.regionCommitments.calculateCancellationFee = (params) => this._makeRequest('projects/{project}/regions/{region}/commitments/{commitment}/calculateCancellationFee', 'POST', params);
    ...
    this.interconnectAttachments.getIamPolicy = (params) => this._makeRequest('projects/{project}/regions/{region}/interconnectAttachments/{resource}/getIamPolicy', 'GET', params);
    this.interconnectAttachments.setIamPolicy = (params) => this._makeRequest('projects/{project}/regions/{region}/interconnectAttachments/{resource}/setIamPolicy', 'POST', params);
    ...
    this.interconnectAttachmentGroups.createMembers = (params) => this._makeRequest('projects/{project}/global/interconnectAttachmentGroups/{interconnectAttachmentGroup}/createMembers', 'POST', params);
    ...
    this.interconnects.getIamPolicy = (params) => this._makeRequest('projects/{project}/global/interconnects/{resource}/getIamPolicy', 'GET', params);
    this.interconnects.setIamPolicy = (params) => this._makeRequest('projects/{project}/global/interconnects/{resource}/setIamPolicy', 'POST', params);
    ...
    this.regionHealthAggregationPolicies.list = (params) => this._makeRequest('projects/{project}/regions/{region}/healthAggregationPolicies', 'GET', params);
    this.regionHealthAggregationPolicies.get = (params) => this._makeRequest('projects/{project}/regions/{region}/healthAggregationPolicies/{healthAggregationPolicy}', 'GET', params);
    this.regionHealthAggregationPolicies.insert = (params) => this._makeRequest('projects/{project}/regions/{region}/healthAggregationPolicies', 'POST', params);
    ...
    this.regionHealthSources.aggregatedList = (params) => this._makeRequest('projects/{project}/aggregated/healthSources', 'GET', params);
    this.regionHealthSources.list = (params) => this._makeRequest('projects/{project}/regions/{region}/healthSources', 'GET', params);
    this.regionHealthSources.get = (params) => this._makeRequest('projects/{project}/regions/{region}/healthSources/{healthSource}', 'GET', params);
    this.regionHealthSources.insert = (params) => this._makeRequest('projects/{project}/regions/{region}/healthSources', 'POST', params);
    this.regionHealthSources.delete = (params) => this._makeRequest('projects/{project}/regions/{region}/healthSources/{healthSource}', 'DELETE', params);
    this.regionHealthSources.patch = (params) => this._makeRequest('projects/{project}/regions/{region}/healthSources/{healthSource}', 'PATCH', params);
    this.regionHealthSources.testIamPermissions = (params) => this._makeRequest('projects/{project}/regions/{region}/healthSources/{resource}/testIamPermissions', 'POST', params);
    ...
    this.instantSnapshotGroups.insert = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups', 'POST', params);
    this.instantSnapshotGroups.get = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{instantSnapshotGroup}', 'GET', params);
    this.instantSnapshotGroups.list = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups', 'GET', params);
    this.instantSnapshotGroups.delete = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{instantSnapshotGroup}', 'DELETE', params);
    this.instantSnapshotGroups.getIamPolicy = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/getIamPolicy', 'GET', params);
    this.instantSnapshotGroups.setIamPolicy = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/setIamPolicy', 'POST', params);
    this.instantSnapshotGroups.testIamPermissions = (params) => this._makeRequest('projects/{project}/zones/{zone}/instantSnapshotGroups/{resource}/testIamPermissions', 'POST', params);

    this.regionInstantSnapshotGroups = {};
    this.regionInstantSnapshotGroups.insert = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups', 'POST', params);
    this.regionInstantSnapshotGroups.get = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{instantSnapshotGroup}', 'GET', params);
    this.regionInstantSnapshotGroups.list = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups', 'GET', params);
    this.regionInstantSnapshotGroups.delete = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{instantSnapshotGroup}', 'DELETE', params);
    this.regionInstantSnapshotGroups.getIamPolicy = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{resource}/getIamPolicy', 'GET', params);
    this.regionInstantSnapshotGroups.setIamPolicy = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{resource}/setIamPolicy', 'POST', params);
    this.regionInstantSnapshotGroups.testIamPermissions = (params) => this._makeRequest('projects/{project}/regions/{region}/instantSnapshotGroups/{resource}/testIamPermissions', 'POST', params);
    ...
    this.licenseCodes.getIamPolicy = (params) => this._makeRequest('projects/{project}/global/licenseCodes/{resource}/getIamPolicy', 'GET', params);
    this.licenseCodes.setIamPolicy = (params) => this._makeRequest('projects/{project}/global/licenseCodes/{resource}/setIamPolicy', 'POST', params);
    ...
    this.regionMultiMigMembers.list = (params) => this._makeRequest('projects/{project}/regions/{region}/multiMigs/{multiMig}/multiMigMembers', 'GET', params);
    this.regionMultiMigMembers.get = (params) => this._makeRequest('projects/{project}/regions/{region}/multiMigs/{multiMig}/multiMigMembers/{multiMigMember}', 'GET', params);
    ...
    this.networks.listIpOwners = (params) => this._makeRequest('projects/{project}/global/networks/{network}/listIpOwners', 'GET', params);
    ...
    this.networks.listIpAddresses = (params) => this._makeRequest('projects/{project}/global/networks/{network}/listIpAddresses', 'GET', params);
    ...
    this.regionNotificationEndpoints.aggregatedList = (params) => this._makeRequest('projects/{project}/aggregated/notificationEndpoints', 'GET', params);
    ...
    this.projects.setDefaultServiceAccount = (params) => this._makeRequest('projects/{project}/setDefaultServiceAccount', 'POST', params);
    ...
    this.routers.updateNamedSet = (params) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/updateNamedSet', 'POST', params);
    this.routers.patchNamedSet = (params) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/patchNamedSet', 'POST', params);
    this.routers.deleteNamedSet = (params) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/deleteNamedSet', 'POST', params);
    this.routers.getNamedSet = (params) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/getNamedSet', 'GET', params);
    this.routers.listNamedSets = (params) => this._makeRequest('projects/{project}/regions/{region}/routers/{router}/listNamedSets', 'GET', params);
    ...
    this.snapshotGroups = {};
    this.snapshotGroups.insert = (params) => this._makeRequest('projects/{project}/global/snapshotGroups', 'POST', params);
    this.snapshotGroups.get = (params) => this._makeRequest('projects/{project}/global/snapshotGroups/{snapshotGroup}', 'GET', params);
    this.snapshotGroups.list = (params) => this._makeRequest('projects/{project}/global/snapshotGroups', 'GET', params);
    this.snapshotGroups.delete = (params) => this._makeRequest('projects/{project}/global/snapshotGroups/{snapshotGroup}', 'DELETE', params);
    this.snapshotGroups.getIamPolicy = (params) => this._makeRequest('projects/{project}/global/snapshotGroups/{resource}/getIamPolicy', 'GET', params);
    this.snapshotGroups.setIamPolicy = (params) => this._makeRequest('projects/{project}/global/snapshotGroups/{resource}/setIamPolicy', 'POST', params);
    this.snapshotGroups.testIamPermissions = (params) => this._makeRequest('projects/{project}/global/snapshotGroups/{resource}/testIamPermissions', 'POST', params);
    ...
    this.storagePools.setLabels = (params) => this._makeRequest('projects/{project}/zones/{zone}/storagePools/{resource}/setLabels', 'POST', params);
    ...
    this.recoverableSnapshots.get = (params) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{recoverableSnapshot}', 'GET', params);
    this.recoverableSnapshots.aggregatedList = (params) => this._makeRequest('projects/{project}/aggregated/recoverableSnapshots', 'GET', params);
    this.recoverableSnapshots.list = (params) => this._makeRequest('projects/{project}/global/recoverableSnapshots', 'GET', params);
    this.recoverableSnapshots.delete = (params) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{recoverableSnapshot}', 'DELETE', params);
    ...
    this.recoverableSnapshots.getIamPolicy = (params) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{resource}/getIamPolicy', 'GET', params);
    this.recoverableSnapshots.setIamPolicy = (params) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{resource}/setIamPolicy', 'POST', params);
    this.recoverableSnapshots.testIamPermissions = (params) => this._makeRequest('projects/{project}/global/recoverableSnapshots/{resource}/testIamPermissions', 'POST', params);
