...
class Compute {
  ...
  constructor(config = {}) {
    ...
    this.globalVmExtensionPolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('projects/{project}/global/vmExtensionPolicies/{globalVmExtensionPolicy}', 'PATCH', apiParams, clientConfig);
