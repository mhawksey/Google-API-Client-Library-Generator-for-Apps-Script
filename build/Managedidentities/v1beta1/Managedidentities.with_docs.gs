...
class Managedidentities {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.name - (Required) Output only. The unique name of the domain using the form: `projects/{project_id}/locations/global/domains/{domain_name}`.
     ...
     * @param {string} params.name - (Required) Required. SqlIntegration resource name using the form: `projects/{project_id}/locations/global/domains/*\/sqlIntegrations/{name}`
     * @return {object} The API response object.
     */
