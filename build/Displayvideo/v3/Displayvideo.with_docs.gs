...
class Displayvideo {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.firstAndThirdPartyAudienceId - (Required) Required. The ID of the first and third party audience to fetch.
     ...
     * @param {integer} params.pageSize - Requested page size. Must be between `1` and `5000`. If unspecified, this value defaults to `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     ...
     * @param {string} params.advertiserId - Required. The ID of the advertiser under whom the FirstAndThirdPartyAudience will be created.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.advertiserId - Required. The ID of the owner advertiser of the updated FirstAndThirdPartyAudience.
     * @param {string} params.firstAndThirdPartyAudienceId - (Required) Output only. The unique ID of the first and third party audience. Assigned by the system.
     ...
     * @param {string} params.firstAndThirdPartyAudienceId - (Required) Required. The ID of the Customer Match FirstAndThirdPartyAudience whose members will be edited.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
