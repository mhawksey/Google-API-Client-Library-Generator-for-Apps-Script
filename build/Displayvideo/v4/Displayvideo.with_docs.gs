...
class Displayvideo {
  ...
  constructor(config = {}) {
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.adAssetId - (Required) Required. The ID of the ad asset to fetch. Only supports assets of AdAssetType `AD_ASSET_TYPE_YOUTUBE_VIDEO`
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser this ad asset belongs to.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser the ad assets belong to.
     * @param {string} apiParams.filter - Optional. Allows filtering of the results by ad asset fields. Supported syntax: * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `youtubeVideoAsset.youtubeVideoId` * `entityStatus` Examples: * All active YouTube video ad assets under an advertiser: `entityStatus=ENTITY_STATUS_ACTIVE`
     * @param {string} apiParams.orderBy - Optional. Field by which to sort the list. Acceptable values are: * `entityStatus` * `youtubeVideoAsset.youtubeVideoId` * `adAssetId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `adAssetId desc`.
     * @param {integer} apiParams.pageSize - Optional. Requested page size. Must be between `1` and `5000`. If unspecified will default to `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} apiParams.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdAssets` method. If not specified, the first page of results will be returned.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser these ad assets belong to.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
    ...
    this.advertisers.reachForecast = {};

    /**
     * Generates a reach forecast for a given advertiser and targeting configuration.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser that will run the planned campaign.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.reachForecast.generateReachForecast = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/reachForecast:generateReachForecast', 'POST', apiParams, clientConfig);

    /**
     * Retrieves the list of countries where reach forecasting is supported.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser to list plannable locations for.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.reachForecast.retrievePlannableLocations = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableLocations', 'GET', apiParams, clientConfig);

    /**
     * Retrieves the list of products that can be planned for a location.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser to list plannable products for.
     * @param {string} apiParams.plannableLocationId - Required. The ID of the plannable location.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.reachForecast.retrievePlannableProducts = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableProducts', 'GET', apiParams, clientConfig);

    /**
     * Retrieves first and third party user lists available for forecasting.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser to retrieve plannable user lists for.
     * @param {string} apiParams.filter - Optional. Allows filtering by plannable user list properties. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` or `OR` logical operators. * A restriction has the form of `{field} {operator} {value}`. * The `updateTime` field must use the `GREATER THAN OR EQUAL TO (>=)` or `LESS THAN OR EQUAL TO (<=)` operators. * All other fields must use the `EQUALS (=)` operator. Supported fields: * `plannableStatus` Examples: * All plannable user lists: `plannableStatus="PLANNABLE"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {integer} apiParams.pageSize - Optional. Requested page size. Must be between `1` and `5000`. If unspecified will default to `5000`.
     * @param {string} apiParams.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `RetrievePlannableUserLists` method. If not specified, the first page of results will be returned.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.reachForecast.retrievePlannableUserLists = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableUserLists', 'GET', apiParams, clientConfig);

    /**
     * Retrieves Google Audiences (User Interests) available for forecasting.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser to list plannable user interests for.
     * @param {string} apiParams.productCategory - Required. The product category to retrieve plannable user interests for.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.reachForecast.retrievePlannableUserInterests = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableUserInterests', 'GET', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser that the linked entity belongs to.
     * @param {string} apiParams.lineItemId - (Required) The ID of a line item.
     * @param {string} apiParams.linkedEntity.adGroupId - The ID of an ad group.
     ...
     * @param {integer} apiParams.pageSize - Optional. Requested page size. Must be between `1` and `10000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} apiParams.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAssetAssociations` method. If not specified, the first page of results will be returned.
     * @param {string} apiParams.youtubeAssetType - (Required) Required. The type of YouTube asset being associated with the resource.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
     ...
     * @param {string} apiParams.lineItemId - (Required) The ID of a line item.
     * @param {string} apiParams.linkedEntity.adGroupId - The ID of an ad group.
     * @param {string} apiParams.youtubeAssetType - (Required) Required. The type of YouTube asset associated with the resource.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     ...
     * @param {string} apiParams.lineItemId - (Required) The ID of a line item.
     * @param {string} apiParams.linkedEntity.adGroupId - The ID of an ad group.
     * @param {string} apiParams.youtubeAssetAssociationId - (Required) Required. The ID of the YouTube asset in the association. For `YOUTUBE_ASSET_TYPE_LOCATION` and `YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION` associations: This should be the ID of the asset set linked, or 0 if the location_asset_filter or affiliate_location_asset_filter is `DISABLED`. For `YOUTUBE_ASSET_TYPE_SITELINK` associations: This should be the ID of the sitelink asset linked.
     * @param {string} apiParams.youtubeAssetType - (Required) Required. The type of YouTube asset associated with the resource.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroupAds.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroupAds/{+adGroupAdId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroupAds.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroupAds', 'POST', apiParams, clientConfig);

    /**
     * Gets an ad group ad.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.adGroupAdId - (Required) Required. The ID of the ad to fetch.
     ...
     * Lists ad group ads.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser the ads belong to.
     * @param {string} apiParams.filter - Optional. Allows filtering by ad group ad fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `adGroupId` * `displayName` * `entityStatus` * `adGroupAdId` Examples: * All ad group ads under an ad group: `adGroupId="1234"` * All ad group ads under an ad group with an entityStatus of `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED`: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupId="12345"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.adGroupAdId - (Required) Required. The ID of the ad to delete. Only Demand Gen ads are supported.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser the ad belongs to.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroupAds.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroupAds/{+adGroupAdId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroups.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroups.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroups.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroups.bulkEditAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups:bulkEditAssignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroups.targetingTypes.assignedTargetingOptions.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.adGroups.targetingTypes.assignedTargetingOptions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', apiParams, clientConfig);
     ...
     * Lists the YouTube asset associations linked to the given resource.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.adGroupId - (Required) The ID of an ad group.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser that the linked entity belongs to.
     * @param {string} apiParams.linkedEntity.lineItemId - The ID of a line item.
     * @param {string} apiParams.orderBy - Optional. Field by which to sort the list. The only acceptable values are: * `linkedYoutubeAsset.locationAssetFilter.assetSetId`, * `linkedYoutubeAsset.affiliateLocationAssetFilter.assetSetId`, * `linkedYoutubeAsset.sitelinkAsset.assetId` The default sorting order is ascending. To specify descending order for a field, a suffix " desc" should be added to the field name. Example: `linkedYoutubeAsset.sitelinkAsset.assetId desc`.
     * @param {integer} apiParams.pageSize - Optional. Requested page size. Must be between `1` and `10000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} apiParams.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAssetAssociations` method. If not specified, the first page of results will be returned.
     * @param {string} apiParams.youtubeAssetType - (Required) Required. The type of YouTube asset being associated with the resource.
