...
class Displayvideo {
  ...
  constructor(config = {}) {
     ...
     */
    this.advertisers.listAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}:listAssignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.editAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}:editAssignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.list = (params) => this._makeRequest('v4/advertisers', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.create = (params) => this._makeRequest('v4/advertisers', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.audit = (params) => this._makeRequest('v4/advertisers/{+advertiserId}:audit', 'GET', params);

    this.advertisers.adGroupAds = {};

    /**
     * Gets an ad group ad.
     * @param {string} params.adGroupAdId - (Required) Required. The ID of the ad group ad to fetch.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser this ad group ad belongs to.
     * @return {object} The API response object.
     */
    this.advertisers.adGroupAds.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroupAds/{+adGroupAdId}', 'GET', params);

    /**
     * Lists ad group ads.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the ad groups belongs to.
     * @param {string} params.filter - Optional. Allows filtering by custom ad group ad fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `adGroupId` * `displayName` * `entityStatus` * `adGroupAdId` Examples: * All ad group ads under an ad group: `adGroupId="1234"` * All ad group ads under an ad group with an entityStatus of `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED`: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupId="12345"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {string} params.orderBy - Optional. Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
     ...
     * @param {string} params.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdGroupAds` method. If not specified, the first page of results will be returned.
     * @return {object} The API response object.
     */
    this.advertisers.adGroupAds.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroupAds', 'GET', params);
     ...
     * @param {string} params.adGroupIds - Required. The IDs of the ad groups to list assigned targeting options for.
     ...
     * @return {object} The API response object.
     */
    this.advertisers.adGroups.bulkListAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups:bulkListAssignedTargetingOptions', 'GET', params);

    /**
     * Gets an ad group.
     * @param {string} params.adGroupId - (Required) Required. The ID of the ad group to fetch.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser this ad group belongs to.
     * @return {object} The API response object.
     */
    this.advertisers.adGroups.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}', 'GET', params);

    /**
     * Lists ad groups.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the ad groups belongs to.
     * @param {string} params.filter - Optional. Allows filtering by custom ad group fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported properties: * `adGroupId` * `displayName` * `entityStatus` * `lineItemId` * `adGroupFormat` Examples: * All ad groups under an line item: `lineItemId="1234"` * All `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED` `AD_GROUP_FORMAT_IN_STREAM` ad groups under an advertiser: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupFormat="AD_GROUP_FORMAT_IN_STREAM"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {string} params.orderBy - Optional. Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
     * @param {integer} params.pageSize - Optional. Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdGroups` method. If not specified, the first page of results will be returned.
     * @return {object} The API response object.
     */
    this.advertisers.adGroups.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups', 'GET', params);
     ...
     * @param {string} params.adGroupId - (Required) Required. The ID of the ad group the assigned targeting option belongs to.
     ...
     * @return {object} The API response object.
     */
    this.advertisers.adGroups.targetingTypes.assignedTargetingOptions.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', params);

    /**
     * Lists the targeting options assigned to an ad group. Inherited assigned targeting options are not included.
     * @param {string} params.adGroupId - (Required) Required. The ID of the ad group to list assigned targeting options for.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the ad group belongs to.
     ...
     * @param {string} params.orderBy - Optional. Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.
     * @param {integer} params.pageSize - Optional. Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdGroupAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
     ...
     * @return {object} The API response object.
     */
    this.advertisers.adGroups.targetingTypes.assignedTargetingOptions.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.bulkListAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems:bulkListAssignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.bulkEditAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems:bulkEditAssignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.generateDefault = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems:generateDefault', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.duplicate = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}:duplicate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.bulkUpdate = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems:bulkUpdate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.assets.upload = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/assets', 'POST', params);

    this.advertisers.campaigns = {};

    /**
     * Lists assigned targeting options of a campaign across targeting types.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the campaign belongs to.
     * @param {string} params.campaignId - (Required) Required. The ID of the campaign to list assigned targeting options for.
     ...
     * @param {string} params.orderBy - Field by which to sort the list. Acceptable values are: * `targetingType` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `targetingType desc`.
     * @param {integer} params.pageSize - Requested page size. The size must be an integer between `1` and `5000`. If unspecified, the default is `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - A token that lets the client fetch the next page of results. Typically, this is the value of next_page_token returned from the previous call to `BulkListCampaignAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.listAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns/{+campaignId}:listAssignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns/{+campaignId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns/{+campaignId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns/{+campaignId}', 'DELETE', params);
     ...
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the campaign belongs to.
     * @param {string} params.assignedTargetingOptionId - (Required) Required. An identifier unique to the targeting type in this campaign that identifies the assigned targeting option being requested.
     * @param {string} params.campaignId - (Required) Required. The ID of the campaign the assigned targeting option belongs to.
     * @param {string} params.targetingType - (Required) Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_VIEWABILITY`
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.targetingTypes.assignedTargetingOptions.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns/{+campaignId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', params);
     ...
     * @param {string} params.orderBy - Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.
     * @param {integer} params.pageSize - Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListCampaignAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
     * @param {string} params.targetingType - (Required) Required. Identifies the type of assigned targeting options to list. Supported targeting types: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_VIEWABILITY`
     * @return {object} The API response object.
     */
    this.advertisers.campaigns.targetingTypes.assignedTargetingOptions.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/campaigns/{+campaignId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/channels/{+channelId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/channels', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/channels', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/channels/{channelId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.sites.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/channels/{+channelId}/sites', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.sites.create = (params) => this._makeRequest('v4/advertisers/{advertiserId}/channels/{+channelId}/sites', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.sites.delete = (params) => this._makeRequest('v4/advertisers/{advertiserId}/channels/{+channelId}/sites/{+urlOrAppId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.sites.bulkEdit = (params) => this._makeRequest('v4/advertisers/{advertiserId}/channels/{+channelId}/sites:bulkEdit', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.channels.sites.replace = (params) => this._makeRequest('v4/advertisers/{advertiserId}/channels/{+channelId}/sites:replace', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.creatives.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/creatives/{+creativeId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.creatives.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/creatives', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.creatives.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/creatives', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.creatives.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/creatives/{+creativeId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.creatives.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/creatives/{+creativeId}', 'DELETE', params);

    this.advertisers.insertionOrders = {};

    /**
     * Lists assigned targeting options of an insertion order across targeting types.
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the insertion order belongs to.
     ...
     * @param {string} params.insertionOrderId - (Required) Required. The ID of the insertion order to list assigned targeting options for.
     * @param {string} params.orderBy - Field by which to sort the list. Acceptable values are: * `targetingType` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `targetingType desc`.
     * @param {integer} params.pageSize - Requested page size. The size must be an integer between `1` and `5000`. If unspecified, the default is `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - A token that lets the client fetch the next page of results. Typically, this is the value of next_page_token returned from the previous call to `BulkListInsertionOrderAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.listAssignedTargetingOptions = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}:listAssignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}', 'DELETE', params);
     ...
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the insertion order belongs to.
     * @param {string} params.assignedTargetingOptionId - (Required) Required. An identifier unique to the targeting type in this insertion order that identifies the assigned targeting option being requested.
     * @param {string} params.insertionOrderId - (Required) Required. The ID of the insertion order the assigned targeting option belongs to.
     * @param {string} params.targetingType - (Required) Required. Identifies the type of this assigned targeting option. Supported targeting types include: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_APP` * `TARGETING_TYPE_APP_CATEGORY` * `TARGETING_TYPE_AUDIENCE_GROUP` * `TARGETING_TYPE_AUDIO_CONTENT_TYPE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_BROWSER` * `TARGETING_TYPE_BUSINESS_CHAIN` * `TARGETING_TYPE_CARRIER_AND_ISP` * `TARGETING_TYPE_CATEGORY` * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_CONTENT_DURATION` * `TARGETING_TYPE_CONTENT_GENRE` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_STREAM_TYPE` * `TARGETING_TYPE_DAY_AND_TIME` * `TARGETING_TYPE_DEVICE_MAKE_MODEL` * `TARGETING_TYPE_DEVICE_TYPE` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_KEYWORD` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_NATIVE_CONTENT_POSITION` * `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_OPERATING_SYSTEM` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_POI` * `TARGETING_TYPE_PROXIMITY_LOCATION_LIST` * `TARGETING_TYPE_REGIONAL_LOCATION_LIST` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_URL` * `TARGETING_TYPE_USER_REWARDED_CONTENT` * `TARGETING_TYPE_VIDEO_PLAYER_SIZE` * `TARGETING_TYPE_VIEWABILITY`
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', params);
     ...
     * @param {string} params.orderBy - Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.
     * @param {integer} params.pageSize - Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListInsertionOrderAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
     * @param {string} params.targetingType - (Required) Required. Identifies the type of assigned targeting options to list. Supported targeting types include: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_APP` * `TARGETING_TYPE_APP_CATEGORY` * `TARGETING_TYPE_AUDIENCE_GROUP` * `TARGETING_TYPE_AUDIO_CONTENT_TYPE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_BROWSER` * `TARGETING_TYPE_BUSINESS_CHAIN` * `TARGETING_TYPE_CARRIER_AND_ISP` * `TARGETING_TYPE_CATEGORY` * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_CONTENT_DURATION` * `TARGETING_TYPE_CONTENT_GENRE` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_STREAM_TYPE` * `TARGETING_TYPE_DAY_AND_TIME` * `TARGETING_TYPE_DEVICE_MAKE_MODEL` * `TARGETING_TYPE_DEVICE_TYPE` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_KEYWORD` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_NATIVE_CONTENT_POSITION` * `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_OPERATING_SYSTEM` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_POI` * `TARGETING_TYPE_PROXIMITY_LOCATION_LIST` * `TARGETING_TYPE_REGIONAL_LOCATION_LIST` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_URL` * `TARGETING_TYPE_USER_REWARDED_CONTENT` * `TARGETING_TYPE_VIDEO_PLAYER_SIZE` * `TARGETING_TYPE_VIEWABILITY`
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', params);
     ...
     * @param {string} params.advertiserId - (Required) Required. The ID of the advertiser the insertion order belongs to.
     * @param {string} params.insertionOrderId - (Required) Required. The ID of the insertion order the assigned targeting option will belong to.
     * @param {string} params.targetingType - (Required) Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_BROWSER` * `TARGETING_TYPE_CATEGORY` * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DEVICE_MAKE_MODEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_KEYWORD` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST` * `TARGETING_TYPE_OPERATING_SYSTEM` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_VIEWABILITY`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.invoices.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/invoices', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.invoices.lookupInvoiceCurrency = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/invoices:lookupInvoiceCurrency', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/locationLists/{+locationListId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/locationLists', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/locationLists', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/locationLists/{locationListId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.assignedLocations.list = (params) => this._makeRequest('v4/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.assignedLocations.create = (params) => this._makeRequest('v4/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.assignedLocations.delete = (params) => this._makeRequest('v4/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations/{+assignedLocationId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.locationLists.assignedLocations.bulkEdit = (params) => this._makeRequest('v4/advertisers/{advertiserId}/locationLists/{+locationListId}/assignedLocations:bulkEdit', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.get = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/negativeKeywordLists', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.create = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/negativeKeywordLists', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.patch = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/negativeKeywordLists/{negativeKeywordListId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.delete = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.list = (params) => this._makeRequest('v4/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.create = (params) => this._makeRequest('v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.delete = (params) => this._makeRequest('v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords/{+keywordValue}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.bulkEdit = (params) => this._makeRequest('v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords:bulkEdit', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.replace = (params) => this._makeRequest('v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords:replace', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.combinedAudiences.get = (params) => this._makeRequest('v4/combinedAudiences/{+combinedAudienceId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.combinedAudiences.list = (params) => this._makeRequest('v4/combinedAudiences', 'GET', params);
     ...
     * @param {string} params.customBiddingAlgorithmId - (Required) Required. The ID of the custom bidding algorithm that owns the rules resource.
     * @param {string} params.partnerId - The ID of the partner that owns the parent custom bidding algorithm.
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.uploadRules = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadRules', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.get = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.list = (params) => this._makeRequest('v4/customBiddingAlgorithms', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.create = (params) => this._makeRequest('v4/customBiddingAlgorithms', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.patch = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.uploadScript = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadScript', 'GET', params);
     ...
     * @param {string} params.advertiserId - The ID of the advertiser that owns the parent custom bidding algorithm.
     * @param {string} params.customBiddingAlgorithmId - (Required) Required. The ID of the custom bidding algorithm that owns the rules resource.
     * @param {string} params.partnerId - The ID of the partner that owns the parent custom bidding algorithm. Only this partner will have write access to this rules resource.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.rules.create = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules', 'POST', params);

    /**
     * Retrieves a rules resource.
     * @param {string} params.advertiserId - The ID of the advertiser that owns the parent custom bidding algorithm.
     * @param {string} params.customBiddingAlgorithmId - (Required) Required. The ID of the custom bidding algorithm that owns the rules resource.
     * @param {string} params.customBiddingAlgorithmRulesId - (Required) Required. The ID of the rules resource to fetch.
     * @param {string} params.partnerId - The ID of the partner that owns the parent custom bidding algorithm.
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.rules.get = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules/{+customBiddingAlgorithmRulesId}', 'GET', params);
     ...
     * @param {integer} params.pageSize - Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListCustomBiddingAlgorithmRules` method. If not specified, the first page of results will be returned.
     * @param {string} params.partnerId - The ID of the partner that owns the parent custom bidding algorithm.
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.rules.list = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.scripts.create = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.scripts.get = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts/{+customBiddingScriptId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customBiddingAlgorithms.scripts.list = (params) => this._makeRequest('v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customLists.get = (params) => this._makeRequest('v4/customLists/{+customListId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customLists.list = (params) => this._makeRequest('v4/customLists', 'GET', params);

    this.firstPartyAndPartnerAudiences = {};

    /**
     * Gets a first party or partner audience.
     * @param {string} params.advertiserId - The ID of the advertiser that has access to the fetched first party and partner audience.
     * @param {string} params.firstPartyAndPartnerAudienceId - (Required) Required. The ID of the first party and partner audience to fetch.
     * @param {string} params.partnerId - The ID of the partner that has access to the fetched first party and partner audience.
     * @return {object} The API response object.
     */
    this.firstPartyAndPartnerAudiences.get = (params) => this._makeRequest('v4/firstPartyAndPartnerAudiences/{+firstPartyAndPartnerAudienceId}', 'GET', params);

    /**
     * Lists first party and partner audiences. The order is defined by the order_by parameter.
     * @param {string} params.advertiserId - The ID of the advertiser that has access to the fetched first party and partner audiences.
     * @param {string} params.filter - Optional. Allows filtering by first party and partner audience fields. Supported syntax: * Filter expressions for first party and partner audiences can only contain at most one restriction. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `HAS (:)` operator. Supported fields: * `displayName` Examples: * All first party and partner audiences for which the display name contains "Google": `displayName:"Google"`. The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {string} params.orderBy - Optional. Field by which to sort the list. Acceptable values are: * `FirstPartyAndPartnerAudienceId` (default) * `displayName` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
     * @param {integer} params.pageSize - Optional. Requested page size. Must be between `1` and `5000`. If unspecified, this value defaults to `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} params.pageToken - Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListFirstPartyAndPartnerAudiences` method. If not specified, the first page of results will be returned.
     * @param {string} params.partnerId - The ID of the partner that has access to the fetched first party and partner audiences.
     * @return {object} The API response object.
     */
    this.firstPartyAndPartnerAudiences.list = (params) => this._makeRequest('v4/firstPartyAndPartnerAudiences', 'GET', params);
     ...
     * @param {string} params.advertiserId - Required. The ID of the advertiser under whom the FirstPartyAndPartnerAudience will be created.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.firstPartyAndPartnerAudiences.create = (params) => this._makeRequest('v4/firstPartyAndPartnerAudiences', 'POST', params);
     ...
     * @param {string} params.advertiserId - Required. The ID of the owner advertiser of the updated FirstPartyAndPartnerAudience.
     * @param {string} params.firstPartyAndPartnerAudienceId - (Required) Identifier. The unique ID of the first party and partner audience. Assigned by the system.
     * @param {string} params.updateMask - Required. The mask to control which fields to update. Updates are only supported for the following fields: * `displayName` * `description` * `membershipDurationDays`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.firstPartyAndPartnerAudiences.patch = (params) => this._makeRequest('v4/firstPartyAndPartnerAudiences/{+firstPartyAndPartnerAudienceId}', 'PATCH', params);

    /**
     * Updates the member list of a Customer Match audience. Only supported for the following audience_type: * `CUSTOMER_MATCH_CONTACT_INFO` * `CUSTOMER_MATCH_DEVICE_ID`
     * @param {string} params.firstPartyAndPartnerAudienceId - (Required) Required. The ID of the Customer Match FirstPartyAndPartnerAudience whose members will be edited.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.firstPartyAndPartnerAudiences.editCustomerMatchMembers = (params) => this._makeRequest('v4/firstPartyAndPartnerAudiences/{+firstPartyAndPartnerAudienceId}:editCustomerMatchMembers', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.floodlightGroups.get = (params) => this._makeRequest('v4/floodlightGroups/{+floodlightGroupId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.floodlightGroups.patch = (params) => this._makeRequest('v4/floodlightGroups/{floodlightGroupId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.floodlightGroups.floodlightActivities.get = (params) => this._makeRequest('v4/floodlightGroups/{+floodlightGroupId}/floodlightActivities/{+floodlightActivityId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.floodlightGroups.floodlightActivities.list = (params) => this._makeRequest('v4/floodlightGroups/{+floodlightGroupId}/floodlightActivities', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.googleAudiences.get = (params) => this._makeRequest('v4/googleAudiences/{+googleAudienceId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.googleAudiences.list = (params) => this._makeRequest('v4/googleAudiences', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.guaranteedOrders.create = (params) => this._makeRequest('v4/guaranteedOrders', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.guaranteedOrders.get = (params) => this._makeRequest('v4/guaranteedOrders/{+guaranteedOrderId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.guaranteedOrders.list = (params) => this._makeRequest('v4/guaranteedOrders', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.guaranteedOrders.patch = (params) => this._makeRequest('v4/guaranteedOrders/{+guaranteedOrderId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.guaranteedOrders.editGuaranteedOrderReadAccessors = (params) => this._makeRequest('v4/guaranteedOrders/{+guaranteedOrderId}:editGuaranteedOrderReadAccessors', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.get = (params) => this._makeRequest('v4/inventorySourceGroups/{+inventorySourceGroupId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.list = (params) => this._makeRequest('v4/inventorySourceGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.create = (params) => this._makeRequest('v4/inventorySourceGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.patch = (params) => this._makeRequest('v4/inventorySourceGroups/{inventorySourceGroupId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.delete = (params) => this._makeRequest('v4/inventorySourceGroups/{+inventorySourceGroupId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.assignedInventorySources.list = (params) => this._makeRequest('v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.assignedInventorySources.create = (params) => this._makeRequest('v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.assignedInventorySources.delete = (params) => this._makeRequest('v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources/{+assignedInventorySourceId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySourceGroups.assignedInventorySources.bulkEdit = (params) => this._makeRequest('v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources:bulkEdit', 'POST', params);

    this.inventorySources = {};

    /**
     * Gets an inventory source.
     * @param {string} params.advertiserId - Optional. The ID of the DV360 advertiser to which the fetched inventory source is permissioned. If the user only has access to the advertiser and not the parent partner, use this field to specify the relevant advertiser.
     ...
     * @return {object} The API response object.
     */
    this.inventorySources.get = (params) => this._makeRequest('v4/inventorySources/{+inventorySourceId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySources.list = (params) => this._makeRequest('v4/inventorySources', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySources.create = (params) => this._makeRequest('v4/inventorySources', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySources.patch = (params) => this._makeRequest('v4/inventorySources/{+inventorySourceId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.inventorySources.editInventorySourceReadWriteAccessors = (params) => this._makeRequest('v4/inventorySources/{+inventorySourceId}:editInventorySourceReadWriteAccessors', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.editAssignedTargetingOptions = (params) => this._makeRequest('v4/partners/{+partnerId}:editAssignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.get = (params) => this._makeRequest('v4/partners/{+partnerId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.list = (params) => this._makeRequest('v4/partners', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.get = (params) => this._makeRequest('v4/partners/{+partnerId}/channels/{+channelId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.list = (params) => this._makeRequest('v4/partners/{+partnerId}/channels', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.create = (params) => this._makeRequest('v4/partners/{+partnerId}/channels', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.patch = (params) => this._makeRequest('v4/partners/{+partnerId}/channels/{channelId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.sites.list = (params) => this._makeRequest('v4/partners/{+partnerId}/channels/{+channelId}/sites', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.sites.create = (params) => this._makeRequest('v4/partners/{partnerId}/channels/{+channelId}/sites', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.sites.delete = (params) => this._makeRequest('v4/partners/{partnerId}/channels/{+channelId}/sites/{+urlOrAppId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.sites.bulkEdit = (params) => this._makeRequest('v4/partners/{partnerId}/channels/{+channelId}/sites:bulkEdit', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.channels.sites.replace = (params) => this._makeRequest('v4/partners/{partnerId}/channels/{+channelId}/sites:replace', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.targetingTypes.assignedTargetingOptions.get = (params) => this._makeRequest('v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.targetingTypes.assignedTargetingOptions.list = (params) => this._makeRequest('v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.targetingTypes.assignedTargetingOptions.create = (params) => this._makeRequest('v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.partners.targetingTypes.assignedTargetingOptions.delete = (params) => this._makeRequest('v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.sdfdownloadtasks.create = (params) => this._makeRequest('v4/sdfdownloadtasks', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.sdfdownloadtasks.operations.get = (params) => this._makeRequest('v4/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.targetingTypes.targetingOptions.get = (params) => this._makeRequest('v4/targetingTypes/{+targetingType}/targetingOptions/{+targetingOptionId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.targetingTypes.targetingOptions.list = (params) => this._makeRequest('v4/targetingTypes/{+targetingType}/targetingOptions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.targetingTypes.targetingOptions.search = (params) => this._makeRequest('v4/targetingTypes/{+targetingType}/targetingOptions:search', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.get = (params) => this._makeRequest('v4/users/{+userId}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.users.list = (params) => this._makeRequest('v4/users', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.users.create = (params) => this._makeRequest('v4/users', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.patch = (params) => this._makeRequest('v4/users/{+userId}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.users.delete = (params) => this._makeRequest('v4/users/{+userId}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.users.bulkEditAssignedUserRoles = (params) => this._makeRequest('v4/users/{+userId}:bulkEditAssignedUserRoles', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.sdfuploadtasks.operations.get = (params) => this._makeRequest('v4/{+name}', 'GET', params);
  }
