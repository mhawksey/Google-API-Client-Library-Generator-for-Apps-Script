...
- **Last Checked:** Tue, 30 Jun 2026 23:46:10 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:46:10 GMT
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.firstPartyAndPartnerAudienceId` | `string` | Yes | Required. The ID of the first party and partner audience to fetch. |
| `params.partnerId` | `string` | No | The ID of the partner that has access to the fetched first party and partner audience. |
| `params.advertiserId` | `string` | No | The ID of the advertiser that has access to the fetched first party and partner audience. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListFirstPartyAndPartnerAudiences` method. If not specified, the first page of results will be returned. |
| `params.orderBy` | `string` | No | Optional. Field by which to sort the list. Acceptable values are: * `FirstPartyAndPartnerAudienceId` (default) * `displayName` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`. |
| `params.advertiserId` | `string` | No | The ID of the advertiser that has access to the fetched first party and partner audiences. |
| `params.partnerId` | `string` | No | The ID of the partner that has access to the fetched first party and partner audiences. |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Must be between `1` and `5000`. If unspecified, this value defaults to `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. |
| `params.filter` | `string` | No | Optional. Allows filtering by first party and partner audience fields. Supported syntax: * Filter expressions for first party and partner audiences can only contain at most one restriction. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `HAS (:)` operator. Supported fields: * `displayName` Examples: * All first party and partner audiences for which the display name contains "Google": `displayName:"Google"`. The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information. |

#### `firstPartyAndPartnerAudiences.patch()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | No | Required. The ID of the owner advertiser of the updated FirstPartyAndPartnerAudience. |
...
| `params.firstPartyAndPartnerAudienceId` | `string` | Yes | Identifier. The unique ID of the first party and partner audience. Assigned by the system. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | No | Required. The ID of the advertiser under whom the FirstPartyAndPartnerAudience will be created. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.firstPartyAndPartnerAudienceId` | `string` | Yes | Required. The ID of the Customer Match FirstPartyAndPartnerAudience whose members will be edited. |
| `params.requestBody` | `object` | Yes | The request body. |
...
### `advertisers.adAssets`

#### `advertisers.adAssets.get()`

Gets an ad asset. Only supports the retrieval of assets of AdAssetType `AD_ASSET_TYPE_YOUTUBE_VIDEO`.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser this ad asset belongs to. |
| `params.adAssetId` | `string` | Yes | Required. The ID of the ad asset to fetch. Only supports assets of AdAssetType `AD_ASSET_TYPE_YOUTUBE_VIDEO` |

#### `advertisers.adAssets.list()`

Lists ad assets under an advertiser ID. Only supports the retrieval of assets of AdAssetType `AD_ASSET_TYPE_YOUTUBE_VIDEO`.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser the ad assets belong to. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdAssets` method. If not specified, the first page of results will be returned. |
| `params.orderBy` | `string` | No | Optional. Field by which to sort the list. Acceptable values are: * `entityStatus` * `youtubeVideoAsset.youtubeVideoId` * `adAssetId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `adAssetId desc`. |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Must be between `1` and `5000`. If unspecified will default to `5000`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. |
| `params.filter` | `string` | No | Optional. Allows filtering of the results by ad asset fields. Supported syntax: * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `youtubeVideoAsset.youtubeVideoId` * `entityStatus` Examples: * All active YouTube video ad assets under an advertiser: `entityStatus=ENTITY_STATUS_ACTIVE` |

#### `advertisers.adAssets.upload()`
...
#### `advertisers.adAssets.bulkCreate()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser these ad assets belong to. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser that will run the planned campaign. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `advertisers.reachForecast.retrievePlannableLocations()`

Retrieves the list of countries where reach forecasting is supported.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser to list plannable locations for. |

#### `advertisers.reachForecast.retrievePlannableProducts()`

Retrieves the list of products that can be planned for a location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser to list plannable products for. |
| `params.plannableLocationId` | `string` | No | Required. The ID of the plannable location. |

#### `advertisers.reachForecast.retrievePlannableUserLists()`

Retrieves first and third party user lists available for forecasting.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser to retrieve plannable user lists for. |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Must be between `1` and `5000`. If unspecified will default to `5000`. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `RetrievePlannableUserLists` method. If not specified, the first page of results will be returned. |
| `params.filter` | `string` | No | Optional. Allows filtering by plannable user list properties. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` or `OR` logical operators. * A restriction has the form of `{field} {operator} {value}`. * The `updateTime` field must use the `GREATER THAN OR EQUAL TO (>=)` or `LESS THAN OR EQUAL TO (<=)` operators. * All other fields must use the `EQUALS (=)` operator. Supported fields: * `plannableStatus` Examples: * All plannable user lists: `plannableStatus="PLANNABLE"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.productCategory` | `string` | No | Required. The product category to retrieve plannable user interests for. |
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser to list plannable user interests for. |
...
### `advertisers.lineItems.youtubeAssetTypes`

### `advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations`

#### `advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations.list()`

Lists the YouTube asset associations linked to the given resource.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.lineItemId` | `string` | Yes | The ID of a line item. |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Must be between `1` and `10000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. |
| `params.linkedEntity.adGroupId` | `string` | No | The ID of an ad group. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAssetAssociations` method. If not specified, the first page of results will be returned. |
| `params.orderBy` | `string` | No | Optional. Field by which to sort the list. The only acceptable values are: * `linkedYoutubeAsset.locationAssetFilter.assetSetId`, * `linkedYoutubeAsset.affiliateLocationAssetFilter.assetSetId`, * `linkedYoutubeAsset.sitelinkAsset.assetId` The default sorting order is ascending. To specify descending order for a field, a suffix " desc" should be added to the field name. Example: `linkedYoutubeAsset.sitelinkAsset.assetId desc`. |
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser that the linked entity belongs to. |
| `params.youtubeAssetType` | `string` | Yes | Required. The type of YouTube asset being associated with the resource. |

#### `advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations.create()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.youtubeAssetType` | `string` | Yes | Required. The type of YouTube asset associated with the resource. |
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser that the linked entity belongs to. |
| `params.lineItemId` | `string` | Yes | The ID of a line item. |
| `params.linkedEntity.adGroupId` | `string` | No | The ID of an ad group. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations.delete()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.youtubeAssetAssociationId` | `string` | Yes | Required. The ID of the YouTube asset in the association. For `YOUTUBE_ASSET_TYPE_LOCATION` and `YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION` associations: This should be the ID of the asset set linked, or 0 if the location_asset_filter or affiliate_location_asset_filter is `DISABLED`. For `YOUTUBE_ASSET_TYPE_SITELINK` associations: This should be the ID of the sitelink asset linked. |
| `params.lineItemId` | `string` | Yes | The ID of a line item. |
| `params.youtubeAssetType` | `string` | Yes | Required. The type of YouTube asset associated with the resource. |
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser that the linked entity belongs to. |
| `params.linkedEntity.adGroupId` | `string` | No | The ID of an ad group. |
...
|---|---|---|---|
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser. |
| `params.targetingType` | `string` | Yes | Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_KEYWORD` |
| `params.requestBody` | `object` | Yes | The request body. |
...
| `params.adGroupAdId` | `string` | Yes | Required. The ID of the ad to fetch. |
...
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser the ads belong to. |
...
| `params.adGroupAdId` | `string` | Yes | Required. The ID of the ad to delete. Only Demand Gen ads are supported. |
...
### `advertisers.adGroups.youtubeAssetTypes`

### `advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations`

#### `advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations.list()`

Lists the YouTube asset associations linked to the given resource.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.linkedEntity.lineItemId` | `string` | No | The ID of a line item. |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Must be between `1` and `10000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. |
| `params.adGroupId` | `string` | Yes | The ID of an ad group. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAssetAssociations` method. If not specified, the first page of results will be returned. |
| `params.orderBy` | `string` | No | Optional. Field by which to sort the list. The only acceptable values are: * `linkedYoutubeAsset.locationAssetFilter.assetSetId`, * `linkedYoutubeAsset.affiliateLocationAssetFilter.assetSetId`, * `linkedYoutubeAsset.sitelinkAsset.assetId` The default sorting order is ascending. To specify descending order for a field, a suffix " desc" should be added to the field name. Example: `linkedYoutubeAsset.sitelinkAsset.assetId desc`. |
| `params.advertiserId` | `string` | Yes | Required. The ID of the advertiser that the linked entity belongs to. |
| `params.youtubeAssetType` | `string` | Yes | Required. The type of YouTube asset being associated with the resource. |

#### `advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations.create()`
...
#### `advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations.delete()`
