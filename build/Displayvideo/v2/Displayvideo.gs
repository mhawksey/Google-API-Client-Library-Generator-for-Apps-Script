...
class Displayvideo {
  ...
  constructor(config = {}) {
     ...
     */
    this.advertisers.listAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}:listAssignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.editAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}:editAssignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.audit = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}:audit', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.bulkListAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems:bulkListAssignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.bulkEditAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems:bulkEditAssignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.generateDefault = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems:generateDefault', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.duplicate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}:duplicate', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.bulkUpdate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems:bulkUpdate', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.lineItems.targetingTypes.assignedTargetingOptions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.targetingTypes.assignedTargetingOptions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', apiParams, clientConfig);
    ...
    this.advertisers.assets.upload = async (apiParams = {}, clientConfig = {}) => {
      ...
      const path = apiParams.media ? '/upload/v2/advertisers/{+advertiserId}/assets' : 'v2/advertisers/{+advertiserId}/assets';
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.listAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns/{+campaignId}:listAssignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns/{+campaignId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns/{+campaignId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns/{+campaignId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.targetingTypes.assignedTargetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns/{+campaignId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.campaigns.targetingTypes.assignedTargetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/campaigns/{+campaignId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/channels/{+channelId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/channels', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/channels', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/channels/{channelId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.sites.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/channels/{+channelId}/sites', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.sites.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/channels/{+channelId}/sites', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.sites.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/channels/{+channelId}/sites/{+urlOrAppId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.sites.bulkEdit = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/channels/{+channelId}/sites:bulkEdit', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.channels.sites.replace = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/channels/{+channelId}/sites:replace', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.creatives.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/creatives/{+creativeId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.creatives.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/creatives', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.creatives.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/creatives', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.creatives.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/creatives/{+creativeId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.creatives.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/creatives/{+creativeId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.listAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}:listAssignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.insertionOrders.targetingTypes.assignedTargetingOptions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.invoices.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/invoices', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.invoices.lookupInvoiceCurrency = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/invoices:lookupInvoiceCurrency', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/locationLists/{+locationListId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/locationLists', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/locationLists', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/locationLists/{locationListId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.assignedLocations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.assignedLocations.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.assignedLocations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations/{+assignedLocationId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.locationLists.assignedLocations.bulkEdit = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/locationLists/{+locationListId}/assignedLocations:bulkEdit', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser this manual trigger belongs to.
     * @param {string} apiParams.triggerId - (Required) Required. The ID of the manual trigger to fetch.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.manualTriggers.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/manualTriggers/{+triggerId}', 'GET', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser that the fetched manual triggers belong to.
     * @param {string} apiParams.filter - Allows filtering by manual trigger fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` or `OR` logical operators. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `displayName` * `state` Examples: * All active manual triggers under an advertiser: `state="ACTIVE"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {string} apiParams.orderBy - Field by which to sort the list. Acceptable values are: * `displayName` (default) * `state` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. For example, `displayName desc`.
     * @param {integer} apiParams.pageSize - Requested page size. Must be between `1` and `200`. If unspecified will default to `100`.
     * @param {string} apiParams.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListManualTriggers` method. If not specified, the first page of results will be returned.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.manualTriggers.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/manualTriggers', 'GET', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. Immutable. The unique ID of the advertiser that the manual trigger belongs to.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.manualTriggers.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/manualTriggers', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. Immutable. The unique ID of the advertiser that the manual trigger belongs to.
     * @param {string} apiParams.triggerId - (Required) Output only. The unique ID of the manual trigger.
     * @param {string} apiParams.updateMask - Required. The mask to control which fields to update.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.manualTriggers.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/manualTriggers/{+triggerId}', 'PATCH', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser that the manual trigger belongs.
     * @param {string} apiParams.triggerId - (Required) Required. The ID of the manual trigger to activate.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.manualTriggers.activate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/manualTriggers/{+triggerId}:activate', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser that the manual trigger belongs.
     * @param {string} apiParams.triggerId - (Required) Required. The ID of the manual trigger to deactivate.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.manualTriggers.deactivate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/manualTriggers/{+triggerId}:deactivate', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/negativeKeywordLists', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/negativeKeywordLists', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/negativeKeywordLists/{negativeKeywordListId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords/{+keywordValue}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.bulkEdit = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords:bulkEdit', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.negativeKeywordLists.negativeKeywords.replace = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords:replace', 'POST', apiParams, clientConfig);
     ...
     * @param {string} apiParams.youtubeAdGroupAdId - (Required) Required. The ID of the ad group ad to fetch.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroupAds.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroupAds/{+youtubeAdGroupAdId}', 'GET', apiParams, clientConfig);
     ...
     * @param {string} apiParams.filter - Allows filtering by custom YouTube ad group ad fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `adGroupId` * `displayName` * `entityStatus` * `adGroupAdId` Examples: * All ad group ads under an ad group: `adGroupId="1234"` * All ad group ads under an ad group with an entityStatus of `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED`: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupId="12345"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {string} apiParams.orderBy - Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
     * @param {integer} apiParams.pageSize - Requested page size. Must be between `1` and `100`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} apiParams.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroupAds` method. If not specified, the first page of results will be returned.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroupAds.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroupAds', 'GET', apiParams, clientConfig);
     ...
     * @param {string} apiParams.youtubeAdGroupIds - Required. The IDs of the youtube ad groups to list assigned targeting options for.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroups.bulkListAdGroupAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroups:bulkListAdGroupAssignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @param {string} apiParams.youtubeAdGroupId - (Required) Required. The ID of the ad group to fetch.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroups.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroups/{+youtubeAdGroupId}', 'GET', apiParams, clientConfig);

    /**
     * Lists YouTube ad groups.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.advertiserId - (Required) Required. The ID of the advertiser the ad groups belongs to.
     * @param {string} apiParams.filter - Allows filtering by custom YouTube ad group fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported properties: * `adGroupId` * `displayName` * `entityStatus` * `lineItemId` * `adGroupFormat` Examples: * All ad groups under an line item: `lineItemId="1234"` * All `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED` `YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM` ad groups under an advertiser: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupFormat="YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
     * @param {string} apiParams.orderBy - Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.
     * @param {integer} apiParams.pageSize - Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} apiParams.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroups` method. If not specified, the first page of results will be returned.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroups.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroups', 'GET', apiParams, clientConfig);
     ...
     * @param {string} apiParams.youtubeAdGroupId - (Required) Required. The ID of the ad group the assigned targeting option belongs to.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroups.targetingTypes.assignedTargetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroups/{+youtubeAdGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @param {string} apiParams.orderBy - Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.
     * @param {integer} apiParams.pageSize - Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
     * @param {string} apiParams.pageToken - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroupAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
     ...
     * @param {string} apiParams.youtubeAdGroupId - (Required) Required. The ID of the ad group to list assigned targeting options for.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.advertisers.youtubeAdGroups.targetingTypes.assignedTargetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/advertisers/{+advertiserId}/youtubeAdGroups/{+youtubeAdGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.combinedAudiences.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/combinedAudiences/{+combinedAudienceId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.combinedAudiences.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/combinedAudiences', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms/{+customBiddingAlgorithmId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms/{+customBiddingAlgorithmId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.uploadScript = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadScript', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.scripts.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.scripts.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts/{+customBiddingScriptId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customBiddingAlgorithms.scripts.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customLists.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customLists/{+customListId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customLists.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/customLists', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.floodlightGroups.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/floodlightGroups/{+floodlightGroupId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.floodlightGroups.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/floodlightGroups/{floodlightGroupId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.floodlightGroups.floodlightActivities.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/floodlightGroups/{+floodlightGroupId}/floodlightActivities/{+floodlightActivityId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.floodlightGroups.floodlightActivities.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/floodlightGroups/{+floodlightGroupId}/floodlightActivities', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.googleAudiences.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/googleAudiences/{+googleAudienceId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.googleAudiences.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/googleAudiences', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.guaranteedOrders.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/guaranteedOrders', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.guaranteedOrders.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/guaranteedOrders/{+guaranteedOrderId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.guaranteedOrders.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/guaranteedOrders', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.guaranteedOrders.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/guaranteedOrders/{+guaranteedOrderId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.guaranteedOrders.editGuaranteedOrderReadAccessors = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/guaranteedOrders/{+guaranteedOrderId}:editGuaranteedOrderReadAccessors', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{+inventorySourceGroupId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{inventorySourceGroupId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{+inventorySourceGroupId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.assignedInventorySources.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.assignedInventorySources.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.assignedInventorySources.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources/{+assignedInventorySourceId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySourceGroups.assignedInventorySources.bulkEdit = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources:bulkEdit', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySources.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySources/{+inventorySourceId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySources.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySources', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySources.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySources', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySources.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySources/{+inventorySourceId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.inventorySources.editInventorySourceReadWriteAccessors = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/inventorySources/{+inventorySourceId}:editInventorySourceReadWriteAccessors', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.editAssignedTargetingOptions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}:editAssignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/channels/{+channelId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/channels', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/channels', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/channels/{channelId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.sites.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/channels/{+channelId}/sites', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.sites.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{partnerId}/channels/{+channelId}/sites', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.sites.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{partnerId}/channels/{+channelId}/sites/{+urlOrAppId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.sites.bulkEdit = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{partnerId}/channels/{+channelId}/sites:bulkEdit', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.channels.sites.replace = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{partnerId}/channels/{+channelId}/sites:replace', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.targetingTypes.assignedTargetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.targetingTypes.assignedTargetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.targetingTypes.assignedTargetingOptions.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.partners.targetingTypes.assignedTargetingOptions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.sdfdownloadtasks.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/sdfdownloadtasks', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.sdfdownloadtasks.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/{+name}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.targetingTypes.targetingOptions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/targetingTypes/{+targetingType}/targetingOptions/{+targetingOptionId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.targetingTypes.targetingOptions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/targetingTypes/{+targetingType}/targetingOptions', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.targetingTypes.targetingOptions.search = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/targetingTypes/{+targetingType}/targetingOptions:search', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.users.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/users/{+userId}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.users.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/users', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.users.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/users', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.users.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/users/{+userId}', 'PATCH', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.users.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/users/{+userId}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.users.bulkEditAssignedUserRoles = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v2/users/{+userId}:bulkEditAssignedUserRoles', 'POST', apiParams, clientConfig);
