...
- **Last Checked:** Tue, 30 Jun 2026 23:44:23 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:44:23 GMT
...
| `params.view` | `string` | No | Optional. View to control which parts of an entry the service should return. Please check the limitations on returned aspects in the Entry view documentation. Amount of returned aspects depends on the selected Entry View. |
...
#### `projects.locations.modifyEntry()`
...
#### `projects.locations.entryGroups.entryLinks.patch()`
...
#### `projects.locations.changeRequests.get()`

Gets a ChangeRequest.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the ChangeRequest to retrieve. Format: projects/{project_number}/locations/{location_id}/changeRequests/{change_request_id} |

#### `projects.locations.changeRequests.list()`

Lists ChangeRequests.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent, which owns this collection of ChangeRequests. Format: projects/{project_number}/locations/{location_id} |
| `params.pageSize` | `integer` | No | Optional. Maximum number of ChangeRequests to return. The service may return fewer. |
| `params.pageToken` | `string` | No | Optional. Page token received from a previous ListChangeRequests call. |
| `params.filter` | `string` | No | Optional. Filter request. Supports filtering by: state, author, resource, create_time, update_time. |
| `params.orderBy` | `string` | No | Optional. Order by fields for the result. |

#### `projects.locations.changeRequests.patch()`

Updates a ChangeRequest. Only allowed when the state is NEW.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Identifier. The relative resource name of the ChangeRequest, of the form: projects/{project_number}/locations/{location_id}/changeRequests/{change_request_id} |
| `params.updateMask` | `string` | No | Optional. The list of fields to update. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.changeRequests.delete()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the ChangeRequest to delete. Format: projects/{project_number}/locations/{location_id}/changeRequests/{change_request_id} |
| `params.etag` | `string` | No | Optional. The etag of the ChangeRequest. |

#### `projects.locations.changeRequests.approve()`

Approves a ChangeRequest.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the ChangeRequest to approve. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.changeRequests.reject()`

Rejects a ChangeRequest.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the ChangeRequest to reject. |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.dataScans.jobs.cancel()`

Cancels a running/pending DataScan job.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The resource name of the DataScanJob: projects/{project_id_or_number}/locations/{location_id}/dataScans/{data_scan_id}/jobs/{data_scan_job_id} where project_id_or_number refers to a project_id or project_number and location_id refers to a Google Cloud region. |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.dataProducts.requestAccess()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The resource name of the data product. Format: projects/{project_number}/locations/{location_id}/dataProducts/{data_product_id} |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.dataDomains.create()`

Creates a DataDomain resource.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The resource name of the parent location: projects/{project_id_or_number}/locations/{location_id} |
| `params.dataDomainId` | `string` | No | Required. DataDomain identifier. * Must contain only lowercase letters, numbers and hyphens. * Must start with a letter. * Must be between 1-63 characters. * Must end with a number or a letter. * Must be unique within the project and location. |
| `params.validateOnly` | `boolean` | No | Optional. Only validate the request, but do not perform mutations. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.dataDomains.patch()`

Updates a DataDomain resource.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Identifier. The relative resource name of the DataDomain, of the form: projects/{project_id_or_number}/locations/{location_id}/dataDomains/{data_domain_id} |
| `params.updateMask` | `string` | No | Optional. Mask of fields to update. |
| `params.validateOnly` | `boolean` | No | Optional. Only validate the request, but do not perform mutations. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.dataDomains.delete()`

Deletes a DataDomain resource (allowed only when there are no bindings).

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The resource name of the DataDomain: projects/{project_id_or_number}/locations/{location_id}/dataDomains/{data_domain_id} |

#### `projects.locations.dataDomains.list()`
...
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The resource name of the parent location: projects/{project_id_or_number}/locations/{location_id} |
| `params.pageSize` | `integer` | No | Optional. Maximum number of DataDomains to return. The service may return fewer. If unspecified, at most 50 domains will be returned. The maximum value is 100; values above 100 will be coerced to 100. |
| `params.pageToken` | `string` | No | Optional. Page token received from a previous ListDataDomains call. |
| `params.filter` | `string` | No | Optional. Filter request. Supports filter by parent_data_domain. |
| `params.orderBy` | `string` | No | Optional. Order by fields for the result. |

#### `projects.locations.dataDomains.get()`
...
#### `projects.locations.dataDomains.bindings.create()`

Creates a DataDomainBinding resource.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The resource name of the parent DataDomain: projects/{project_id_or_number}/locations/{location_id}/dataDomains/{data_domain_id} |
| `params.dataDomainBindingId` | `string` | No | Optional. DataDomainBinding identifier. * Must contain only lowercase letters, numbers and hyphens. * Must start with a letter. * Must be between 1-63 characters. * Must end with a number or a letter. * Must be unique within the parent DataDomain. If not provided, a system-generated UUID will be used. |
| `params.validateOnly` | `boolean` | No | Optional. Only validate the request, but do not perform mutations. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The resource name of the DataDomainBinding: projects/{project_id_or_number}/locations/{location_id}/dataDomains/{data_domain_id}/bindings/{binding_id} |

#### `projects.locations.dataDomains.bindings.get()`
...
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The resource name of the parent DataDomain: projects/{project_id_or_number}/locations/{location_id}/dataDomains/{data_domain_id} |
| `params.pageSize` | `integer` | No | Optional. Maximum number of DataDomainBindings to return. The service may return fewer. If unspecified, at most 50 bindings will be returned. The maximum value is 100; values above 100 will be coerced to 100. |
| `params.pageToken` | `string` | No | Optional. Page token received from a previous ListDataDomainBindings call. |
| `params.filter` | `string` | No | Optional. Filter request. |
| `params.orderBy` | `string` | No | Optional. Order by fields for the result. |
