...
class Drive {
  ...
  constructor(config = {}) {
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {boolean} apiParams.enforceExpansiveAccess - Deprecated: All requests use the expansive access rules.
     ...
     * @param {boolean} apiParams.transferOwnership - Whether to transfer ownership to the specified user and downgrade the current owner to a writer. This parameter is required as an acknowledgement of the side effect. For more information, see [Transfer file ownership](https://developers.google.com//workspace/drive/api/guides/transfer-file).
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.fileId - The ID of the file for which the JWT should be generated. If not provided, an id will be generated.
     * @param {string} apiParams.parent - The ID of the expected parent of the file. Used when generating a JWT for a new CSE file. If specified, the parent will be fetched, and if the parent is a shared drive item, the shared drive's policy will be used to determine the KACLS that should be used. It is invalid to specify both file_id and parent in a single request.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.files.generateCseToken = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/generateCseToken', 'GET', apiParams, clientConfig);
     ...
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.approvalId - (Required) Required. The ID of the approval to comment on.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.approvals.comment = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/{fileId}/approvals/{approvalId}:comment', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.approvalId - (Required) Required. The ID of the approval to reassign.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.approvals.reassign = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/{fileId}/approvals/{approvalId}:reassign', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is created on.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.approvals.start = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/{fileId}/approvals:start', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.approvalId - (Required) Required. The ID of the approval to approve.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.approvals.approve = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/{fileId}/approvals/{approvalId}:approve', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.approvalId - (Required) Required. The ID of the approval to decline.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.approvals.decline = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/{fileId}/approvals/{approvalId}:decline', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.approvalId - (Required) Required. The ID of the approval to cancel.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.approvals.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('files/{fileId}/approvals/{approvalId}:cancel', 'POST', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.fileId - (Required) Required. The ID of the file that the approval is on.
     * @param {integer} apiParams.pageSize - The maximum number of approvals to return. When not set, at most 100 approvals are returned.
