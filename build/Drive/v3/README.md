...
- **Last Checked:** Tue, 30 Jun 2026 23:52:25 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:52:25 GMT
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | No | The ID of the expected parent of the file. Used when generating a JWT for a new CSE file. If specified, the parent will be fetched, and if the parent is a shared drive item, the shared drive's policy will be used to determine the KACLS that should be used. It is invalid to specify both file_id and parent in a single request. |
| `params.fileId` | `string` | No | The ID of the file for which the JWT should be generated. If not provided, an id will be generated. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.enforceExpansiveAccess` | `boolean` | No | Deprecated: All requests use the expansive access rules. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is created on. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is on. |
| `params.pageSize` | `integer` | No | The maximum number of approvals to return. When not set, at most 100 approvals are returned. |
...
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is on. |
| `params.approvalId` | `string` | Yes | Required. The ID of the approval to comment on. |
| `params.requestBody` | `object` | Yes | The request body. |
...
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is on. |
| `params.approvalId` | `string` | Yes | Required. The ID of the approval to decline. |
| `params.requestBody` | `object` | Yes | The request body. |
...
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is on. |
| `params.approvalId` | `string` | Yes | Required. The ID of the approval to reassign. |
| `params.requestBody` | `object` | Yes | The request body. |
...
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is on. |
| `params.approvalId` | `string` | Yes | Required. The ID of the approval to approve. |
| `params.requestBody` | `object` | Yes | The request body. |
...
|---|---|---|---|
| `params.fileId` | `string` | Yes | Required. The ID of the file that the approval is on. |
| `params.approvalId` | `string` | Yes | Required. The ID of the approval to cancel. |
| `params.requestBody` | `object` | Yes | The request body. |
