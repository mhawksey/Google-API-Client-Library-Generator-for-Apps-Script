...
- **Last Checked:** Fri, 01 May 2026 00:38:47 GMT
- **Last Modified:** Fri, 01 May 2026 00:38:47 GMT
...
#### `projects.locations.workstationClusters.workstationConfigs.workstations.pushCredentials()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.workstation` | `string` | Yes | Required. Name of the workstation for which the credentials should be pushed. |
| `params.requestBody` | `object` | Yes | The request body. |
