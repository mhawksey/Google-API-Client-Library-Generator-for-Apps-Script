...
class AdminDirectory {
  ...
  constructor(config = {}) {
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.customer.devices.chromeos.countChromeOsDevices = async (apiParams = {}, clientConfig = {}) => this._makeRequest('admin/directory/v1/customer/{customerId}/devices/chromeos:countChromeOsDevices', 'GET', apiParams, clientConfig);
