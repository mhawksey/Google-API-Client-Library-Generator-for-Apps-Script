...
- **Last Checked:** Tue, 30 Jun 2026 23:24:25 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:24:25 GMT
...
#### `organizations.locations.workloads.violations.batchAcknowledgeViolations()`
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Optional. The parent resource shared by all violations being acknowledged. Format: organizations/{organization}/locations/{location}/workloads/{workload} |
| `params.requestBody` | `object` | Yes | The request body. |
...
| `params.orderBy` | `string` | No | Optional. Actionable sorting delegation. |
...
#### `organizations.locations.dbFindingSummaries.list()`

Lists the finding summary by category for a given scope.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.pageToken` | `string` | No | Optional. A token that identifies the page of results that the server should return. |
| `params.pageSize` | `integer` | No | Optional. The requested page size. The server might return fewer items than requested. If unspecified, the server picks an appropriate default. |
| `params.filter` | `string` | No | Optional. The filtering results. |
| `params.parent` | `string` | Yes | Required. The parent scope for the framework overview page. Formats: - projects/{project}/locations/{location} - folders/{folder}/locations/{location} - organizations/{organization}/locations/{location} |
...
#### `folders.locations.dbFindingSummaries.list()`
...
#### `projects.locations.dbFindingSummaries.list()`
...
#### `assuredworkloads.revertArchivedResourceEvents()`
...
#### `assuredworkloads.archiveResourceEvents()`
