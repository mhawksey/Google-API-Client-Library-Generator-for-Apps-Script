...
class Assuredworkloads {
  ...
  constructor(config = {}) {
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.parent - (Required) Optional. The parent resource shared by all violations being acknowledged. Format: organizations/{organization}/locations/{location}/workloads/{workload}
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.organizations.locations.workloads.violations.batchAcknowledgeViolations = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/violations:batchAcknowledgeViolations', 'POST', apiParams, clientConfig);
     ...
     * @param {string} apiParams.orderBy - Optional. Actionable sorting delegation.
    ...
    this.organizations.locations.dbFindingSummaries = {};

    /**
     * Lists the finding summary by category for a given scope.
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.filter - Optional. The filtering results.
     * @param {integer} apiParams.pageSize - Optional. The requested page size. The server might return fewer items than requested. If unspecified, the server picks an appropriate default.
     * @param {string} apiParams.pageToken - Optional. A token that identifies the page of results that the server should return.
     * @param {string} apiParams.parent - (Required) Required. The parent scope for the framework overview page. Formats: - projects/{project}/locations/{location} - folders/{folder}/locations/{location} - organizations/{organization}/locations/{location}
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.organizations.locations.dbFindingSummaries.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/dbFindingSummaries', 'GET', apiParams, clientConfig);
    ...
    this.folders.locations.dbFindingSummaries = {};
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.folders.locations.dbFindingSummaries.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/dbFindingSummaries', 'GET', apiParams, clientConfig);

    this.projects = {};

    this.projects.locations = {};

    this.projects.locations.dbFindingSummaries = {};
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.dbFindingSummaries.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/dbFindingSummaries', 'GET', apiParams, clientConfig);

    this.assuredworkloads = {};
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.assuredworkloads.revertArchivedResourceEvents = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/assuredworkloads:revertArchivedResourceEvents', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.assuredworkloads.archiveResourceEvents = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/assuredworkloads:archiveResourceEvents', 'POST', apiParams, clientConfig);
  }
