...
class Policysimulator {
  ...
  constructor(config = {}) {
     ...
     */
    this.operations.list = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.orgPolicyViolationsPreviews.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.accessPolicySimulations.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @param {integer} params.pageSize - The maximum number of Replay objects to return. Defaults to 50. The maximum value is 1000; values above 1000 are rounded down to 1000.
     * @param {string} params.pageToken - A page token, received from a previous Simulator.ListReplays call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to Simulator.ListReplays must match the call that provided the page token.
     * @param {string} params.parent - (Required) Required. The parent resource, in the following format: `{projects|folders|organizations}/{resource-id}/locations/global`, where `{resource-id}` is the ID of the project, folder, or organization that owns the Replay. Example: `projects/my-example-project/locations/global` Only `Replay` objects that are direct children of the provided parent are listed. In other words, `Replay` objects that are children of a project will not be included when the parent is a folder of that project.
     * @return {object} The API response object.
     */
    this.projects.locations.replays.list = (params) => this._makeRequest('v1beta/{+parent}/replays', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.replays.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.replays.create = (params) => this._makeRequest('v1beta/{+parent}/replays', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.replays.operations.list = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.replays.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.replays.results.list = (params) => this._makeRequest('v1beta/{+parent}/results', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.orgPolicyViolationsPreviews.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.accessPolicySimulations.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.replays.list = (params) => this._makeRequest('v1beta/{+parent}/replays', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.replays.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.replays.create = (params) => this._makeRequest('v1beta/{+parent}/replays', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.replays.operations.list = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.replays.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.replays.results.list = (params) => this._makeRequest('v1beta/{+parent}/results', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.accessPolicySimulations.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.replays.list = (params) => this._makeRequest('v1beta/{+parent}/replays', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.replays.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.replays.create = (params) => this._makeRequest('v1beta/{+parent}/replays', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.replays.operations.list = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.replays.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.replays.results.list = (params) => this._makeRequest('v1beta/{+parent}/results', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.orgPolicyViolationsPreviews.list = (params) => this._makeRequest('v1beta/{+parent}/orgPolicyViolationsPreviews', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.orgPolicyViolationsPreviews.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.orgPolicyViolationsPreviews.generate = (params) => this._makeRequest('v1beta/{+parent}/orgPolicyViolationsPreviews:generate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.orgPolicyViolationsPreviews.create = (params) => this._makeRequest('v1beta/{+parent}/orgPolicyViolationsPreviews', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.orgPolicyViolationsPreviews.operations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.orgPolicyViolationsPreviews.orgPolicyViolations.list = (params) => this._makeRequest('v1beta/{+parent}/orgPolicyViolations', 'GET', params);
  }
