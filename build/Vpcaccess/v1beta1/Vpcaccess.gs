...
class Vpcaccess {
  ...
  constructor(config = {}) {
    ...
    this.projects.locations.connectors.create = (params) => this._makeRequest('v1beta1/{+parent}/connectors', 'POST', params);
    this.projects.locations.connectors.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
    this.projects.locations.connectors.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
    this.projects.locations.connectors.list = (params) => this._makeRequest('v1beta1/{+parent}/connectors', 'GET', params);
    this.projects.locations.connectors.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
  }
