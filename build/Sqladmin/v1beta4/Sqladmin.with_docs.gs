...
class Sqladmin {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.id - (Required) The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1beta4/backupRuns/list) method.
     ...
     * @param {string} params.instance - (Required) Required. The name of the Cloud SQL instance.
     * @param {string} params.project - (Required) Required. The project ID of the project that contains the instance.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.instance - (Required) The Cloud SQL instance ID. This doesn't include the project ID.
     ...
     * @param {string} params.instance - (Required) Required. The Cloud SQL instance ID. This doesn't include the project ID. It's composed of lowercase letters, numbers, and hyphens, and it must start with a letter. The total length must be 98 characters or less (Example: instance-id).
     * @param {string} params.project - (Required) Required. The ID of the project that contains the instance (Example: project-id).
     * @return {object} The API response object.
     */
