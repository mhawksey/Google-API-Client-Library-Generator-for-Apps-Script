...
- **Last Checked:** Mon, 01 Dec 2025 01:16:33 GMT
- **Last Modified:** Mon, 01 Dec 2025 01:16:33 GMT
...
| `params.revokeExistingRoles` | `boolean` | No | Optional. revoke the existing roles granted to the user. |
| `params.requestBody` | `object` | Yes | The request body. |