...
class Sqladmin {
  ...
  constructor(config = {}) {
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.instance - (Required) Required. The ID of the Cloud SQL instance to be cloned (source). This does not include the project ID.
     * @param {string} apiParams.project - (Required) Required. Project ID of the source Cloud SQL instance.
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.connect.resolve = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/dns/{dnsName}/locations/{location}:resolveConnectSettings', 'GET', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.operation - (Required) Required. Instance operation ID.
     * @param {string} apiParams.project - (Required) Required. Project ID of the project that contains the instance.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
