...
class Dataform {
  ...
  constructor(config = {}) {
     ...
     * @param {integer} apiParams.pageSize - Optional. Maximum number of TeamFolders to return. The server may return fewer items than requested. If unspecified, the server will pick an appropriate default.
