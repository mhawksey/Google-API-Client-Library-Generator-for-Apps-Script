...
class Servicecontrol {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.serviceName - (Required) Name of the service as specified in the service configuration. For example, `"pubsub.googleapis.com"`. See google.api.Service for the definition of a service name.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.services.allocateQuota = (params) => this._makeRequest('v1/services/{serviceName}:allocateQuota', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.services.check = (params) => this._makeRequest('v1/services/{serviceName}:check', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.services.report = (params) => this._makeRequest('v1/services/{serviceName}:report', 'POST', params);
  }
