...
class Apigateway {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gateways.setIamPolicy = (params) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gateways.getIamPolicy = (params) => this._makeRequest('v1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gateways.testIamPermissions = (params) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.list = (params) => this._makeRequest('v1/{+parent}/configs', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.create = (params) => this._makeRequest('v1/{+parent}/configs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.setIamPolicy = (params) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.getIamPolicy = (params) => this._makeRequest('v1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.apis.configs.testIamPermissions = (params) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', params);
  }
