...
class Cloudsearch {
  ...
  constructor(config = {}) {
     ...
     * @param {string} apiParams.requestOptions.clientDisplayLanguageCode - The BCP-47 language code, such as "pt" or "en". It represents the user's preferred Display Language.
