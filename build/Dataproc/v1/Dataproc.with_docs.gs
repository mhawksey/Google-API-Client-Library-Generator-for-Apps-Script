...
class Dataproc {
  ...
  constructor(config = {}) {
     ...
     * @param {string} apiParams.region - (Required) Required. The region in which to handle the request.
     ...
     * @param {integer} apiParams.pageSize - Optional. The maximum number of clusters to return in each response. The service may return fewer than this value. If unspecified, the default value is 200. The maximum value is 1000.
     * @param {string} apiParams.pageToken - Optional. A page token received from a previous ListClusters call. Provide this token to retrieve the subsequent page.
     * @param {string} apiParams.projectId - (Required) Required. The ID of the Google Cloud Platform project that the cluster belongs to.
     * @param {string} apiParams.region - (Required) Required. The region in which to handle the request.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
