...
- **Last Checked:** Mon, 01 Dec 2025 00:46:13 GMT
- **Last Modified:** Mon, 01 Dec 2025 00:46:13 GMT
...
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the `AabInfo` resource to retrieve. Format: `projects/{project_number}/apps/{app}/aabInfo` |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | The name of the release resource. Format: `projects/{project_number}/apps/{app}/releases/{release}` |
