...
class Binaryauthorization {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.getPolicy = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.updatePolicy = (params) => this._makeRequest('v1beta1/{+name}', 'PUT', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.validateAttestationOccurrence = (params) => this._makeRequest('v1beta1/{+attestor}:validateAttestationOccurrence', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.create = (params) => this._makeRequest('v1beta1/{+parent}/attestors', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.update = (params) => this._makeRequest('v1beta1/{+name}', 'PUT', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.list = (params) => this._makeRequest('v1beta1/{+parent}/attestors', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.getIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.attestors.testIamPermissions = (params) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.policy.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.policy.getIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.policy.testIamPermissions = (params) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.systempolicy.getPolicy = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
  }
