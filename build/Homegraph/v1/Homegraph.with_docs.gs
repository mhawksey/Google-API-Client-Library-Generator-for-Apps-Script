...
class Homegraph {
  ...
  constructor(config = {}) {
     ...
     */
    this.devices.requestSync = (params) => this._makeRequest('v1/devices:requestSync', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.reportStateAndNotification = (params) => this._makeRequest('v1/devices:reportStateAndNotification', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.query = (params) => this._makeRequest('v1/devices:query', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.sync = (params) => this._makeRequest('v1/devices:sync', 'POST', params);
     ...
     * @param {string} params.agentUserId - (Required) Required. Third-party user ID.
     * @param {string} params.requestId - Request ID used for debugging.
     * @return {object} The API response object.
     */
    this.agentUsers.delete = (params) => this._makeRequest('v1/{+agentUserId}', 'DELETE', params);
  }
