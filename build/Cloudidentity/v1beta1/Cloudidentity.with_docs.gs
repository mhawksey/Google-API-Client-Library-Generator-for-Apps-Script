...
class Cloudidentity {
  ...
  constructor(config = {}) {
     ...
     */
    this.devices.create = (params) => this._makeRequest('v1beta1/devices', 'POST', params);

    /**
     * Retrieves the specified device.
     * @param {string} params.customer - Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Customer in format: `customers/{customer_id}`, where customer_id is the customer to whom the device belongs.
     * @param {string} params.name - (Required) Required. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}`, where device_id is the unique ID assigned to the Device.
     * @return {object} The API response object.
     */
    this.devices.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);

    /**
     * Lists/Searches devices.
     * @param {string} params.customer - Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer.
     ...
     * @return {object} The API response object.
     */
    this.devices.list = (params) => this._makeRequest('v1beta1/devices', 'GET', params);

    /**
     * Deletes the specified device.
     * @param {string} params.customer - Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer_id}`, where customer_id is the customer to whom the device belongs.
     * @param {string} params.name - (Required) Required. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}`, where device_id is the unique ID assigned to the Device.
     * @return {object} The API response object.
     */
    this.devices.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);

    /**
     * Wipes all data on the specified device.
     * @param {string} params.name - (Required) Required. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}/deviceUsers/{device_user_id}`, where device_id is the unique ID assigned to the Device, and device_user_id is the unique ID assigned to the User.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.devices.wipe = (params) => this._makeRequest('v1beta1/{+name}:wipe', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.cancelWipe = (params) => this._makeRequest('v1beta1/{+name}:cancelWipe', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.list = (params) => this._makeRequest('v1beta1/{+parent}/deviceUsers', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.lookup = (params) => this._makeRequest('v1beta1/{+parent}:lookup', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.approve = (params) => this._makeRequest('v1beta1/{+name}:approve', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.block = (params) => this._makeRequest('v1beta1/{+name}:block', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.wipe = (params) => this._makeRequest('v1beta1/{+name}:wipe', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.cancelWipe = (params) => this._makeRequest('v1beta1/{+name}:cancelWipe', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.clientStates.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);

    /**
     * Updates the client state for the device user **Note**: This method is available only to customers who have one of the following SKUs: Enterprise Standard, Enterprise Plus, Enterprise for Education, and Cloud Identity Premium
     * @param {string} params.customer - Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer_id}`, where customer_id is the customer to whom the device belongs.
     * @param {string} params.name - (Required) Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the ClientState in format: `devices/{device_id}/deviceUsers/{device_user_id}/clientState/{partner_id}`, where partner_id corresponds to the partner storing the data.
     ...
     * @return {object} The API response object.
     */
    this.devices.deviceUsers.clientStates.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.create = (params) => this._makeRequest('v1beta1/groups', 'POST', params);

    /**
     * Retrieves a `Group`.
     * @param {string} params.name - (Required) Required. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Group` to retrieve. Must be of the form `groups/{group_id}`.
     * @return {object} The API response object.
     */
    this.groups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.getSecuritySettings = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.updateSecuritySettings = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);

    /**
     * Updates a `Group`.
     * @param {string} params.name - (Required) Output only. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Group`. Shall be of the form `groups/{group_id}`.
     * @param {string} params.updateMask - Required. The names of fields to update. May only contain the following field names: `display_name`, `description`, `labels`, `dynamic_group_metadata`, `posix_groups`.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.groups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.lookup = (params) => this._makeRequest('v1beta1/groups:lookup', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.search = (params) => this._makeRequest('v1beta1/groups:search', 'GET', params);

    /**
     * Lists the `Group` resources under a customer or namespace.
     * @param {integer} params.pageSize - The maximum number of results to return. Note that the number of results returned may be less than this value even if there are more available results. To fetch all results, clients must continue calling this method repeatedly until the response no longer contains a `next_page_token`. If unspecified, defaults to 200 for `View.BASIC` and to 50 for `View.FULL`. Must not be greater than 1000 for `View.BASIC` or 500 for `View.FULL`.
     * @param {string} params.pageToken - The `next_page_token` value returned from a previous list request, if any.
     * @param {string} params.parent - Required. The parent resource under which to list all `Group` resources. Must be of the form `identitysources/{identity_source_id}` for external- identity-mapped groups or `customers/{customer_id}` for Google Groups. The `customer_id` must begin with "C" (for example, 'C046psxkn'). [Find your customer ID.] (https://support.google.com/cloudidentity/answer/10070793)
     * @param {string} params.view - The level of detail to be returned. If unspecified, defaults to `View.BASIC`.
     * @return {object} The API response object.
     */
    this.groups.list = (params) => this._makeRequest('v1beta1/groups', 'GET', params);

    this.groups.memberships = {};

    /**
     * Creates a `Membership`.
     * @param {string} params.parent - (Required) Required. The parent `Group` resource under which to create the `Membership`. Must be of the form `groups/{group_id}`.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.groups.memberships.create = (params) => this._makeRequest('v1beta1/{+parent}/memberships', 'POST', params);

    /**
     * Retrieves a `Membership`.
     * @param {string} params.name - (Required) Required. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Membership` to retrieve. Must be of the form `groups/{group_id}/memberships/{membership_id}`.
     * @return {object} The API response object.
     */
    this.groups.memberships.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);

    /**
     * Deletes a `Membership`.
     * @param {string} params.name - (Required) Required. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Membership` to delete. Must be of the form `groups/{group_id}/memberships/{membership_id}`.
     * @return {object} The API response object.
     */
    this.groups.memberships.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @param {string} params.parent - (Required) Required. The parent `Group` resource under which to lookup the `Membership` name. Must be of the form `groups/{group_id}`.
     * @return {object} The API response object.
     */
    this.groups.memberships.lookup = (params) => this._makeRequest('v1beta1/{+parent}/memberships:lookup', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.memberships.list = (params) => this._makeRequest('v1beta1/{+parent}/memberships', 'GET', params);

    /**
     * Modifies the `MembershipRole`s of a `Membership`.
     * @param {string} params.name - (Required) Required. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Membership` whose roles are to be modified. Must be of the form `groups/{group_id}/memberships/{membership_id}`.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.groups.memberships.modifyMembershipRoles = (params) => this._makeRequest('v1beta1/{+name}:modifyMembershipRoles', 'POST', params);
     ...
     * @param {string} params.pageToken - The next_page_token value returned from a previous list request, if any.
     * @param {string} params.parent - (Required) [Resource name](https://cloud.google.com/apis/design/resource_names) of the group to search transitive memberships in. Format: `groups/{group_id}`, where `group_id` is the unique ID assigned to the Group.
     * @return {object} The API response object.
     */
    this.groups.memberships.searchTransitiveMemberships = (params) => this._makeRequest('v1beta1/{+parent}/memberships:searchTransitiveMemberships', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.memberships.searchTransitiveGroups = (params) => this._makeRequest('v1beta1/{+parent}/memberships:searchTransitiveGroups', 'GET', params);

    /**
     * Check a potential member for membership in a group. **Note:** This feature is only available to Google Workspace Enterprise Standard, Enterprise Plus, and Enterprise for Education; and Cloud Identity Premium accounts. A member has membership to a group as long as there is a single viewable transitive membership between the group and the member. The actor must have view permissions to at least one transitive membership between the member and group.
     * @param {string} params.parent - (Required) [Resource name](https://cloud.google.com/apis/design/resource_names) of the group to check the transitive membership in. Format: `groups/{group_id}`, where `group_id` is the unique id assigned to the Group to which the Membership belongs to.
     ...
     * @return {object} The API response object.
     */
    this.groups.memberships.checkTransitiveMembership = (params) => this._makeRequest('v1beta1/{+parent}/memberships:checkTransitiveMembership', 'GET', params);

    /**
     * Get a membership graph of just a member or both a member and a group. **Note:** This feature is only available to Google Workspace Enterprise Standard, Enterprise Plus, and Enterprise for Education; and Cloud Identity Premium accounts. Given a member, the response will contain all membership paths from the member. Given both a group and a member, the response will contain all membership paths between the group and the member.
     * @param {string} params.parent - (Required) Required. [Resource name](https://cloud.google.com/apis/design/resource_names) of the group to search transitive memberships in. Format: `groups/{group_id}`, where `group_id` is the unique ID assigned to the Group to which the Membership belongs to. group_id can be a wildcard collection id "-". When `group_id` is specified, the membership graph will be constrained to paths between the member (defined in the query) and the parent. If a wildcard collection is provided, all membership paths connected to the member will be returned.
     ...
     * @return {object} The API response object.
     */
    this.groups.memberships.getMembershipGraph = (params) => this._makeRequest('v1beta1/{+parent}/memberships:getMembershipGraph', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.groups.memberships.searchDirectGroups = (params) => this._makeRequest('v1beta1/{+parent}/memberships:searchDirectGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.create = (params) => this._makeRequest('v1beta1/inboundSamlSsoProfiles', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.list = (params) => this._makeRequest('v1beta1/inboundSamlSsoProfiles', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.idpCredentials.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSamlSsoProfiles.idpCredentials.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSsoAssignments.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSsoAssignments.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.inboundSsoAssignments.list = (params) => this._makeRequest('v1beta1/inboundSsoAssignments', 'GET', params);
     ...
     * @param {string} params.customer - Required. Immutable. Customer that this OrgMembership belongs to. All authorization will happen on the role assignments of this customer. Format: customers/{$customerId} where `$customerId` is the `id` from the [Admin SDK `Customer` resource](https://developers.google.com/admin-sdk/directory/reference/rest/v1/customers). You may also use `customers/my_customer` to specify your own organization.
     * @param {string} params.filter - The search query. Must be specified in [Common Expression Language](https://opensource.google/projects/cel). May only contain equality operators on the `type` (e.g., `type == 'shared_drive'`).
     * @param {integer} params.pageSize - The maximum number of results to return. The service may return fewer than this value. If omitted (or defaulted to zero) the server will default to 50. The maximum allowed value is 100, though requests with page_size greater than that will be silently interpreted as 100.
     * @param {string} params.pageToken - A page token, received from a previous `OrgMembershipsService.ListOrgMemberships` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListOrgMembershipsRequest` must match the call that provided the page token.
     * @param {string} params.parent - (Required) Required. Immutable. OrgUnit which is queried for a list of memberships. Format: orgUnits/{$orgUnitId} where `$orgUnitId` is the `orgUnitId` from the [Admin SDK `OrgUnit` resource](https://developers.google.com/admin-sdk/directory/reference/rest/v1/orgunits).
     * @return {object} The API response object.
     */
    this.orgUnits.memberships.list = (params) => this._makeRequest('v1beta1/{+parent}/memberships', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.list = (params) => this._makeRequest('v1beta1/policies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customers.userinvitations.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customers.userinvitations.list = (params) => this._makeRequest('v1beta1/{+parent}/userinvitations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.customers.userinvitations.send = (params) => this._makeRequest('v1beta1/{+name}:send', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.customers.userinvitations.cancel = (params) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.customers.userinvitations.isInvitableUser = (params) => this._makeRequest('v1beta1/{+name}:isInvitableUser', 'GET', params);
  }
