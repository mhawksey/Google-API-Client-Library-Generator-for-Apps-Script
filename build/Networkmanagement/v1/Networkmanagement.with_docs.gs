...
class Networkmanagement {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.operations.list = (params) => this._makeRequest('v1/{+name}/operations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.list = (params) => this._makeRequest('v1/{+parent}/connectivityTests', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.create = (params) => this._makeRequest('v1/{+parent}/connectivityTests', 'POST', params);
     ...
     * @param {string} params.name - (Required) Identifier. Unique name of the resource using the form: `projects/{project_id}/locations/global/connectivityTests/{test_id}`
     * @param {string} params.updateMask - Required. Mask of fields to update. At least one path must be supplied in this field.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.rerun = (params) => this._makeRequest('v1/{+name}:rerun', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.setIamPolicy = (params) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.getIamPolicy = (params) => this._makeRequest('v1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.global.connectivityTests.testIamPermissions = (params) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @param {string} params.networkMonitoringProviderId - Required. The ID to use for the NetworkMonitoringProvider resource, which will become the final component of the NetworkMonitoringProvider resource's name.
     * @param {string} params.parent - (Required) Required. Parent value for CreateNetworkMonitoringProviderRequest. Format: projects/{project}/locations/{location}
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.create = (params) => this._makeRequest('v1/{+parent}/networkMonitoringProviders', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @param {integer} params.pageSize - Optional. The maximum number of monitoring points to return. The service may return fewer than this value. If unspecified, at most 20 monitoring points will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
     * @param {string} params.pageToken - Optional. A page token, received from a previous `ListMonitoringPoints` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListMonitoringPoints` must match the call that provided the page token.
     * @param {string} params.parent - (Required) Required. Parent value for ListMonitoringPointsRequest. Format: projects/{project}/locations/{location}/networkMonitoringProviders/{network_monitoring_provider}
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.monitoringPoints.list = (params) => this._makeRequest('v1/{+parent}/monitoringPoints', 'GET', params);

    /**
     * Gets the MonitoringPoint resource.
     * @param {string} params.name - (Required) Required. Name of the resource. Format: projects/{project}/locations/{location}/networkMonitoringProviders/{network_monitoring_provider}/monitoringPoints/{monitoring_point}
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.monitoringPoints.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @param {integer} params.pageSize - Optional. The maximum number of network paths to return. The service may return fewer than this value. If unspecified, at most 20 network pathswill be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
     * @param {string} params.pageToken - Optional. A page token, received from a previous `ListNetworkPaths` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListNetworkPaths` must match the call that provided the page token.
     * @param {string} params.parent - (Required) Required. Parent value for ListNetworkPathsRequest. Format: projects/{project}/locations/{location}/networkMonitoringProviders/{network_monitoring_provider}
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.networkPaths.list = (params) => this._makeRequest('v1/{+parent}/networkPaths', 'GET', params);

    /**
     * Gets the NetworkPath resource.
     * @param {string} params.name - (Required) Required. Name of the resource. Format: projects/{project}/locations/{location}/networkMonitoringProviders/{network_monitoring_provider}/networkPaths/{network_path}
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.networkPaths.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);

    this.projects.locations.networkMonitoringProviders.webPaths = {};

    /**
     * Lists WebPaths for a given network monitoring provider.
     * @param {integer} params.pageSize - Optional. The maximum number of web paths to return. The service may return fewer than this value. If unspecified, at most 20 web paths will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
     * @param {string} params.pageToken - Optional. A page token, received from a previous `ListWebPaths` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListWebPaths` must match the call that provided the page token.
     * @param {string} params.parent - (Required) Required. Parent value for ListWebPathsRequest. Format: projects/{project}/locations/{location}/networkMonitoringProviders/{network_monitoring_provider}
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.webPaths.list = (params) => this._makeRequest('v1/{+parent}/webPaths', 'GET', params);

    /**
     * Gets the WebPath resource.
     * @param {string} params.name - (Required) Required. Name of the resource.. Format: projects/{project}/locations/{location}/networkMonitoringProviders/{network_monitoring_provider}/webPaths/{web_path}
     * @return {object} The API response object.
     */
    this.projects.locations.networkMonitoringProviders.webPaths.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.vpcFlowLogsConfigs.list = (params) => this._makeRequest('v1/{+parent}/vpcFlowLogsConfigs', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.vpcFlowLogsConfigs.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.vpcFlowLogsConfigs.create = (params) => this._makeRequest('v1/{+parent}/vpcFlowLogsConfigs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.vpcFlowLogsConfigs.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.vpcFlowLogsConfigs.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.list = (params) => this._makeRequest('v1/{+name}/locations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
