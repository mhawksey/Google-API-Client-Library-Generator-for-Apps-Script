...
/**
 * Google Apps Script client library for the PageSpeed Insights API
 * Documentation URL: https://developers.google.com/speed/docs/insights/v5/about
 * @class
 */
class Pagespeedonline {
  ...
  constructor(config = {}) {
    ...
    this._rootUrl = 'https://pagespeedonline.googleapis.com/';
    this._servicePath = '';
     ...
     * @param {string} params.url - (Required) Required. The URL to fetch and analyze
     ...
     */
    this.pagespeedapi.runpagespeed = (params) => this._makeRequest('pagespeedonline/v5/runPagespeed', 'GET', params);
  }
