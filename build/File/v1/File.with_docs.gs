...
class File {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.name - (Required) Output only. The resource name of the instance, in the format `projects/{project}/locations/{location}/instances/{instance}`.
     * @param {string} params.updateMask - Mask of fields to update. At least one path must be supplied in this field. The elements of the repeated paths field may only include these fields: * "description" * "file_shares" * "labels" * "performance_config" * "deletion_protection_enabled" * "deletion_protection_reason"
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Required. The resource name of the instance, in the format `projects/{project_number}/locations/{location_id}/instances/{instance_id}`.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.revert = (params) => this._makeRequest('v1/{+name}:revert', 'POST', params);

    /**
     * Deletes an instance.
     * @param {boolean} params.force - If set to true, all snapshots of the instance will also be deleted. (Otherwise, the request will only work if the instance has no snapshots.)
     * @param {string} params.name - (Required) Required. The instance resource name, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`
     * @return {object} The API response object.
     */
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.promoteReplica = (params) => this._makeRequest('v1/{+name}:promoteReplica', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.snapshots.list = (params) => this._makeRequest('v1/{+parent}/snapshots', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.snapshots.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.snapshots.create = (params) => this._makeRequest('v1/{+parent}/snapshots', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.snapshots.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.snapshots.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @param {string} params.name - (Required) Required. The backup resource name, in the format `projects/{project_number}/locations/{location}/backups/{backup_id}`.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. The backup's project and location, in the format `projects/{project_number}/locations/{location}`. In Filestore, backup locations map to Google Cloud regions, for example **us-west1**.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Output only. The resource name of the backup, in the format `projects/{project_number}/locations/{location_id}/backups/{backup_id}`.
     * @param {string} params.updateMask - Required. Mask of fields to update. At least one path must be supplied in this field.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
