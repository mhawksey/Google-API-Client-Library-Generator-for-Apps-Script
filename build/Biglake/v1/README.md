# Lakehouse API - Apps Script Client Library

Auto-generated client library for using the **Lakehouse API (version: v1)** in Google Apps Script.

## Metadata

- **Last Checked:** Tue, 30 Jun 2026 23:24:57 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:24:57 GMT
...
#### `projects.catalogs.testIamPermissions()`
...
#### `projects.catalogs.namespaces.testIamPermissions()`
...
#### `projects.catalogs.namespaces.tables.getIamPolicy()`
...
#### `projects.catalogs.namespaces.tables.setIamPolicy()`
...
#### `projects.catalogs.namespaces.tables.testIamPermissions()`
