...
class Iam {
  ...
  constructor(config = {}) {
     ...
     */
    this.policies.listPolicies = (params) => this._makeRequest('v2beta/{+parent}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.get = (params) => this._makeRequest('v2beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.createPolicy = (params) => this._makeRequest('v2beta/{+parent}', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.update = (params) => this._makeRequest('v2beta/{+name}', 'PUT', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.delete = (params) => this._makeRequest('v2beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.policies.operations.get = (params) => this._makeRequest('v2beta/{+name}', 'GET', params);
  }
