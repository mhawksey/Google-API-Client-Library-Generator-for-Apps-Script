...
class Cloudkms {
  ...
  constructor(config = {}) {
     ...
     * @param {string} apiParams.name - (Required) Identifier. Name of the AutokeyConfig resource, e.g. `folders/{FOLDER_NUMBER}/autokeyConfig` or `projects/{PROJECT_NUMBER}/autokeyConfig`.
