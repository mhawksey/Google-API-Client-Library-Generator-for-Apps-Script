...
class Aiplatform {
  ...
  constructor(config = {}) {
    ...
    this.skills.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.skills.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.skills.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.skills.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.skills.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}/operations', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.askContexts = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}:askContexts', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.generateLossClusters = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+location}:generateLossClusters', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.generateUserScenarios = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+location}:generateUserScenarios', 'POST', apiParams, clientConfig);
    this.projects.locations.updateSemanticGovernancePolicyEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.getSemanticGovernancePolicyEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.asyncRetrieveContexts = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}:asyncRetrieveContexts', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.skills.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.skills.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.skills.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    ...
    this.projects.locations.publishers.models.invoke.invoke = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+endpoint}/invoke/{+invokeId}', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.onlineEvaluators.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/onlineEvaluators', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.activate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:activate', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.suspend = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:suspend', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/onlineEvaluators', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'PATCH', apiParams, clientConfig);

    this.projects.locations.onlineEvaluators.operations = {};
    this.projects.locations.onlineEvaluators.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.asyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:asyncQuery', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.cancelAsyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancelAsyncQuery', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+resource}:getIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.memories.ingestEvents = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/memories:ingestEvents', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.runtimeRevisions.query = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:query', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.streamQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:streamQuery', 'POST', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/sandboxEnvironmentSnapshots', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/sandboxEnvironmentTemplates', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/sandboxEnvironmentTemplates', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.sandboxEnvironments.snapshot = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:snapshot', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironments.pause = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:pause', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.sandboxEnvironments.resume = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:resume', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.semanticGovernancePolicies.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/semanticGovernancePolicies', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/semanticGovernancePolicies', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);

    this.projects.locations.semanticGovernancePolicies.operations = {};
    this.projects.locations.semanticGovernancePolicies.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);

    this.projects.locations.agents = {};
    this.projects.locations.agents.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.agents.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.agents.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/agents', 'GET', apiParams, clientConfig);
    this.projects.locations.agents.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.agents.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/agents', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.evaluationSets.import = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/evaluationSets:import', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.semanticGovernancePolicyEngine.deprovision = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:deprovision', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.endpoints.openapi.responses = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+endpoint}/responses', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.cancelAsyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancelAsyncQuery', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.asyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:asyncQuery', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.sandboxEnvironments.resume = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:resume', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.sandboxEnvironments.snapshot = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:snapshot', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.pause = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:pause', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.sandboxEnvironmentTemplates.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/sandboxEnvironmentTemplates', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/sandboxEnvironmentTemplates', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentTemplates.operations = {};
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentSnapshots = {};
    this.reasoningEngines.sandboxEnvironmentSnapshots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/sandboxEnvironmentSnapshots', 'GET', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentSnapshots.operations = {};
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.runtimeRevisions.query = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:query', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.streamQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:streamQuery', 'POST', apiParams, clientConfig);
    ...
    this.onlineEvaluators.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.onlineEvaluators.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.onlineEvaluators.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.onlineEvaluators.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.onlineEvaluators.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    ...
    this.semanticGovernancePolicies.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'GET', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}/operations', 'GET', apiParams, clientConfig);
