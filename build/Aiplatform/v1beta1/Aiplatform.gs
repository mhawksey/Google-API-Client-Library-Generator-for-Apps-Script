...
class Aiplatform {
  ...
  constructor(config = {}) {
    ...
    this.semanticGovernancePolicyEngine = {};

    this.semanticGovernancePolicyEngine.operations = {};
    this.semanticGovernancePolicyEngine.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.semanticGovernancePolicyEngine.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.semanticGovernancePolicyEngine.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.semanticGovernancePolicyEngine.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.semanticGovernancePolicyEngine.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.semanticGovernancePolicyEngine.operations = {};
    this.projects.locations.semanticGovernancePolicyEngine.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicyEngine.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicyEngine.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicyEngine.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicyEngine.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
