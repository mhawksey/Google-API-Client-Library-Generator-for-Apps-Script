...
/**
 * Google Apps Script client library for the Agent Platform API
...
class Aiplatform {
  ...
  constructor(config = {}) {
    ...
    this.extensions.operations = {};
    this.extensions.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.extensions.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.extensions.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.extensions.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.extensions.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.evaluationRuns = {};

    this.evaluationRuns.operations = {};
    this.evaluationRuns.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.evaluationRuns.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.evaluationRuns.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.evaluationRuns.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.notebookRuntimes = {};

    this.notebookRuntimes.operations = {};
    this.notebookRuntimes.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.notebookRuntimes.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.notebookRuntimes.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.notebookRuntimes.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.notebookRuntimes.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.models = {};

    this.models.operations = {};
    this.models.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.models.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.models.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.models.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.models.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.models.evaluations = {};

    this.models.evaluations.operations = {};
    this.models.evaluations.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.models.evaluations.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.models.evaluations.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.models.evaluations.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.models.evaluations.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.ragCorpora = {};

    this.ragCorpora.operations = {};
    this.ragCorpora.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.ragCorpora.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.ragCorpora.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.ragCorpora.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.ragCorpora.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.ragCorpora.ragFiles = {};

    this.ragCorpora.ragFiles.operations = {};
    this.ragCorpora.ragFiles.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.ragCorpora.ragFiles.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.ragCorpora.ragFiles.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.ragCorpora.ragFiles.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.ragCorpora.ragFiles.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.schedules = {};

    this.schedules.operations = {};
    this.schedules.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.schedules.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.schedules.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.schedules.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.schedules.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.specialistPools = {};

    this.specialistPools.operations = {};
    this.specialistPools.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.specialistPools.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.specialistPools.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.specialistPools.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.specialistPools.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.evaluationItems.operations = {};
    this.evaluationItems.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.evaluationItems.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.evaluationItems.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.evaluationItems.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.solvers = {};

    this.solvers.operations = {};
    this.solvers.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.solvers.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.solvers.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.agents = {};

    this.agents.operations = {};
    this.agents.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.agents.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.agents.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.agents.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.agents.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.evaluationTasks = {};

    this.evaluationTasks.operations = {};
    this.evaluationTasks.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.evaluationTasks.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.evaluationTasks.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.evaluationTasks.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.skills = {};

    this.skills.operations = {};
    this.skills.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.skills.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.skills.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.skills.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.skills.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.vertexExpress = {};
    this.vertexExpress.retrieveExpressProject = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/vertexExpress:retrieveExpressProject', 'GET', apiParams, clientConfig);
    this.vertexExpress.signUp = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/vertexExpress:signUp', 'POST', apiParams, clientConfig);

    this.vertexExpress.Eligibility = {};
    this.vertexExpress.Eligibility.check = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/vertexExpress/Eligibility:check', 'GET', apiParams, clientConfig);

    this.apps = {};

    this.apps.operations = {};
    this.apps.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.apps.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.apps.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.apps.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.apps.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.featureOnlineStores = {};

    this.featureOnlineStores.operations = {};
    this.featureOnlineStores.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.featureOnlineStores.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featureOnlineStores.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featureOnlineStores.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.featureOnlineStores.featureViews = {};

    this.featureOnlineStores.featureViews.operations = {};
    this.featureOnlineStores.featureViews.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featureOnlineStores.featureViews.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.featureOnlineStores.featureViews.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featureOnlineStores.featureViews.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.extensionControllers = {};

    this.extensionControllers.operations = {};
    this.extensionControllers.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.extensionControllers.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.extensionControllers.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.extensionControllers.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.extensionControllers.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.indexEndpoints = {};

    this.indexEndpoints.operations = {};
    this.indexEndpoints.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.indexEndpoints.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.indexEndpoints.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.indexEndpoints.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.indexEndpoints.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.trainingPipelines = {};

    this.trainingPipelines.operations = {};
    this.trainingPipelines.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.trainingPipelines.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.trainingPipelines.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.trainingPipelines.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.trainingPipelines.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.semanticGovernancePolicies = {};

    this.semanticGovernancePolicies.operations = {};
    this.semanticGovernancePolicies.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.semanticGovernancePolicies.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.updateSemanticGovernancePolicyEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'PATCH', apiParams, clientConfig);
    ...
    this.projects.locations.generateLossClusters = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+location}:generateLossClusters', 'POST', apiParams, clientConfig);
    this.projects.locations.askContexts = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}:askContexts', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.asyncRetrieveContexts = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}:asyncRetrieveContexts', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.generateUserScenarios = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+location}:generateUserScenarios', 'POST', apiParams, clientConfig);
    this.projects.locations.getSemanticGovernancePolicyEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.datasets.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.evaluationSets.import = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/evaluationSets:import', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.semanticGovernancePolicies = {};
    this.projects.locations.semanticGovernancePolicies.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/semanticGovernancePolicies', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/semanticGovernancePolicies', 'POST', apiParams, clientConfig);

    this.projects.locations.semanticGovernancePolicies.operations = {};
    this.projects.locations.semanticGovernancePolicies.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.semanticGovernancePolicies.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    ...
    this.projects.locations.semanticGovernancePolicyEngine = {};
    this.projects.locations.semanticGovernancePolicyEngine.deprovision = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:deprovision', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.featureOnlineStores.featureViews.generateFetchAccessToken = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+featureView}:generateFetchAccessToken', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.skills = {};
    this.projects.locations.skills.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.skills.retrieve = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/skills:retrieve', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/skills', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/skills', 'POST', apiParams, clientConfig);
    this.projects.locations.skills.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'PATCH', apiParams, clientConfig);

    this.projects.locations.skills.operations = {};
    this.projects.locations.skills.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.skills.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.skills.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.projects.locations.skills.revisions = {};
    this.projects.locations.skills.revisions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/revisions', 'GET', apiParams, clientConfig);
    this.projects.locations.skills.revisions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.agents.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/agents', 'GET', apiParams, clientConfig);
    this.projects.locations.agents.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.agents.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.agents.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.agents.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/agents', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.agentAnomalyDetectionScopes = {};
    this.projects.locations.agentAnomalyDetectionScopes.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.agentAnomalyDetectionScopes.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/agentAnomalyDetectionScopes', 'POST', apiParams, clientConfig);
    this.projects.locations.agentAnomalyDetectionScopes.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.agentAnomalyDetectionScopes.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/agentAnomalyDetectionScopes', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.ragCorpora.ragDataSchemas = {};
    this.projects.locations.ragCorpora.ragDataSchemas.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragDataSchemas', 'GET', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragDataSchemas.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragDataSchemas.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragDataSchemas.batchDelete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragDataSchemas:batchDelete', 'POST', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragDataSchemas.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragDataSchemas', 'POST', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragDataSchemas.batchCreate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragDataSchemas:batchCreate', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.ragCorpora.ragFiles.ragMetadata = {};
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragMetadata', 'GET', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragMetadata', 'POST', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.batchCreate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragMetadata:batchCreate', 'POST', apiParams, clientConfig);
    this.projects.locations.ragCorpora.ragFiles.ragMetadata.batchDelete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/ragMetadata:batchDelete', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.interactions = {};
    this.projects.locations.interactions.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/projects/{projectsId}/locations/{locationsId}/interactions:create', 'POST', apiParams, clientConfig);
    this.projects.locations.interactions.createStream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/projects/{projectsId}/locations/{locationsId}/interactions:createStream', 'POST', apiParams, clientConfig);
    this.projects.locations.interactions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    ...
    this.projects.locations.tuningJobs.validateReinforcementTuningReward = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/tuningJobs:validateReinforcementTuningReward', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.tuningJobs.processData = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/tuningJobs:processData', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.endpoints.responses = {};
    this.projects.locations.endpoints.responses.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.endpoints.responses.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.projects.locations.endpoints.google = {};

    this.projects.locations.endpoints.google.science = {};
    this.projects.locations.endpoints.google.science.inference = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+endpoint}/science/inference', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.endpoints.openapi.responses = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+endpoint}/responses', 'POST', apiParams, clientConfig);
    this.projects.locations.endpoints.openapi.completions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+endpoint}/completions', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.servingProfiles = {};

    this.projects.locations.servingProfiles.operations = {};
    this.projects.locations.servingProfiles.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.servingProfiles.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.servingProfiles.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.servingProfiles.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.servingProfiles.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.monitoredAgents = {};
    this.projects.locations.monitoredAgents.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/monitoredAgents', 'GET', apiParams, clientConfig);
    this.projects.locations.monitoredAgents.disable = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:disable', 'POST', apiParams, clientConfig);
    this.projects.locations.monitoredAgents.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.monitoredAgents.enable = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:enable', 'POST', apiParams, clientConfig);

    this.projects.locations.monitoredAgents.analyzedSessions = {};
    this.projects.locations.monitoredAgents.analyzedSessions.aggregate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/analyzedSessions:aggregate', 'GET', apiParams, clientConfig);
    this.projects.locations.monitoredAgents.analyzedSessions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/analyzedSessions', 'GET', apiParams, clientConfig);
    this.projects.locations.monitoredAgents.analyzedSessions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.monitoredAgents.analyzedSessions.analyzedInvocations = {};
    this.projects.locations.monitoredAgents.analyzedSessions.analyzedInvocations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.monitoredAgents.analyzedSessions.analyzedInvocations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/analyzedInvocations', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.publishers.models.embedContent = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+model}:embedContent', 'POST', apiParams, clientConfig);

    this.projects.locations.publishers.models.invoke = {};
    this.projects.locations.publishers.models.invoke.invoke = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+endpoint}/invoke/{+invokeId}', 'POST', apiParams, clientConfig);

    this.projects.locations.reasoningEngines = {};
    this.projects.locations.reasoningEngines.cancelAsyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancelAsyncQuery', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.testIamPermissions = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.executeCode = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:executeCode', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.asyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:asyncQuery', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.runtimeRevisions = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.query = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:query', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/runtimeRevisions', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.streamQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:streamQuery', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.operations = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.card = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.message = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:stream', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:send', 'POST', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks.pushNotificationConfigs = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:subscribe', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks.pushNotificationConfigs = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.tasks.pushNotificationConfigs.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1 = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.card = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.message = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:send', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:stream', 'POST', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:subscribe', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks.pushNotificationConfigs = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks.pushNotificationConfigs = {};
    this.projects.locations.reasoningEngines.runtimeRevisions.a2a.v1.tasks.pushNotificationConfigs.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.a2aTasks = {};
    this.projects.locations.reasoningEngines.a2aTasks.appendEvents = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:appendEvents', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2aTasks.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2aTasks.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/a2aTasks', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2aTasks.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/a2aTasks', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2aTasks.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.a2aTasks.events = {};
    this.projects.locations.reasoningEngines.a2aTasks.events.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/events', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.feedbackEntries = {};

    this.projects.locations.reasoningEngines.feedbackEntries.operations = {};
    this.projects.locations.reasoningEngines.feedbackEntries.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.feedbackEntries.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.feedbackEntries.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.feedbackEntries.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.feedbackEntries.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironmentSnapshots', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentSnapshots.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironmentTemplates', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironmentTemplates', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations = {};
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironmentTemplates.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.memories.purge = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/memories:purge', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.memories.ingestEvents = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/memories:ingestEvents', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.memories.rollback = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:rollback', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.memories.retrieveProfiles = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/memories:retrieveProfiles', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.memories.revisions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.memories.revisions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/revisions', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.sandboxEnvironments.pause = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:pause', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.sandboxEnvironments.resume = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:resume', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.sandboxEnvironments.snapshot = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:snapshot', 'POST', apiParams, clientConfig);
    ...
    this.projects.locations.reasoningEngines.a2a.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.card = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.a2a.message = {};
    this.projects.locations.reasoningEngines.a2a.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:stream', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:send', 'POST', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.a2a.tasks = {};
    this.projects.locations.reasoningEngines.a2a.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.tasks.pushNotificationConfigs = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.tasks.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:subscribe', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.a2a.tasks.pushNotificationConfigs = {};
    this.projects.locations.reasoningEngines.a2a.tasks.pushNotificationConfigs.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.projects.locations.reasoningEngines.a2a.v1 = {};
    this.projects.locations.reasoningEngines.a2a.v1.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.projects.locations.reasoningEngines.a2a.v1.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    ...
    this.projects.locations.onlineEvaluators = {};
    this.projects.locations.onlineEvaluators.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/onlineEvaluators', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.patch = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'PATCH', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.activate = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:activate', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/onlineEvaluators', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.suspend = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:suspend', 'POST', apiParams, clientConfig);

    this.projects.locations.onlineEvaluators.operations = {};
    this.projects.locations.onlineEvaluators.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.onlineEvaluators.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.projects.locations.evaluationMetrics = {};
    this.projects.locations.evaluationMetrics.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.evaluationMetrics.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/evaluationMetrics', 'GET', apiParams, clientConfig);
    this.projects.locations.evaluationMetrics.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/evaluationMetrics', 'POST', apiParams, clientConfig);
    this.projects.locations.evaluationMetrics.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.projects.locations.evaluationMetrics.operations = {};
    this.projects.locations.evaluationMetrics.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.projects.locations.evaluationMetrics.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.projects.locations.evaluationMetrics.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    ...
    this.edgeDevices.operations = {};
    this.edgeDevices.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.edgeDevices.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.edgeDevices.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.edgeDevices.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.edgeDevices.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.featurestores = {};

    this.featurestores.operations = {};
    this.featurestores.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featurestores.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.featurestores.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.featurestores.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.featurestores.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.featurestores.entityTypes = {};

    this.featurestores.entityTypes.operations = {};
    this.featurestores.entityTypes.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.featurestores.entityTypes.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.featurestores.entityTypes.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featurestores.entityTypes.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featurestores.entityTypes.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.featurestores.entityTypes.features = {};

    this.featurestores.entityTypes.features.operations = {};
    this.featurestores.entityTypes.features.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.featurestores.entityTypes.features.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featurestores.entityTypes.features.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featurestores.entityTypes.features.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.featurestores.entityTypes.features.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.customJobs = {};

    this.customJobs.operations = {};
    this.customJobs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.customJobs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.customJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.customJobs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.customJobs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.evaluationSets = {};

    this.evaluationSets.operations = {};
    this.evaluationSets.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.evaluationSets.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.evaluationSets.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.evaluationSets.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.datasets.dataItems.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.datasets.dataItems.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.datasets.dataItems.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.datasets.dataItems.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.datasets.dataItems.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.datasets.dataItems.annotations = {};

    this.datasets.dataItems.annotations.operations = {};
    this.datasets.dataItems.annotations.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.datasets.dataItems.annotations.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.datasets.dataItems.annotations.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.datasets.dataItems.annotations.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.datasets.dataItems.annotations.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.datasets.savedQueries = {};

    this.datasets.savedQueries.operations = {};
    this.datasets.savedQueries.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.datasets.savedQueries.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.datasets.savedQueries.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.datasets.savedQueries.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.datasets.savedQueries.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.datasets.annotationSpecs = {};

    this.datasets.annotationSpecs.operations = {};
    this.datasets.annotationSpecs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.datasets.annotationSpecs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.datasets.annotationSpecs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.datasets.annotationSpecs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.datasets.annotationSpecs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.datasets.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.datasets.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.datasets.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.datasets.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.datasets.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.persistentResources = {};

    this.persistentResources.operations = {};
    this.persistentResources.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.persistentResources.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.persistentResources.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.persistentResources.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.persistentResources.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.onlineEvaluators = {};

    this.onlineEvaluators.operations = {};
    this.onlineEvaluators.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.onlineEvaluators.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.onlineEvaluators.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.onlineEvaluators.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.onlineEvaluators.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.evaluationMetrics = {};

    this.evaluationMetrics.operations = {};
    this.evaluationMetrics.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.evaluationMetrics.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.evaluationMetrics.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.tensorboards = {};

    this.tensorboards.operations = {};
    this.tensorboards.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.tensorboards.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.tensorboards.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.tensorboards.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.tensorboards.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.tensorboards.experiments = {};

    this.tensorboards.experiments.operations = {};
    this.tensorboards.experiments.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.tensorboards.experiments.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.tensorboards.experiments.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.tensorboards.experiments.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.tensorboards.experiments.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.tensorboards.experiments.runs = {};

    this.tensorboards.experiments.runs.operations = {};
    this.tensorboards.experiments.runs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.tensorboards.experiments.runs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.tensorboards.experiments.runs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.tensorboards.experiments.runs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.tensorboards.experiments.runs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.tensorboards.experiments.runs.timeSeries = {};

    this.tensorboards.experiments.runs.timeSeries.operations = {};
    this.tensorboards.experiments.runs.timeSeries.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.tensorboards.experiments.runs.timeSeries.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.tensorboards.experiments.runs.timeSeries.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.tensorboards.experiments.runs.timeSeries.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.tensorboards.experiments.runs.timeSeries.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    ...
    this.reasoningEngines.cancelAsyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancelAsyncQuery', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.executeCode = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:executeCode', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.asyncQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:asyncQuery', 'POST', apiParams, clientConfig);
    this.reasoningEngines.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions = {};
    this.reasoningEngines.runtimeRevisions.query = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:query', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.streamQuery = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:streamQuery', 'POST', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.operations = {};
    this.reasoningEngines.runtimeRevisions.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a = {};
    this.reasoningEngines.runtimeRevisions.a2a.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.card = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.message = {};
    this.reasoningEngines.runtimeRevisions.a2a.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:stream', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:send', 'POST', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.tasks = {};
    this.reasoningEngines.runtimeRevisions.a2a.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:subscribe', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.tasks.pushNotificationConfigs = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.tasks.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.tasks.pushNotificationConfigs = {};
    this.reasoningEngines.runtimeRevisions.a2a.tasks.pushNotificationConfigs.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.v1 = {};
    this.reasoningEngines.runtimeRevisions.a2a.v1.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.v1.card = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.v1.message = {};
    this.reasoningEngines.runtimeRevisions.a2a.v1.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:stream', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.v1.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:send', 'POST', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks = {};
    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks.pushNotificationConfigs = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:subscribe', 'GET', apiParams, clientConfig);

    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks.pushNotificationConfigs = {};
    this.reasoningEngines.runtimeRevisions.a2a.v1.tasks.pushNotificationConfigs.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.feedbackEntries = {};

    this.reasoningEngines.feedbackEntries.operations = {};
    this.reasoningEngines.feedbackEntries.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.feedbackEntries.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.feedbackEntries.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.reasoningEngines.feedbackEntries.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.feedbackEntries.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentSnapshots = {};
    this.reasoningEngines.sandboxEnvironmentSnapshots.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironmentSnapshots', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentSnapshots.operations = {};
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentSnapshots.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentTemplates = {};
    this.reasoningEngines.sandboxEnvironmentTemplates.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironmentTemplates', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironmentTemplates', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironmentTemplates.operations = {};
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironmentTemplates.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.reasoningEngines.operations = {};
    this.reasoningEngines.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.reasoningEngines.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.reasoningEngines.a2a = {};
    this.reasoningEngines.a2a.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.a2a.card = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.a2a.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.a2a.message = {};
    this.reasoningEngines.a2a.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:stream', 'POST', apiParams, clientConfig);
    this.reasoningEngines.a2a.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:send', 'POST', apiParams, clientConfig);

    this.reasoningEngines.a2a.tasks = {};
    this.reasoningEngines.a2a.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.a2a.tasks.pushNotificationConfigs = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.a2a.tasks.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.a2a.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}:subscribe', 'GET', apiParams, clientConfig);

    this.reasoningEngines.a2a.tasks.pushNotificationConfigs = {};
    this.reasoningEngines.a2a.tasks.pushNotificationConfigs.a2aGetReasoningEngine = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);

    this.reasoningEngines.a2a.v1 = {};
    this.reasoningEngines.a2a.v1.extendedAgentCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    ...
    this.reasoningEngines.a2a.v1.tasks = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/a2a/{+a2aEndpoint}', 'GET', apiParams, clientConfig);
    ...
    this.reasoningEngines.examples = {};

    this.reasoningEngines.examples.operations = {};
    this.reasoningEngines.examples.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.examples.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.examples.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.examples.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.reasoningEngines.memories = {};
    this.reasoningEngines.memories.purge = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/memories:purge', 'POST', apiParams, clientConfig);
    this.reasoningEngines.memories.ingestEvents = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/memories:ingestEvents', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.memories.rollback = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:rollback', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.memories.retrieveProfiles = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/memories:retrieveProfiles', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.memories.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.memories.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.reasoningEngines.memories.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.memories.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.memories.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.reasoningEngines.memories.revisions = {};
    this.reasoningEngines.memories.revisions.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.memories.revisions.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/revisions', 'GET', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironments = {};
    this.reasoningEngines.sandboxEnvironments.snapshot = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:snapshot', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.resume = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:resume', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironments', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.pause = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:pause', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/sandboxEnvironments', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.execute = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:execute', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.reasoningEngines.sandboxEnvironments.operations = {};
    this.reasoningEngines.sandboxEnvironments.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sandboxEnvironments.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.reasoningEngines.sessions.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sessions.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.reasoningEngines.sessions.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.reasoningEngines.sessions.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.reasoningEngines.sessions.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    ...
    this.migratableResources.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.migratableResources.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.migratableResources.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.migratableResources.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.migratableResources.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.modelDeploymentMonitoringJobs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.modelDeploymentMonitoringJobs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.modelDeploymentMonitoringJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.modelDeploymentMonitoringJobs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.modelDeploymentMonitoringJobs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.notebookExecutionJobs = {};

    this.notebookExecutionJobs.operations = {};
    this.notebookExecutionJobs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.notebookExecutionJobs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.notebookExecutionJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.notebookExecutionJobs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.notebookExecutionJobs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.ragEngineConfig = {};

    this.ragEngineConfig.operations = {};
    this.ragEngineConfig.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.ragEngineConfig.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.ragEngineConfig.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.ragEngineConfig.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.ragEngineConfig.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.modelMonitors = {};

    this.modelMonitors.operations = {};
    this.modelMonitors.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.modelMonitors.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.modelMonitors.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.modelMonitors.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.modelMonitors.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.metadataStores.artifacts.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.metadataStores.artifacts.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.metadataStores.artifacts.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.metadataStores.artifacts.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.metadataStores.artifacts.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.metadataStores.contexts = {};

    this.metadataStores.contexts.operations = {};
    this.metadataStores.contexts.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.metadataStores.contexts.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.metadataStores.contexts.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.metadataStores.contexts.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.metadataStores.contexts.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.metadataStores.executions = {};

    this.metadataStores.executions.operations = {};
    this.metadataStores.executions.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.metadataStores.executions.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.metadataStores.executions.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.metadataStores.executions.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.metadataStores.executions.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.metadataStores.operations = {};
    this.metadataStores.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.metadataStores.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.metadataStores.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.metadataStores.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.metadataStores.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.studies = {};

    this.studies.operations = {};
    this.studies.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.studies.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.studies.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.studies.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.studies.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.studies.trials = {};

    this.studies.trials.operations = {};
    this.studies.trials.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.studies.trials.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.studies.trials.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.studies.trials.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.studies.trials.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.exampleStores = {};

    this.exampleStores.operations = {};
    this.exampleStores.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.exampleStores.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.exampleStores.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.exampleStores.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.exampleStores.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    ...
    this.notebookRuntimeTemplates.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.notebookRuntimeTemplates.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.notebookRuntimeTemplates.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.notebookRuntimeTemplates.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.notebookRuntimeTemplates.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.pipelineJobs = {};

    this.pipelineJobs.operations = {};
    this.pipelineJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.pipelineJobs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.pipelineJobs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.pipelineJobs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.pipelineJobs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.v1beta1 = {};
    this.v1beta1.generateInstanceRubrics = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1:generateInstanceRubrics', 'POST', apiParams, clientConfig);
    this.v1beta1.evaluateInstances = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1:evaluateInstances', 'POST', apiParams, clientConfig);
    this.v1beta1.evaluateDataset = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1:evaluateDataset', 'POST', apiParams, clientConfig);

    this.servingProfiles = {};

    this.servingProfiles.operations = {};
    this.servingProfiles.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.servingProfiles.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.servingProfiles.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.servingProfiles.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.servingProfiles.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.dataLabelingJobs = {};

    this.dataLabelingJobs.operations = {};
    this.dataLabelingJobs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.dataLabelingJobs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.dataLabelingJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.dataLabelingJobs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.dataLabelingJobs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.deploymentResourcePools = {};

    this.deploymentResourcePools.operations = {};
    this.deploymentResourcePools.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.deploymentResourcePools.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.deploymentResourcePools.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.deploymentResourcePools.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.deploymentResourcePools.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);

    this.hyperparameterTuningJobs = {};

    this.hyperparameterTuningJobs.operations = {};
    this.hyperparameterTuningJobs.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.hyperparameterTuningJobs.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.hyperparameterTuningJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.hyperparameterTuningJobs.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.hyperparameterTuningJobs.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    ...
    this.endpoints.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.endpoints.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.endpoints.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.endpoints.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.endpoints.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.indexes = {};

    this.indexes.operations = {};
    this.indexes.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.indexes.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.indexes.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.indexes.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.indexes.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);

    this.interactions = {};
    this.interactions.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.interactions.getPoll = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:poll', 'GET', apiParams, clientConfig);
    this.interactions.getStream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:stream', 'GET', apiParams, clientConfig);

    this.tuningJobs = {};

    this.tuningJobs.operations = {};
    this.tuningJobs.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);

    this.operations = {};
    this.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/operations', 'GET', apiParams, clientConfig);
    this.operations.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', apiParams, clientConfig);
    this.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    ...
    this.featureGroups.features.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featureGroups.features.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.featureGroups.features.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
    this.featureGroups.features.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);

    this.featureGroups.featureMonitors = {};

    this.featureGroups.featureMonitors.operations = {};
    this.featureGroups.featureMonitors.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featureGroups.featureMonitors.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.featureGroups.featureMonitors.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featureGroups.featureMonitors.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);

    this.featureGroups.operations = {};
    this.featureGroups.operations.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'DELETE', apiParams, clientConfig);
    this.featureGroups.operations.wait = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}:wait', 'POST', apiParams, clientConfig);
    this.featureGroups.operations.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}', 'GET', apiParams, clientConfig);
    this.featureGroups.operations.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+name}/operations', 'GET', apiParams, clientConfig);
  }
