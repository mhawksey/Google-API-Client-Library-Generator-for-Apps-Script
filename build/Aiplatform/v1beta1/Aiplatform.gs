...
class Aiplatform {
  ...
  constructor(config = {}) {
    ...
    this.project.locations.datasets = {};
    this.project.locations.datasets.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'POST', apiParams, clientConfig);
