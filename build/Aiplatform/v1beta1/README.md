...
- **Last Checked:** Tue, 31 Mar 2026 23:21:32 GMT
- **Last Modified:** Mon, 30 Mar 2026 19:58:53 GMT
...
| `params.a2aTaskId` | `string` | No | Required. User-defined ID of the A2aTask. This ID must be unique within the ReasoningEngine. |
| `params.requestBody` | `object` | Yes | The request body. |
