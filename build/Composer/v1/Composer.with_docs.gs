...
class Composer {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.restartWebServer = (params) => this._makeRequest('v1/{+name}:restartWebServer', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.executeAirflowCommand = (params) => this._makeRequest('v1/{+environment}:executeAirflowCommand', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.stopAirflowCommand = (params) => this._makeRequest('v1/{+environment}:stopAirflowCommand', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.pollAirflowCommand = (params) => this._makeRequest('v1/{+environment}:pollAirflowCommand', 'POST', params);
     ...
     * @param {string} params.environment - (Required) Required. The resource name of the environment to check upgrade for, in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.environments.checkUpgrade = (params) => this._makeRequest('v1/{+environment}:checkUpgrade', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.saveSnapshot = (params) => this._makeRequest('v1/{+environment}:saveSnapshot', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.loadSnapshot = (params) => this._makeRequest('v1/{+environment}:loadSnapshot', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.databaseFailover = (params) => this._makeRequest('v1/{+environment}:databaseFailover', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.fetchDatabaseProperties = (params) => this._makeRequest('v1/{+environment}:fetchDatabaseProperties', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.workloads.list = (params) => this._makeRequest('v1/{+parent}/workloads', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsSecrets.create = (params) => this._makeRequest('v1/{+parent}/userWorkloadsSecrets', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsSecrets.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsSecrets.list = (params) => this._makeRequest('v1/{+parent}/userWorkloadsSecrets', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsSecrets.update = (params) => this._makeRequest('v1/{+name}', 'PUT', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsSecrets.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsConfigMaps.create = (params) => this._makeRequest('v1/{+parent}/userWorkloadsConfigMaps', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsConfigMaps.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsConfigMaps.list = (params) => this._makeRequest('v1/{+parent}/userWorkloadsConfigMaps', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsConfigMaps.update = (params) => this._makeRequest('v1/{+name}', 'PUT', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.environments.userWorkloadsConfigMaps.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.imageVersions.list = (params) => this._makeRequest('v1/{+parent}/imageVersions', 'GET', params);
  }
