...
class Netapp {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.list = (params) => this._makeRequest('v1/{+parent}/storagePools', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.create = (params) => this._makeRequest('v1/{+parent}/storagePools', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.validateDirectoryService = (params) => this._makeRequest('v1/{+name}:validateDirectoryService', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.storagePools.switch = (params) => this._makeRequest('v1/{+name}:switch', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.list = (params) => this._makeRequest('v1/{+parent}/volumes', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.create = (params) => this._makeRequest('v1/{+parent}/volumes', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.revert = (params) => this._makeRequest('v1/{+name}:revert', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.snapshots.list = (params) => this._makeRequest('v1/{+parent}/snapshots', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.snapshots.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.snapshots.create = (params) => this._makeRequest('v1/{+parent}/snapshots', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.snapshots.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.snapshots.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.list = (params) => this._makeRequest('v1/{+parent}/replications', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.create = (params) => this._makeRequest('v1/{+parent}/replications', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.stop = (params) => this._makeRequest('v1/{+name}:stop', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.resume = (params) => this._makeRequest('v1/{+name}:resume', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.reverseDirection = (params) => this._makeRequest('v1/{+name}:reverseDirection', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.establishPeering = (params) => this._makeRequest('v1/{+name}:establishPeering', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.replications.sync = (params) => this._makeRequest('v1/{+name}:sync', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.quotaRules.list = (params) => this._makeRequest('v1/{+parent}/quotaRules', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.quotaRules.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.quotaRules.create = (params) => this._makeRequest('v1/{+parent}/quotaRules', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.quotaRules.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.volumes.quotaRules.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.activeDirectories.list = (params) => this._makeRequest('v1/{+parent}/activeDirectories', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.activeDirectories.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.activeDirectories.create = (params) => this._makeRequest('v1/{+parent}/activeDirectories', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.activeDirectories.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.activeDirectories.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.list = (params) => this._makeRequest('v1/{+parent}/kmsConfigs', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.create = (params) => this._makeRequest('v1/{+parent}/kmsConfigs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.encrypt = (params) => this._makeRequest('v1/{+name}:encrypt', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.verify = (params) => this._makeRequest('v1/{+name}:verify', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.kmsConfigs.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupVaults.backups.create = (params) => this._makeRequest('v1/{+parent}/backups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupVaults.backups.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupVaults.backups.list = (params) => this._makeRequest('v1/{+parent}/backups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupVaults.backups.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupVaults.backups.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupPolicies.create = (params) => this._makeRequest('v1/{+parent}/backupPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupPolicies.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupPolicies.list = (params) => this._makeRequest('v1/{+parent}/backupPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupPolicies.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backupPolicies.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
  }
