...
class Websecurityscanner {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.name - (Required) The resource name of the ScanConfig. The name follows the format of 'projects/{projectId}/scanConfigs/{scanConfigId}'. The ScanConfig IDs are generated by the system.
