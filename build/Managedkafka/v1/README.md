...
- **Last Checked:** Wed, 18 Mar 2026 21:49:39 GMT
- **Last Modified:** Wed, 18 Mar 2026 21:49:39 GMT
...
| `params.view` | `string` | No | Optional. Specifies the view of the Cluster resource to be returned. Defaults to CLUSTER_VIEW_BASIC. See the ClusterView enum for possible values. |
...
| `params.view` | `string` | No | Optional. Specifies the view (BASIC or FULL) of the ConsumerGroup resource to be returned in the response. Defaults to FULL view. |
| `params.filter` | `string` | No | Optional. Filter expression for the result. Only supports filtering by topic name as a key in the `topics` map. |
