...
class Texttospeech {
  ...
  constructor(config = {}) {
    ...
    this.voices = {};
    this.voices.list = (params) => this._makeRequest('v1/voices', 'GET', params);

    this.text = {};
    this.text.synthesize = (params) => this._makeRequest('v1/text:synthesize', 'POST', params);

    this.projects = {};

    this.projects.locations = {};
    this.projects.locations.synthesizeLongAudio = (params) => this._makeRequest('v1/{+parent}:synthesizeLongAudio', 'POST', params);
