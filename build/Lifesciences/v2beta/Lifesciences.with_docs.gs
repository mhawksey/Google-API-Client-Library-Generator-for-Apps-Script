...
/**
 * Google Apps Script client library for the Cloud Life Sciences API
 * Documentation URL: https://cloud.google.com/life-sciences
 * @class
 */
class Lifesciences {
  /**
  ...
  constructor(config = {}) {
    ...
    this._rootUrl = 'https://lifesciences.googleapis.com/';
    this._servicePath = '';
     ...
     * @param {string} params.parent - (Required) The project and location that this request should be executed against.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.pipelines.run = (params) => this._makeRequest('v2beta/{+parent}/pipelines:run', 'POST', params);
  }
