...
class Observability {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.name - (Required) Required. Name of the resource. The format is: projects/{project}/locations/{location}/scopes/{scope} The `{location}` field must be set to `global`. The `{scope}` field must be set to `_Default`.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Identifier. Name of the resource. The format is: projects/{project}/locations/{location}/scopes/{scope} The `{location}` field must be set to `global`. The `{scope}` field must be set to `_Default`.
