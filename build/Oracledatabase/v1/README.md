...
- **Last Checked:** Mon, 01 Jun 2026 00:05:45 GMT
- **Last Modified:** Mon, 01 Jun 2026 00:05:45 GMT
...
#### `projects.locations.goldengateDeployments.list()`

Lists all the GoldengateDeployments for the given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent value for GoldengateDeployments in the following format: projects/{project}/locations/{location}. |
| `params.pageSize` | `integer` | No | Optional. The maximum number of items to return. If unspecified, at most 50 GoldengateDeployments will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. |
| `params.pageToken` | `string` | No | Optional. A page token, received from a previous ListGoldengateDeployments call. Provide this to retrieve the subsequent page. |
| `params.filter` | `string` | No | Optional. An expression for filtering the results of the request. |
| `params.orderBy` | `string` | No | Optional. An expression for ordering the results of the request. |

#### `projects.locations.goldengateDeployments.get()`

Gets details of a single GoldengateDeployment.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the GoldengateDeployment in the following format: projects/{project}/locations/{location}/goldengateDeployments/{goldengate_deployment}. |

#### `projects.locations.goldengateDeployments.create()`

Creates a new GoldengateDeployment in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The value for parent of the GoldengateDeployment in the following format: projects/{project}/locations/{location}. |
| `params.goldengateDeploymentId` | `string` | No | Required. The ID of the GoldengateDeployment to create. This value is restricted to (^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$) and must be a maximum of 63 characters in length. The value must start with a letter and end with a letter or a number. |
| `params.requestId` | `string` | No | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.goldengateDeployments.delete()`
...
#### `projects.locations.goldengateDeployments.stop()`

Stops a single GoldengateDeployment.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the Goldengate Deployment in the following format: projects/{project}/locations/{location}/goldengateDeployments/{goldengate_deployment}. |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.goldengateDeployments.start()`
...
#### `projects.locations.goldengateConnections.list()`

Lists all the GoldengateConnections for the given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent value for GoldengateConnections in the following format: projects/{project}/locations/{location}. |
| `params.pageSize` | `integer` | No | Optional. The maximum number of items to return. If unspecified, at most 50 GoldengateConnections will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. |
| `params.pageToken` | `string` | No | Optional. A page token, received from a previous ListGoldengateConnections call. Provide this to retrieve the subsequent page. |
| `params.filter` | `string` | No | Optional. An expression for filtering the results of the request. |
| `params.orderBy` | `string` | No | Optional. An expression for ordering the results of the request. |

#### `projects.locations.goldengateConnections.get()`

Gets details of a single GoldengateConnection.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the GoldengateConnection in the following format: projects/{project}/locations/{location}/goldengateConnections/{goldengate_connection}. |

#### `projects.locations.goldengateConnections.create()`

Creates a new GoldengateConnection in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The value for parent of the GoldengateConnection in the following format: projects/{project}/locations/{location}. |
| `params.goldengateConnectionId` | `string` | No | Required. The ID of the GoldengateConnection to create. This value is restricted to (^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$) and must be a maximum of 63 characters in length. The value must start with a letter and end with a letter or a number. |
| `params.requestId` | `string` | No | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.goldengateConnections.delete()`
...
#### `projects.locations.goldengateDeploymentVersions.get()`

Gets details of a single GoldengateDeploymentVersion.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the GoldengateDeploymentVersion to retrieve. Format: projects/{project}/locations/{location}/goldengateDeploymentVersions/{goldengate_deployment_version} |

#### `projects.locations.goldengateDeploymentVersions.list()`

Lists GoldengateDeploymentVersions in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. Parent value for ListGoldengateDeploymentVersionsRequest Format: projects/{project}/locations/{location} |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Server may return fewer items than requested. If unspecified, server will pick an appropriate default. The maximum value is 1000; values above 1000 will be coerced to 1000. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. |
| `params.filter` | `string` | No | Optional. An expression for filtering the results of the request. Either the deployment_id and deployment_type fields must be specified in the format: `deployment_id="id"` or `deployment_type="DATABASE_ORACLE"`. |

### `projects.locations.goldengateDeploymentTypes`

#### `projects.locations.goldengateDeploymentTypes.get()`

Gets details of a single GoldenGateDeploymentType.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the GoldengateDeploymentType to retrieve. Format: projects/{project}/locations/{location}/goldengateDeploymentTypes/{goldengate_deployment_type} |

#### `projects.locations.goldengateDeploymentTypes.list()`

Lists GoldenGateDeploymentTypes in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent resource. Format: projects/{project}/locations/{location} |
...
#### `projects.locations.goldengateDeploymentEnvironments.get()`

Gets details of a single GoldengateDeploymentEnvironment.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. Name of the resource with the format: projects/{project}/locations/{location}/goldengateDeploymentEnvironments/{goldengate_deployment_environment} |

#### `projects.locations.goldengateDeploymentEnvironments.list()`

Lists GoldengateDeploymentEnvironments in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent, which owns this collection of GoldengateDeploymentEnvironments. Format: projects/{project}/locations/{location} |
| `params.pageSize` | `integer` | No | Optional. The maximum number of items to return. If unspecified, at most 50 deployment environments will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. |

### `projects.locations.goldengateConnectionTypes`

#### `projects.locations.goldengateConnectionTypes.get()`

Gets details of a single GoldengateConnectionType.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. Name of the resource in the format: projects/{project}/locations/{location}/goldengateConnectionTypes/{goldengate_connection_type} |

#### `projects.locations.goldengateConnectionTypes.list()`

Lists GoldengateConnectionTypes in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. Parent value for ListGoldengateConnectionTypesRequest Format: projects/{project}/locations/{location} |
| `params.pageSize` | `integer` | No | Optional. Requested page size. Server may return fewer items than requested. If unspecified, server will pick an appropriate default. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. |
| `params.filter` | `string` | No | Optional. An expression for filtering the results of the request. The connection_type field must be specified in the format: `connection_type="ORACLE"`. |
...
#### `projects.locations.goldengateConnectionAssignments.list()`

Lists GoldengateConnectionAssignments in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent value for the GoldengateConnectionAssignments. Format: projects/{project}/locations/{location} |
| `params.pageSize` | `integer` | No | Optional. The maximum number of GoldengateConnectionAssignments to return. The service may return fewer than this value. If unspecified, at most 50 GoldengateConnectionAssignments will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000. |
| `params.pageToken` | `string` | No | Optional. A page token, received from a previous `ListGoldengateConnectionAssignments` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListGoldengateConnectionAssignments` must match the call that provided the page token. |
| `params.filter` | `string` | No | Optional. A filter expression that filters GoldengateConnectionAssignments listed in the response. |
...
#### `projects.locations.goldengateConnectionAssignments.get()`

Gets details of a single GoldengateConnectionAssignment.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the GoldengateConnectionAssignment to retrieve. Format: projects/{project}/locations/{location}/goldengateConnectionAssignments/{goldengate_connection_assignment} |

#### `projects.locations.goldengateConnectionAssignments.create()`

Creates a new GoldengateConnectionAssignment in a given project and location.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.parent` | `string` | Yes | Required. The parent resource where this GoldengateConnectionAssignment will be created. Format: projects/{project}/locations/{location} |
| `params.goldengateConnectionAssignmentId` | `string` | No | Required. The ID of the GoldengateConnectionAssignment to create. |
| `params.requestId` | `string` | No | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). |
| `params.requestBody` | `object` | Yes | The request body. |

#### `projects.locations.goldengateConnectionAssignments.delete()`

Deletes a single GoldengateConnectionAssignment.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. The name of the GoldengateConnectionAssignment to delete. Format: projects/{project}/locations/{location}/goldengateConnectionAssignments/{goldengate_connection_assignment} |
| `params.requestId` | `string` | No | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). |

#### `projects.locations.goldengateConnectionAssignments.test()`

Tests a single GoldengateConnectionAssignment.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. Name of the connection assignment for which to test connection. projects/{project}/locations/{region}/goldengateConnectionAssignments/{goldengate_connection_assignment} |
| `params.requestBody` | `object` | Yes | The request body. |