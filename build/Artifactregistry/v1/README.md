...
- **Last Checked:** Tue, 30 Jun 2026 23:24:17 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:24:17 GMT
...
#### `projects.locations.repositories.removePrewarmedArtifact()`

Removes an artifact from streaming.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.repository` | `string` | Yes | Required. The repository name, for example: `projects/p1/locations/us-central1/repositories/repo1`. |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.repositories.prewarmArtifact()`

Prewarms an artifact for streaming.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.repository` | `string` | Yes | Required. The repository name, for example: `projects/p1/locations/us-central1/repositories/repo1`. If the package or version ID parts contain slashes, the slashes are escaped. |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.repositories.checkPrewarmedArtifact()`

Checks an artifact streaming.

| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.repository` | `string` | Yes | Required. The name of the repository, for example: `projects/p1/locations/us-central1/repositories/repo1`. If the package or version ID parts contain slashes, the slashes are escaped. |
| `params.requestBody` | `object` | Yes | The request body. |
...
#### `projects.locations.repositories.prewarmedArtifacts.list()`
...
| `params.pageSize` | `integer` | No | Optional. The maximum number of prewarmed artifacts to return. Maximum page size is 1,000. Default page size is 100. |
| `params.filter` | `string` | No | Optional. Filter should only support The location of the prewarmed artifacts. multi-region is not supported for this field. |
| `params.parent` | `string` | Yes | Required. The repository of the artifact to list. Format: projects/{project}/locations/{location}/repositories/{repository} |
