...
class Contactcenteraiplatform {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.parent - (Required) Required. Parent project resource id.
     * @return {object} The API response object.
     */
    this.projects.locations.queryContactCenterQuota = (params) => this._makeRequest('v1alpha1/{+parent}:queryContactCenterQuota', 'GET', params);
     ...
     * @param {string} params.parent - (Required) Required. Parent value for ListContactCentersRequest
     * @return {object} The API response object.
     */
    this.projects.locations.contactCenters.list = (params) => this._makeRequest('v1alpha1/{+parent}/contactCenters', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.contactCenters.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);

    /**
     * Creates a new ContactCenter in a given project and location.
     * @param {string} params.contactCenterId - Required. Id of the requesting object If auto-generating Id server-side, remove this field and contact_center_id from the method_signature of Create RPC
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.contactCenters.create = (params) => this._makeRequest('v1alpha1/{+parent}/contactCenters', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.contactCenters.patch = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.contactCenters.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
  }
