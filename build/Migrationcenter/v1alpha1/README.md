...
Auto-generated client library for using the **Migration Center API (version: v1alpha1)** in Google Apps Script.

## Metadata

- **Last Checked:** Mon, 01 Dec 2025 00:57:38 GMT
- **Last Modified:** Mon, 01 Dec 2025 00:57:38 GMT
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Output only. Name of the PreferenceSet. |
...
#### `projects.locations.reportConfigs.reports.artifactLink()`
...
#### `projects.locations.reportConfigs.reports.export()`
