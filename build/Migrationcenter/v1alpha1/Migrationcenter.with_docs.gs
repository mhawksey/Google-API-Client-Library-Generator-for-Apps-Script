...
class Migrationcenter {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.locations.getSettings = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.updateSettings = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.list = (params) => this._makeRequest('v1alpha1/{+parent}/assets', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.patch = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.batchUpdate = (params) => this._makeRequest('v1alpha1/{+parent}/assets:batchUpdate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.batchDelete = (params) => this._makeRequest('v1alpha1/{+parent}/assets:batchDelete', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.reportAssetFrames = (params) => this._makeRequest('v1alpha1/{+parent}/assets:reportAssetFrames', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assets.aggregateValues = (params) => this._makeRequest('v1alpha1/{+parent}/assets:aggregateValues', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.create = (params) => this._makeRequest('v1alpha1/{+parent}/importJobs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.list = (params) => this._makeRequest('v1alpha1/{+parent}/importJobs', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.patch = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.validate = (params) => this._makeRequest('v1alpha1/{+name}:validate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.run = (params) => this._makeRequest('v1alpha1/{+name}:run', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.importDataFiles.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.importDataFiles.list = (params) => this._makeRequest('v1alpha1/{+parent}/importDataFiles', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.importDataFiles.create = (params) => this._makeRequest('v1alpha1/{+parent}/importDataFiles', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.importJobs.importDataFiles.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.groups.addAssets = (params) => this._makeRequest('v1alpha1/{+group}:addAssets', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.groups.removeAssets = (params) => this._makeRequest('v1alpha1/{+group}:removeAssets', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.sources.errorFrames.list = (params) => this._makeRequest('v1alpha1/{+parent}/errorFrames', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.sources.errorFrames.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.preferenceSets.list = (params) => this._makeRequest('v1alpha1/{+parent}/preferenceSets', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.preferenceSets.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);

    /**
     * Creates a new preference set in a given project and location.
     * @param {string} params.parent - (Required) Required. Value for parent.
     * @param {string} params.preferenceSetId - 
     * @param {string} params.requestId - Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.preferenceSets.create = (params) => this._makeRequest('v1alpha1/{+parent}/preferenceSets', 'POST', params);

    /**
     * Updates the parameters of a preference set.
     * @param {string} params.name - (Required) Output only. Name of the PreferenceSet.
     * @param {string} params.requestId - Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     * @param {string} params.updateMask - Required. Field mask is used to specify the fields to be overwritten in the `PreferenceSet` resource by the update. The values specified in the `update_mask` field are relative to the resource, not the full request. A field will be overwritten if it is in the mask. A single * value in the mask lets you to overwrite all fields.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.preferenceSets.patch = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.preferenceSets.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.create = (params) => this._makeRequest('v1alpha1/{+parent}/reportConfigs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.list = (params) => this._makeRequest('v1alpha1/{+parent}/reportConfigs', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.reports.create = (params) => this._makeRequest('v1alpha1/{+parent}/reports', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.reports.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.reports.list = (params) => this._makeRequest('v1alpha1/{+parent}/reports', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.reportConfigs.reports.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);

    this.projects.locations.assetsExportJobs = {};

    /**
     * Creates a new assets export job.
     * @param {string} params.assetsExportJobId - Required. The ID to use for the asset export job.
     * @param {string} params.parent - (Required) Required. The parent resource where the assts export job will be created.
     * @param {string} params.requestId - Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.assetsExportJobs.create = (params) => this._makeRequest('v1alpha1/{+parent}/assetsExportJobs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assetsExportJobs.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);

    /**
     * Lists all the assets export jobs in a given project and location.
     * @param {integer} params.pageSize - Optional. Requested page size. The server may return fewer items than requested. If unspecified, the server will pick an appropriate default value.
     * @param {string} params.pageToken - Optional. A token identifying a page of results that the server should return.
     * @param {string} params.parent - (Required) Required. Parent resource.
     * @return {object} The API response object.
     */
    this.projects.locations.assetsExportJobs.list = (params) => this._makeRequest('v1alpha1/{+parent}/assetsExportJobs', 'GET', params);

    /**
     * Deletes an assets export job.
     * @param {string} params.name - (Required) Required. The name of the assets export job to delete.
     * @return {object} The API response object.
     */
    this.projects.locations.assetsExportJobs.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.assetsExportJobs.run = (params) => this._makeRequest('v1alpha1/{+name}:run', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.discoveryClients.create = (params) => this._makeRequest('v1alpha1/{+parent}/discoveryClients', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.discoveryClients.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.discoveryClients.list = (params) => this._makeRequest('v1alpha1/{+parent}/discoveryClients', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.discoveryClients.patch = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.discoveryClients.sendHeartbeat = (params) => this._makeRequest('v1alpha1/{+name}:sendHeartbeat', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.discoveryClients.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.relations.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.relations.list = (params) => this._makeRequest('v1alpha1/{+parent}/relations', 'GET', params);
  }
