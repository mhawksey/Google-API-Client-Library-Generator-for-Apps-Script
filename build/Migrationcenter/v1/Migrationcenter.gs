...
class Migrationcenter {
  ...
  constructor(config = {}) {
    ...
    this.projects.locations.reportConfigs.reports.artifactLink = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}:artifactLink', 'POST', apiParams, clientConfig);
