...
class Memcache {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.operations.list = (params) => this._makeRequest('v1beta2/{+name}/operations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.operations.delete = (params) => this._makeRequest('v1beta2/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.operations.cancel = (params) => this._makeRequest('v1beta2/{+name}:cancel', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.list = (params) => this._makeRequest('v1beta2/{+parent}/instances', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.get = (params) => this._makeRequest('v1beta2/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.create = (params) => this._makeRequest('v1beta2/{+parent}/instances', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.patch = (params) => this._makeRequest('v1beta2/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.updateParameters = (params) => this._makeRequest('v1beta2/{+name}:updateParameters', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.delete = (params) => this._makeRequest('v1beta2/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.applyParameters = (params) => this._makeRequest('v1beta2/{+name}:applyParameters', 'POST', params);

    /**
     * Updates software on the selected nodes of the Instance.
     * @param {string} params.instance - (Required) Required. Resource name of the Memcached instance for which software update should be applied.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.instances.applySoftwareUpdate = (params) => this._makeRequest('v1beta2/{+instance}:applySoftwareUpdate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.rescheduleMaintenance = (params) => this._makeRequest('v1beta2/{+instance}:rescheduleMaintenance', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.instances.upgrade = (params) => this._makeRequest('v1beta2/{+name}:upgrade', 'POST', params);
  }
