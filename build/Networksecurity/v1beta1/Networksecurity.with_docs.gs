...
class Networksecurity {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/addressGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/addressGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.addItems = (params) => this._makeRequest('v1beta1/{+addressGroup}:addItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.removeItems = (params) => this._makeRequest('v1beta1/{+addressGroup}:removeItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.cloneItems = (params) => this._makeRequest('v1beta1/{+addressGroup}:cloneItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.listReferences = (params) => this._makeRequest('v1beta1/{+addressGroup}:listReferences', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.addressGroups.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.firewallEndpointAssociations.create = (params) => this._makeRequest('v1beta1/{+parent}/firewallEndpointAssociations', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.firewallEndpointAssociations.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.firewallEndpointAssociations.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/interceptEndpointGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/interceptEndpointGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroupAssociations.list = (params) => this._makeRequest('v1beta1/{+parent}/interceptEndpointGroupAssociations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroupAssociations.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroupAssociations.create = (params) => this._makeRequest('v1beta1/{+parent}/interceptEndpointGroupAssociations', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroupAssociations.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptEndpointGroupAssociations.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeploymentGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/interceptDeploymentGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeploymentGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeploymentGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/interceptDeploymentGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeploymentGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeploymentGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeployments.list = (params) => this._makeRequest('v1beta1/{+parent}/interceptDeployments', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeployments.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeployments.create = (params) => this._makeRequest('v1beta1/{+parent}/interceptDeployments', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeployments.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.interceptDeployments.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/mirroringEndpointGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/mirroringEndpointGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroupAssociations.list = (params) => this._makeRequest('v1beta1/{+parent}/mirroringEndpointGroupAssociations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroupAssociations.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroupAssociations.create = (params) => this._makeRequest('v1beta1/{+parent}/mirroringEndpointGroupAssociations', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroupAssociations.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringEndpointGroupAssociations.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeploymentGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/mirroringDeploymentGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeploymentGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeploymentGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/mirroringDeploymentGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeploymentGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeploymentGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeployments.list = (params) => this._makeRequest('v1beta1/{+parent}/mirroringDeployments', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeployments.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeployments.create = (params) => this._makeRequest('v1beta1/{+parent}/mirroringDeployments', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeployments.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.mirroringDeployments.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);

    this.projects.locations.sacRealms = {};

    /**
     * Lists SACRealms in a given project.
     * @param {string} params.filter - Optional. An expression that filters the list of results.
     ...
     * @param {string} params.parent - (Required) Required. The parent, in the form `projects/{project}/locations/global`.
     * @return {object} The API response object.
     */
    this.projects.locations.sacRealms.list = (params) => this._makeRequest('v1beta1/{+parent}/sacRealms', 'GET', params);

    /**
     * Returns the specified realm.
     * @param {string} params.name - (Required) Required. Name of the resource, in the form `projects/{project}/locations/global/sacRealms/{sacRealm}`.
     * @return {object} The API response object.
     */
    this.projects.locations.sacRealms.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);

    /**
     * Creates a new SACRealm in a given project.
     * @param {string} params.parent - (Required) Required. The parent, in the form `projects/{project}/locations/global`.
     * @param {string} params.requestId - Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     * @param {string} params.sacRealmId - Required. ID of the created realm. The ID must be 1-63 characters long, and comply with RFC1035. Specifically, it must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.sacRealms.create = (params) => this._makeRequest('v1beta1/{+parent}/sacRealms', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.sacRealms.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @param {integer} params.pageSize - Optional. Requested page size. Server may return fewer items than requested. If unspecified, server will pick an appropriate default.
     * @param {string} params.pageToken - Optional. A token identifying a page of results the server should return.
     * @param {string} params.parent - (Required) Required. The parent, in the form `projects/{project}/locations/{location}`.
     * @return {object} The API response object.
     */
    this.projects.locations.sacAttachments.list = (params) => this._makeRequest('v1beta1/{+parent}/sacAttachments', 'GET', params);

    /**
     * Returns the specified attachment.
     * @param {string} params.name - (Required) Required. Name of the resource, in the form `projects/{project}/locations/{location}/sacAttachments/{sac_attachment}`.
     * @return {object} The API response object.
     */
    this.projects.locations.sacAttachments.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);

    /**
     * Creates a new SACAttachment in a given project and location.
     * @param {string} params.parent - (Required) Required. The parent, in the form `projects/{project}/locations/{location}`.
     * @param {string} params.requestId - Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     * @param {string} params.sacAttachmentId - Required. ID of the created attachment. The ID must be 1-63 characters long, and comply with RFC1035. Specifically, it must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.sacAttachments.create = (params) => this._makeRequest('v1beta1/{+parent}/sacAttachments', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.sacAttachments.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.list = (params) => this._makeRequest('v1beta1/{+parent}/authorizationPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.create = (params) => this._makeRequest('v1beta1/{+parent}/authorizationPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.getIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authorizationPolicies.testIamPermissions = (params) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backendAuthenticationConfigs.list = (params) => this._makeRequest('v1beta1/{+parent}/backendAuthenticationConfigs', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backendAuthenticationConfigs.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backendAuthenticationConfigs.create = (params) => this._makeRequest('v1beta1/{+parent}/backendAuthenticationConfigs', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backendAuthenticationConfigs.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backendAuthenticationConfigs.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.list = (params) => this._makeRequest('v1beta1/{+parent}/serverTlsPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.create = (params) => this._makeRequest('v1beta1/{+parent}/serverTlsPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.getIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.serverTlsPolicies.testIamPermissions = (params) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.list = (params) => this._makeRequest('v1beta1/{+parent}/clientTlsPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.create = (params) => this._makeRequest('v1beta1/{+parent}/clientTlsPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.getIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clientTlsPolicies.testIamPermissions = (params) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.list = (params) => this._makeRequest('v1beta1/{+parent}/gatewaySecurityPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.create = (params) => this._makeRequest('v1beta1/{+parent}/gatewaySecurityPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.rules.list = (params) => this._makeRequest('v1beta1/{+parent}/rules', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.rules.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.rules.create = (params) => this._makeRequest('v1beta1/{+parent}/rules', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.rules.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.gatewaySecurityPolicies.rules.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.urlLists.list = (params) => this._makeRequest('v1beta1/{+parent}/urlLists', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.urlLists.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.urlLists.create = (params) => this._makeRequest('v1beta1/{+parent}/urlLists', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.urlLists.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.urlLists.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.tlsInspectionPolicies.list = (params) => this._makeRequest('v1beta1/{+parent}/tlsInspectionPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.tlsInspectionPolicies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.tlsInspectionPolicies.create = (params) => this._makeRequest('v1beta1/{+parent}/tlsInspectionPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.tlsInspectionPolicies.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.tlsInspectionPolicies.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.list = (params) => this._makeRequest('v1beta1/{+parent}/authzPolicies', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.create = (params) => this._makeRequest('v1beta1/{+parent}/authzPolicies', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.setIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.getIamPolicy = (params) => this._makeRequest('v1beta1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.authzPolicies.testIamPermissions = (params) => this._makeRequest('v1beta1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.operations.list = (params) => this._makeRequest('v1beta1/{+name}/operations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.operations.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.operations.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.operations.cancel = (params) => this._makeRequest('v1beta1/{+name}:cancel', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/addressGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/addressGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.addItems = (params) => this._makeRequest('v1beta1/{+addressGroup}:addItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.removeItems = (params) => this._makeRequest('v1beta1/{+addressGroup}:removeItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.cloneItems = (params) => this._makeRequest('v1beta1/{+addressGroup}:cloneItems', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.addressGroups.listReferences = (params) => this._makeRequest('v1beta1/{+addressGroup}:listReferences', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.firewallEndpoints.list = (params) => this._makeRequest('v1beta1/{+parent}/firewallEndpoints', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.firewallEndpoints.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.firewallEndpoints.create = (params) => this._makeRequest('v1beta1/{+parent}/firewallEndpoints', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.firewallEndpoints.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.firewallEndpoints.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfileGroups.list = (params) => this._makeRequest('v1beta1/{+parent}/securityProfileGroups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfileGroups.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfileGroups.create = (params) => this._makeRequest('v1beta1/{+parent}/securityProfileGroups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfileGroups.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfileGroups.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfiles.list = (params) => this._makeRequest('v1beta1/{+parent}/securityProfiles', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfiles.get = (params) => this._makeRequest('v1beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfiles.create = (params) => this._makeRequest('v1beta1/{+parent}/securityProfiles', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfiles.patch = (params) => this._makeRequest('v1beta1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.securityProfiles.delete = (params) => this._makeRequest('v1beta1/{+name}', 'DELETE', params);
  }
