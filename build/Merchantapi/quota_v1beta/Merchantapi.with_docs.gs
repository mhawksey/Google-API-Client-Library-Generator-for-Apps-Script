...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.parent - (Required) Required. The merchant account who owns the collection of method quotas Format: accounts/{account}
     * @return {object} The API response object.
     */
    this.accounts.quotas.list = (params) => this._makeRequest('quota/v1beta/{+parent}/quotas', 'GET', params);
  }
