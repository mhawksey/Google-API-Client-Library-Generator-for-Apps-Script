...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.parent - (Required) Required. Id of the account making the call. Must be a standalone account or an MCA subaccount. Format: accounts/{account}
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.accounts.reports.search = (params) => this._makeRequest('reports/v1beta/{+parent}/reports:search', 'POST', params);
  }
