...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     */
    this.accounts.aggregateProductStatuses.list = (params) => this._makeRequest('issueresolution/v1beta/{+parent}/aggregateProductStatuses', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.issueresolution.renderaccountissues = (params) => this._makeRequest('issueresolution/v1beta/{+name}:renderaccountissues', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.issueresolution.renderproductissues = (params) => this._makeRequest('issueresolution/v1beta/{+name}:renderproductissues', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.issueresolution.triggeraction = (params) => this._makeRequest('issueresolution/v1beta/{+name}:triggeraction', 'POST', params);
  }
