...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     */
    this.accounts.dataSources.get = (params) => this._makeRequest('datasources/v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.dataSources.list = (params) => this._makeRequest('datasources/v1/{+parent}/dataSources', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.dataSources.create = (params) => this._makeRequest('datasources/v1/{+parent}/dataSources', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.dataSources.patch = (params) => this._makeRequest('datasources/v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.dataSources.delete = (params) => this._makeRequest('datasources/v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.dataSources.fetch = (params) => this._makeRequest('datasources/v1/{+name}:fetch', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.dataSources.fileUploads.get = (params) => this._makeRequest('datasources/v1/{+name}', 'GET', params);
  }
