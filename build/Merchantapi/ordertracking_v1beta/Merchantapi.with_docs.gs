...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     */
    this.accounts.orderTrackingSignals.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('ordertracking/v1beta/{+parent}/orderTrackingSignals', 'POST', apiParams, clientConfig);
  }
