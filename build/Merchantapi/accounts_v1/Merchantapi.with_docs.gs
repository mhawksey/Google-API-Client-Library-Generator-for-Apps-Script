...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.parent - (Required) Required. The account to create one or more regions for. Format: `accounts/{account}`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. The account to update one or more regions for. Format: `accounts/{account}`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
