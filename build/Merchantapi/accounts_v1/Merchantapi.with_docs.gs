...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.accounts.getAccountForGcpRegistration = async (apiParams = {}, clientConfig = {}) => this._makeRequest('accounts/v1/accounts:getAccountForGcpRegistration', 'GET', apiParams, clientConfig);
