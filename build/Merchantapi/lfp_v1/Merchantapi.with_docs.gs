...
class Merchantapi {
  ...
  constructor(config = {}) {
     ...
     */
    this.accounts.lfpInventories.insert = (params) => this._makeRequest('lfp/v1/{+parent}/lfpInventories:insert', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.lfpMerchantStates.get = (params) => this._makeRequest('lfp/v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.lfpSales.insert = (params) => this._makeRequest('lfp/v1/{+parent}/lfpSales:insert', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.lfpStores.get = (params) => this._makeRequest('lfp/v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.lfpStores.insert = (params) => this._makeRequest('lfp/v1/{+parent}/lfpStores:insert', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.lfpStores.delete = (params) => this._makeRequest('lfp/v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.accounts.lfpStores.list = (params) => this._makeRequest('lfp/v1/{+parent}/lfpStores', 'GET', params);
  }
