...
class Datastream {
  ...
  constructor(config = {}) {
     ...
     * @param {boolean} params.force - Optional. Create the connection profile without validating it.
     ...
     * @param {boolean} params.validateOnly - Optional. Only validate the connection profile, but don't create any resources. The default is false.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {boolean} params.force - Optional. Update the connection profile without validating it.
     * @param {string} params.name - (Required) Output only. Identifier. The resource's name.
     * @param {string} params.requestId - Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     ...
     * @param {boolean} params.validateOnly - Optional. Only validate the connection profile, but don't update any resources. The default is false.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. The parent resource of the connection profile type. Must be in the format `projects/*\/locations/*`.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.connectionProfiles.discover = (params) => this._makeRequest('v1/{+parent}/connectionProfiles:discover', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.list = (params) => this._makeRequest('v1/{+parent}/streams', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @param {boolean} params.validateOnly - Optional. Only validate the stream, but don't create any resources. The default is false.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.streams.create = (params) => this._makeRequest('v1/{+parent}/streams', 'POST', params);

    /**
     * Use this method to update the configuration of a stream.
     * @param {boolean} params.force - Optional. Update the stream without validating it.
     * @param {string} params.name - (Required) Output only. Identifier. The stream's name.
     * @param {string} params.requestId - Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);

    /**
     * Use this method to start, resume or recover a stream with a non default CDC strategy.
     * @param {string} params.name - (Required) Required. Name of the stream resource to start, in the format: projects/{project_id}/locations/{location}/streams/{stream_name}
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.streams.run = (params) => this._makeRequest('v1/{+name}:run', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.objects.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.objects.lookup = (params) => this._makeRequest('v1/{+parent}/objects:lookup', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.objects.list = (params) => this._makeRequest('v1/{+parent}/objects', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.objects.startBackfillJob = (params) => this._makeRequest('v1/{+object}:startBackfillJob', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.streams.objects.stopBackfillJob = (params) => this._makeRequest('v1/{+object}:stopBackfillJob', 'POST', params);

    this.projects.locations.privateConnections = {};

    /**
     * Use this method to create a private connectivity configuration.
     * @param {boolean} params.force - Optional. If set to true, will skip validations.
     ...
     * @param {string} params.requestId - Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     * @param {boolean} params.validateOnly - Optional. When supplied with PSC Interface config, will get/create the tenant project required for the customer to allow list and won't actually create the private connection.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.privateConnections.routes.create = (params) => this._makeRequest('v1/{+parent}/routes', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.privateConnections.routes.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.privateConnections.routes.list = (params) => this._makeRequest('v1/{+parent}/routes', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.privateConnections.routes.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
  }
