...
- **Last Checked:** Thu, 01 Jan 2026 01:05:42 GMT
- **Last Modified:** Thu, 01 Jan 2026 01:05:42 GMT
...
|---|---|---|---|
| `params.topic` | `string` | Yes | Required. Identifier. The messages in the request will be published on this topic. Format is `projects/{project}/topics/{topic}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. Identifier. The name of the topic. It must have the format `"projects/{project}/topics/{topic}"`. `{topic}` must start with a letter, and contain only letters (`[A-Za-z]`), numbers (`[0-9]`), dashes (`-`), underscores (`_`), periods (`.`), tildes (`~`), plus (`+`) or percent signs (`%`). It must be between 3 and 255 characters in length, and it must not start with `"goog"`. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.topic` | `string` | Yes | Required. Identifier. The name of the topic to get. Format is `projects/{project}/topics/{topic}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.topic` | `string` | Yes | Required. Identifier. Name of the topic to delete. Format is `projects/{project}/topics/{topic}`. |
...
| `params.project` | `string` | Yes | Required. Identifier. The name of the project in which to list topics. Format is `projects/{project-id}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.subscription` | `string` | Yes | Required. Identifier. The name of the subscription to get. Format is `projects/{project}/subscriptions/{sub}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. Identifier. The name of the subscription. It must have the format `"projects/{project}/subscriptions/{subscription}"`. `{subscription}` must start with a letter, and contain only letters (`[A-Za-z]`), numbers (`[0-9]`), dashes (`-`), underscores (`_`), periods (`.`), tildes (`~`), plus (`+`) or percent signs (`%`). It must be between 3 and 255 characters in length, and it must not start with `"goog"`. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.subscription` | `string` | Yes | Required. Identifier. The subscription to delete. Format is `projects/{project}/subscriptions/{sub}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.project` | `string` | Yes | Required. Identifier. The name of the project in which to list subscriptions. Format is `projects/{project-id}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.snapshot` | `string` | Yes | Required. Identifier. The name of the snapshot to delete. Format is `projects/{project}/snapshots/{snap}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Required. Identifier. User-provided name for this snapshot. If the name is not provided in the request, the server will assign a random name for this snapshot on the same project as the subscription. Note that for REST API requests, you must specify a name. See the [resource name rules](https://cloud.google.com/pubsub/docs/pubsub-basics#resource_names). Format is `projects/{project}/snapshots/{snap}`. |
| `params.requestBody` | `object` | Yes | The request body. |
...
| `params.project` | `string` | Yes | Required. Identifier. The name of the project in which to list snapshots. Format is `projects/{project-id}`. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.snapshot` | `string` | Yes | Required. Identifier. The name of the snapshot to get. Format is `projects/{project}/snapshots/{snap}`. |