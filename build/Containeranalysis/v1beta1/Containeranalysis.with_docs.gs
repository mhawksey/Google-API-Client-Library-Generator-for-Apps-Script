...
class Containeranalysis {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.name - (Required) Required. The name of the resource to get a packages summary for in the form of `projects/[PROJECT_ID]/resources/[RESOURCE_URL]`.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
