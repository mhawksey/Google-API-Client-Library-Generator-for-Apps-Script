...
class Firebaseml {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.locations.publishers.models.countTokens = (params) => this._makeRequest('v2beta/{+endpoint}:countTokens', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.publishers.models.generateContent = (params) => this._makeRequest('v2beta/{+model}:generateContent', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.publishers.models.streamGenerateContent = (params) => this._makeRequest('v2beta/{+model}:streamGenerateContent', 'POST', params);
  }
