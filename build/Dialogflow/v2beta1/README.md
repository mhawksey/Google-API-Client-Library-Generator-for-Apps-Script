...
- **Last Checked:** Tue, 30 Jun 2026 23:45:12 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:45:12 GMT
...
|---|---|---|---|
| `params.parent` | `string` | Yes |  |
| `params.importGcsCustomMetadata` | `boolean` | No |  |
| `params.requestBody` | `object` | Yes | The request body. |
