...
class Dataportability {
  ...
  constructor(config = {}) {
     ...
     */
    this.portabilityArchive.initiate = (params) => this._makeRequest('v1/portabilityArchive:initiate', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.archiveJobs.getPortabilityArchiveState = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.archiveJobs.retry = (params) => this._makeRequest('v1/{+name}:retry', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.archiveJobs.cancel = (params) => this._makeRequest('v1/{+name}:cancel', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.authorization.reset = (params) => this._makeRequest('v1/authorization:reset', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.accessType.check = (params) => this._makeRequest('v1/accessType:check', 'POST', params);
  }
