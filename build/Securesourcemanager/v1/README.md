...
- **Last Checked:** Wed, 01 Apr 2026 00:03:46 GMT
- **Last Modified:** Wed, 18 Mar 2026 22:02:34 GMT
...
| `params.filter` | `string` | No | Optional. Filter for filtering results. |
...
| `params.force` | `boolean` | No | Optional. If set to true, will force the deletion of the instance. |
...
| `params.pageSize` | `integer` | No | Optional. Requested page size. If unspecified, a default size of 30 will be used. The maximum value is 100; values above 100 will be coerced to 100. |
| `params.pageToken` | `string` | No | Optional. A token identifying a page of results the server should return. |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Identifier. A unique identifier for a repository. The name should be of the format: `projects/{project}/locations/{location_id}/repositories/{repository_id}` |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Identifier. A unique identifier for a BranchRule. The name should be of the format: `projects/{project}/locations/{location}/repositories/{repository}/branchRules/{branch_rule}` |
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Output only. Identifier. A unique identifier for a PullRequest. The number appended at the end is generated by the server. Format: `projects/{project}/locations/{location}/repositories/{repository}/pullRequests/{pull_request_id}` |
