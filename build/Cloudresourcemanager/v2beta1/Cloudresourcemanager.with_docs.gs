...
class Cloudresourcemanager {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.folders.list = (params) => this._makeRequest('v2/folders', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.search = (params) => this._makeRequest('v2/folders:search', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.get = (params) => this._makeRequest('v2/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.create = (params) => this._makeRequest('v2/folders', 'POST', params);
     ...
     * @param {string} params.name - (Required) Output only. The resource name of the Folder. Its format is `folders/{folder_id}`, for example: "folders/1234".
     * @param {string} params.updateMask - Required. Fields to be updated. Only the `display_name` can be updated.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.folders.patch = (params) => this._makeRequest('v2/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.move = (params) => this._makeRequest('v2/{+name}:move', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.delete = (params) => this._makeRequest('v2/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.undelete = (params) => this._makeRequest('v2/{+name}:undelete', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.getIamPolicy = (params) => this._makeRequest('v2/{+resource}:getIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.setIamPolicy = (params) => this._makeRequest('v2/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.testIamPermissions = (params) => this._makeRequest('v2/{+resource}:testIamPermissions', 'POST', params);
  }
