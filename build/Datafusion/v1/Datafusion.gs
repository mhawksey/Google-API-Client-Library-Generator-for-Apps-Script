...
class Datafusion {
  ...
  constructor(config = {}) {
    ...
    this.projects.locations.versions.list = (params) => this._makeRequest('v1/{+parent}/versions', 'GET', params);
    ...
    this.projects.locations.instances.dnsPeerings.create = (params) => this._makeRequest('v1/{+parent}/dnsPeerings', 'POST', params);
    this.projects.locations.instances.dnsPeerings.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
    this.projects.locations.instances.dnsPeerings.list = (params) => this._makeRequest('v1/{+parent}/dnsPeerings', 'GET', params);
  }
