...
class Retail {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.name - (Required) Required. Full resource name of the project. Format: `projects/{project_number_or_id}/retailProject`
     ...
     * @param {string} params.project - (Required) Required. Full resource name of parent. Format: `projects/{project_number_or_id}`
     ...
     * @param {string} params.parent - (Required) Required. Full resource name of parent. Format: `projects/{project_number_or_id}`
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Required. Full LoggingConfig resource name. Format: projects/{project_number}/loggingConfig
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Required. Immutable. The name of the LoggingConfig singleton resource. Format: projects/*\/loggingConfig
     * @param {string} params.updateMask - Indicates which fields in the provided LoggingConfig to update. The following are the only supported fields: * LoggingConfig.default_log_generation_rule * LoggingConfig.service_log_generation_rules If not set, all supported fields are updated.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Required. Full AlertConfig resource name. Format: projects/{project_number}/alertConfig
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Required. Immutable. The name of the AlertConfig singleton resource. Format: projects/*\/alertConfig
     * @param {string} params.updateMask - Indicates which fields in the provided AlertConfig to update. If not set, all supported fields are updated.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. The parent catalog resource name.
     * @param {string} params.view - The view to apply to the returned Branch. Defaults to [Branch.BranchView.BASIC] if unspecified. See documentation of fields of Branch to find what fields are excluded from BASIC view.
     * @return {object} The API response object.
     */
    ...
    /**
     * Retrieves a Branch.
     * @param {string} params.name - (Required) Required. The name of the branch to retrieve. Format: `projects/*\/locations/global/catalogs/default_catalog/branches/some_branch_id`. "default_branch" can be used as a special branch_id, it returns the default branch that has been set for the catalog.
     * @param {string} params.view - The view to apply to the returned Branch. Defaults to [Branch.BranchView.BASIC] if unspecified. See documentation of fields of Branch to find what fields are excluded from BASIC view.
     * @return {object} The API response object.
     */
     ...
     * @param {boolean} params.requireTotalSize - If true and page_token is empty, ListProductsResponse.total_size is set to the total count of matched items irrespective of pagination. Notice that setting this field to true affects the performance.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. Resource name of a Branch, and `default_branch` for branch_id component is supported. For example `projects/1234/locations/global/catalogs/default_catalog/branches/default_branch`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.attributesConfig - (Required) Required. The attributes config resource shared by all catalog attributes being deleted. Format: `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/attributesConfig`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. Resource name of a Catalog. For example `projects/1234/locations/global/catalogs/default_catalog`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. The parent Catalog of the resource. It must match this format: `projects/{PROJECT_NUMBER}/locations/global/catalogs/{CATALOG_ID}`
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.parent - (Required) Required. The branch resource where this MerchantCenterAccountLink will be created. Format: `projects/{PROJECT_NUMBER}/locations/global/catalogs/{CATALOG_ID}`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.name - (Required) Required. Full resource name. Format: `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/merchantCenterAccountLinks/{merchant_center_account_link_id}`
     * @return {object} The API response object.
     */
     ...
     * @param {string} params.project - (Required) Required. Full resource name of the project. Format: `projects/{project_number_or_id}/retailProject`
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
