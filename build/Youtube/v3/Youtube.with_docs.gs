...
class Youtube {
  ...
  constructor(config = {}) {
     ...
     * @param {string} apiParams.channelId - Filter on resources belonging to this channelId. (Force TAP rebuild)
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.id - Required. Return videos with the given ids. The number of IDs specified cannot exceed 50.
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.videos.batchGetStats = async (apiParams = {}, clientConfig = {}) => this._makeRequest('youtube/v3/videos:batchGetStats', 'GET', apiParams, clientConfig);
