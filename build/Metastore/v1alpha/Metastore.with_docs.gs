...
class Metastore {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.list = (params) => this._makeRequest('v1alpha/{+parent}/federations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.get = (params) => this._makeRequest('v1alpha/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.create = (params) => this._makeRequest('v1alpha/{+parent}/federations', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.patch = (params) => this._makeRequest('v1alpha/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.delete = (params) => this._makeRequest('v1alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.setIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.getIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.federations.testIamPermissions = (params) => this._makeRequest('v1alpha/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.list = (params) => this._makeRequest('v1alpha/{+parent}/services', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.get = (params) => this._makeRequest('v1alpha/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.create = (params) => this._makeRequest('v1alpha/{+parent}/services', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.patch = (params) => this._makeRequest('v1alpha/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.delete = (params) => this._makeRequest('v1alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.exportMetadata = (params) => this._makeRequest('v1alpha/{+service}:exportMetadata', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.restore = (params) => this._makeRequest('v1alpha/{+service}:restore', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.removeIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:removeIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.queryMetadata = (params) => this._makeRequest('v1alpha/{+service}:queryMetadata', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.moveTableToDatabase = (params) => this._makeRequest('v1alpha/{+service}:moveTableToDatabase', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.alterLocation = (params) => this._makeRequest('v1alpha/{+service}:alterLocation', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.alterTableProperties = (params) => this._makeRequest('v1alpha/{+service}:alterTableProperties', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.startMigration = (params) => this._makeRequest('v1alpha/{+service}:startMigration', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.completeMigration = (params) => this._makeRequest('v1alpha/{+service}:completeMigration', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.cancelMigration = (params) => this._makeRequest('v1alpha/{+service}:cancelMigration', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.setIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.getIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.testIamPermissions = (params) => this._makeRequest('v1alpha/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.metadataImports.list = (params) => this._makeRequest('v1alpha/{+parent}/metadataImports', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.metadataImports.get = (params) => this._makeRequest('v1alpha/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.metadataImports.create = (params) => this._makeRequest('v1alpha/{+parent}/metadataImports', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.metadataImports.patch = (params) => this._makeRequest('v1alpha/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.list = (params) => this._makeRequest('v1alpha/{+parent}/backups', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.get = (params) => this._makeRequest('v1alpha/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.create = (params) => this._makeRequest('v1alpha/{+parent}/backups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.delete = (params) => this._makeRequest('v1alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.setIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.getIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.backups.testIamPermissions = (params) => this._makeRequest('v1alpha/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.migrationExecutions.get = (params) => this._makeRequest('v1alpha/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.migrationExecutions.list = (params) => this._makeRequest('v1alpha/{+parent}/migrationExecutions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.migrationExecutions.delete = (params) => this._makeRequest('v1alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.databases.setIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.databases.getIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.databases.testIamPermissions = (params) => this._makeRequest('v1alpha/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.databases.tables.setIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.databases.tables.getIamPolicy = (params) => this._makeRequest('v1alpha/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.services.databases.tables.testIamPermissions = (params) => this._makeRequest('v1alpha/{+resource}:testIamPermissions', 'POST', params);
  }
