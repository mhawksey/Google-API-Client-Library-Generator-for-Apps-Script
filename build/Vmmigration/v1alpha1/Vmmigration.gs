...
class Vmmigration {
  ...
  constructor(config = {}) {
    ...
    this.projects.locations.sources.fetchStorageInventory = (params) => this._makeRequest('v1alpha1/{+source}:fetchStorageInventory', 'GET', params);
    ...
    this.projects.locations.sources.diskMigrationJobs.create = (params) => this._makeRequest('v1alpha1/{+parent}/diskMigrationJobs', 'POST', params);
    this.projects.locations.sources.diskMigrationJobs.list = (params) => this._makeRequest('v1alpha1/{+parent}/diskMigrationJobs', 'GET', params);
    this.projects.locations.sources.diskMigrationJobs.get = (params) => this._makeRequest('v1alpha1/{+name}', 'GET', params);
    this.projects.locations.sources.diskMigrationJobs.patch = (params) => this._makeRequest('v1alpha1/{+name}', 'PATCH', params);
    this.projects.locations.sources.diskMigrationJobs.delete = (params) => this._makeRequest('v1alpha1/{+name}', 'DELETE', params);
    this.projects.locations.sources.diskMigrationJobs.run = (params) => this._makeRequest('v1alpha1/{+name}:run', 'POST', params);
    this.projects.locations.sources.diskMigrationJobs.cancel = (params) => this._makeRequest('v1alpha1/{+name}:cancel', 'POST', params);
