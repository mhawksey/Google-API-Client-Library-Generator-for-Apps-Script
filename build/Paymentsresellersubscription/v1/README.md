...
- **Last Checked:** Thu, 01 Jan 2026 01:04:25 GMT
- **Last Modified:** Thu, 01 Jan 2026 01:04:25 GMT
...
| Parameter | Type | Required | Description |
|---|---|---|---|
| `params.name` | `string` | Yes | Identifier. Resource name of the line item. Format: partners/{partner}/subscriptions/{subscription}/lineItems/{lineItem} |
| `params.updateMask` | `string` | No | Required. The list of fields to update. Only a limited set of fields can be updated. The allowed fields are the following: - `product_payload.googleHomePayload.googleStructureId` |
| `params.requestBody` | `object` | Yes | The request body. |