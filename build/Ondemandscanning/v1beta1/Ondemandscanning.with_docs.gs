...
class Ondemandscanning {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.parent - (Required) Required. The parent of the resource for which analysis is requested. Format: projects/[project_name]/locations/[location]
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.projects.locations.scans.analyzePackages = (params) => this._makeRequest('v1beta1/{+parent}/scans:analyzePackages', 'POST', params);

    this.projects.locations.scans.vulnerabilities = {};

    /**
     * Lists vulnerabilities resulting from a successfully completed scan.
     * @param {integer} params.pageSize - The number of vulnerabilities to retrieve.
     * @param {string} params.pageToken - The page token, resulting from a previous call to ListVulnerabilities.
     * @param {string} params.parent - (Required) Required. The parent of the collection of Vulnerabilities being requested. Format: projects/[project_name]/locations/[location]/scans/[scan_id]
     * @return {object} The API response object.
     */
    this.projects.locations.scans.vulnerabilities.list = (params) => this._makeRequest('v1beta1/{+parent}/vulnerabilities', 'GET', params);
  }
