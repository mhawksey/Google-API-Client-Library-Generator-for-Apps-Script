...
class Publicca {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.locations.externalAccountKeys.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1alpha1/{+parent}/externalAccountKeys', 'POST', apiParams, clientConfig);
  }
