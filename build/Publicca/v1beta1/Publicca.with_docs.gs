...
class Publicca {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.locations.externalAccountKeys.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta1/{+parent}/externalAccountKeys', 'POST', apiParams, clientConfig);
  }
