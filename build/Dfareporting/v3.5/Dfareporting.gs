...
class Dfareporting {
  ...
  constructor(config = {}) {
    ...
    this._servicePath = 'dfareporting/v3.5/';

    // --- Public Interface Initialization ---

    this.media = {};
    this.media.upload = (params) => this._makeRequest('userprofiles/{+profileId}/creativeAssets/{+advertiserId}/creativeAssets', 'POST', params);
  }
