...
class Discoveryengine {
  ...
  constructor(config = {}) {
     ...
     */
    this.billingAccounts.billingAccountLicenseConfigs.retractLicenseConfig = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta/{+billingAccountLicenseConfig}:retractLicenseConfig', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.billingAccounts.billingAccountLicenseConfigs.distributeLicenseConfig = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta/{+billingAccountLicenseConfig}:distributeLicenseConfig', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.getIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta/{+resource}:getIamPolicy', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.setIamPolicy = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta/{+resource}:setIamPolicy', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.licenseConfigs.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1beta/{+parent}/licenseConfigs', 'GET', apiParams, clientConfig);
