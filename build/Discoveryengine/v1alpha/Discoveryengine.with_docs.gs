...
class Discoveryengine {
  ...
  constructor(config = {}) {
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.media.download = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1alpha/{+name}:downloadFile', 'GET', apiParams, clientConfig);
    ...
    this.media.upload = async (apiParams = {}, clientConfig = {}) => {
      ...
      const path = apiParams.media ? '/upload/v1alpha/{+name}:uploadFile' : 'v1alpha/{+name}:uploadFile';
     ...
     * @param {string} apiParams.name - (Required) Required. The name of the ConfigurablePricingUsageStats to retrieve. Format: projects/{project}/locations/{location}/configurablePricingUsageStats
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.getConfigurablePricingUsageStats = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1alpha/{+name}', 'GET', apiParams, clientConfig);
     ...
     * @param {object} apiParams - The parameters for the API request.
     * @param {string} apiParams.parent - (Required) Required. The parent resource where the sources will be created. Format: projects/{project}/locations/{location}/notebooks/{notebook}
     * @param {string} apiParams.sourceId - (Required) The source id of the associated file. If not set, a source id will be generated and a new tentative source will be created.
     * @param {object} apiParams.requestBody - The request body.
     * @param {object} [clientConfig] - Optional client-side configuration.
     * @param {string} [clientConfig.responseType] - The expected response type. Setting to 'blob' returns the raw file content. Omit for JSON.
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.notebooks.sources.uploadFile = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1alpha/{+parent}/sources/{sourceId}:uploadFile', 'POST', apiParams, clientConfig);
