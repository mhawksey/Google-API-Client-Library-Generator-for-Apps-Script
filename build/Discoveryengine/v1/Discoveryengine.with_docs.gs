...
class Discoveryengine {
  ...
  constructor(config = {}) {
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.userStores.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+parent}/userStores', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.userStores.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('v1/{+name}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.getCard = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/card', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.message.send = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/message:send', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.message.stream = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/message:stream', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.cancel = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+name}:cancel', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+name}', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.subscribe = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+name}:subscribe', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.pushNotificationConfigs.delete = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+name}', 'DELETE', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.pushNotificationConfigs.create = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+parent}', 'POST', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.pushNotificationConfigs.list = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+parent}/pushNotificationConfigs', 'GET', apiParams, clientConfig);
     ...
     * @return {Promise<object>} A Promise that resolves with the response object. The response payload is in the `data` property, which will be a JSON object or a Blob.
     */
    this.projects.locations.collections.engines.assistants.agents.tasks.pushNotificationConfigs.get = async (apiParams = {}, clientConfig = {}) => this._makeRequest('{+tenant}/{+name}', 'GET', apiParams, clientConfig);
