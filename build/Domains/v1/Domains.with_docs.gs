...
class Domains {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.searchDomains = (params) => this._makeRequest('v1/{+location}/registrations:searchDomains', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.retrieveRegisterParameters = (params) => this._makeRequest('v1/{+location}/registrations:retrieveRegisterParameters', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.register = (params) => this._makeRequest('v1/{+parent}/registrations:register', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.retrieveTransferParameters = (params) => this._makeRequest('v1/{+location}/registrations:retrieveTransferParameters', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.transfer = (params) => this._makeRequest('v1/{+parent}/registrations:transfer', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.retrieveImportableDomains = (params) => this._makeRequest('v1/{+location}/registrations:retrieveImportableDomains', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.import = (params) => this._makeRequest('v1/{+parent}/registrations:import', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.list = (params) => this._makeRequest('v1/{+parent}/registrations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.configureManagementSettings = (params) => this._makeRequest('v1/{+registration}:configureManagementSettings', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.configureDnsSettings = (params) => this._makeRequest('v1/{+registration}:configureDnsSettings', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.retrieveGoogleDomainsDnsRecords = (params) => this._makeRequest('v1/{+registration}:retrieveGoogleDomainsDnsRecords', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.retrieveGoogleDomainsForwardingConfig = (params) => this._makeRequest('v1/{+registration}:retrieveGoogleDomainsForwardingConfig', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.configureContactSettings = (params) => this._makeRequest('v1/{+registration}:configureContactSettings', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.export = (params) => this._makeRequest('v1/{+name}:export', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.retrieveAuthorizationCode = (params) => this._makeRequest('v1/{+registration}:retrieveAuthorizationCode', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.resetAuthorizationCode = (params) => this._makeRequest('v1/{+registration}:resetAuthorizationCode', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.initiatePushTransfer = (params) => this._makeRequest('v1/{+registration}:initiatePushTransfer', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.renewDomain = (params) => this._makeRequest('v1/{+registration}:renewDomain', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.setIamPolicy = (params) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.getIamPolicy = (params) => this._makeRequest('v1/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.registrations.testIamPermissions = (params) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', params);
  }
