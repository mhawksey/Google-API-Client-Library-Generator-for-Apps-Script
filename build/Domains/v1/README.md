...
- **Last Checked:** Tue, 30 Jun 2026 23:52:07 GMT
- **Last Modified:** Tue, 30 Jun 2026 23:52:07 GMT
...
| `params.validateOnly` | `boolean` | No | Optional. If set, validates the request without actually updating the registration. |
| `params.requestBody` | `object` | Yes | The request body. |
