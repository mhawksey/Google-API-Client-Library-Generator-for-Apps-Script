...
class Policyanalyzer {
  ...
  constructor(config = {}) {
     ...
     * @param {string} params.parent - (Required) Required. The container resource on which to execute the request. Acceptable formats: `projects/[PROJECT_ID|PROJECT_NUMBER]/locations/[LOCATION]/activityTypes/[ACTIVITY_TYPE]` LOCATION here refers to Google Cloud Locations: https://cloud.google.com/about/locations/
     * @return {object} The API response object.
     */
    this.projects.locations.activityTypes.activities.query = (params) => this._makeRequest('v1/{+parent}/activities:query', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.activityTypes.activities.query = (params) => this._makeRequest('v1/{+parent}/activities:query', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.folders.locations.activityTypes.activities.query = (params) => this._makeRequest('v1/{+parent}/activities:query', 'GET', params);
  }
