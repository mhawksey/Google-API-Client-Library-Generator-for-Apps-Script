...
class Oslogin {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.locations.signSshPublicKey = (params) => this._makeRequest('v1alpha/{+parent}:signSshPublicKey', 'POST', params);
     ...
     * @param {string} params.operatingSystemType - Optional. The type of operating system associated with the account.
     ...
     * @return {object} The API response object.
     */
    this.users.getLoginProfile = (params) => this._makeRequest('v1alpha/{+name}/loginProfile', 'GET', params);
     ...
     * @param {string} params.regions - Optional. The regions to wait for a POSIX account to be written to before returning a response. If unspecified, defaults to all regions. Regions are listed at https://cloud.google.com/about/locations#region.
     * @param {string} params.view - The view configures whether to retrieve security keys information.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.users.importSshPublicKey = (params) => this._makeRequest('v1alpha/{+parent}:importSshPublicKey', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.create = (params) => this._makeRequest('v1alpha/{+parent}/sshPublicKeys', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.delete = (params) => this._makeRequest('v1alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.get = (params) => this._makeRequest('v1alpha/{+name}', 'GET', params);

    /**
     * Updates an SSH public key and returns the profile information. This method supports patch semantics.
     * @param {string} params.name - (Required) Required. The fingerprint of the public key to update. Public keys are identified by their SHA-256 fingerprint. The fingerprint of the public key is in format `users/{user}/sshPublicKeys/{fingerprint}`.
     * @param {string} params.updateMask - Optional. Mask to control which fields get updated. Updates all if not present.
     * @param {object} params.resource - The request body.
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.patch = (params) => this._makeRequest('v1alpha/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.users.projects.delete = (params) => this._makeRequest('v1alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.users.projects.provisionPosixAccount = (params) => this._makeRequest('v1alpha/{+name}', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.projects.zones.signSshPublicKey = (params) => this._makeRequest('v1alpha/{+parent}:signSshPublicKey', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.projects.locations.signSshPublicKey = (params) => this._makeRequest('v1alpha/{+parent}:signSshPublicKey', 'POST', params);
  }
