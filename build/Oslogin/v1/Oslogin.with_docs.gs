...
class Oslogin {
  ...
  constructor(config = {}) {
     ...
     */
    this.users.getLoginProfile = (params) => this._makeRequest('v1/{+name}/loginProfile', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.users.importSshPublicKey = (params) => this._makeRequest('v1/{+parent}:importSshPublicKey', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.create = (params) => this._makeRequest('v1/{+parent}/sshPublicKeys', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.users.sshPublicKeys.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.users.projects.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
  }
