...
class Alloydb {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.restoreFromCloudSQL = (params) => this._makeRequest('v1/{+parent}/clusters:restoreFromCloudSQL', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.export = (params) => this._makeRequest('v1/{+name}:export', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.import = (params) => this._makeRequest('v1/{+name}:import', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.upgrade = (params) => this._makeRequest('v1/{+name}:upgrade', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.promote = (params) => this._makeRequest('v1/{+name}:promote', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.switchover = (params) => this._makeRequest('v1/{+name}:switchover', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.restore = (params) => this._makeRequest('v1/{+parent}/clusters:restore', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.createsecondary = (params) => this._makeRequest('v1/{+parent}/clusters:createsecondary', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.list = (params) => this._makeRequest('v1/{+parent}/instances', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.create = (params) => this._makeRequest('v1/{+parent}/instances', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.createsecondary = (params) => this._makeRequest('v1/{+parent}/instances:createsecondary', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.failover = (params) => this._makeRequest('v1/{+name}:failover', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.injectFault = (params) => this._makeRequest('v1/{+name}:injectFault', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.restart = (params) => this._makeRequest('v1/{+name}:restart', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.instances.getConnectionInfo = (params) => this._makeRequest('v1/{+parent}/connectionInfo', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.users.list = (params) => this._makeRequest('v1/{+parent}/users', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.users.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.users.create = (params) => this._makeRequest('v1/{+parent}/users', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.users.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.clusters.users.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backups.create = (params) => this._makeRequest('v1/{+parent}/backups', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.backups.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.supportedDatabaseFlags.list = (params) => this._makeRequest('v1/{+parent}/supportedDatabaseFlags', 'GET', params);
  }
