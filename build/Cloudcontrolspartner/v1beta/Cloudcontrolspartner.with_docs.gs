...
class Cloudcontrolspartner {
  ...
  constructor(config = {}) {
     ...
     */
    this.organizations.locations.getPartner = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.list = (params) => this._makeRequest('v1beta/{+parent}/customers', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.create = (params) => this._makeRequest('v1beta/{+parent}/customers', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.list = (params) => this._makeRequest('v1beta/{+parent}/workloads', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.getEkmConnections = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.getPartnerPermissions = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.accessApprovalRequests.list = (params) => this._makeRequest('v1beta/{+parent}/accessApprovalRequests', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.violations.list = (params) => this._makeRequest('v1beta/{+parent}/violations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.customers.workloads.violations.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
  }
