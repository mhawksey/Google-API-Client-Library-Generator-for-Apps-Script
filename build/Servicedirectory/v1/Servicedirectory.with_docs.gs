...
class Servicedirectory {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.create = (params) => this._makeRequest('v1/{+parent}/namespaces', 'POST', params);

    /**
     * Lists all namespaces.
     * @param {string} params.filter - Optional. The filter to list results by. General `filter` string syntax: ` ()` * `` can be `name` or `labels.` for map field * `` can be `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:` means `HAS`, and is roughly the same as `=` * `` must be the same data type as field * `` can be `AND`, `OR`, `NOT` Examples of valid filters: * `labels.owner` returns namespaces that have a label with the key `owner`, this is the same as `labels:owner` * `labels.owner=sd` returns namespaces that have key/value `owner=sd` * `name>projects/my-project/locations/us-east1/namespaces/namespace-c` returns namespaces that have name that is alphabetically later than the string, so "namespace-e" is returned but "namespace-a" is not * `labels.owner!=sd AND labels.foo=bar` returns namespaces that have `owner` in label key but value is not `sd` AND have key/value `foo=bar` * `doesnotexist.foo=bar` returns an empty list. Note that namespace doesn't have a field called "doesnotexist". Since the filter does not match any namespaces, it returns no results For more information about filtering, see [API Filtering](https://aip.dev/160).
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.list = (params) => this._makeRequest('v1/{+parent}/namespaces', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.getIamPolicy = (params) => this._makeRequest('v1/{+resource}:getIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.setIamPolicy = (params) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.testIamPermissions = (params) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.resolve = (params) => this._makeRequest('v1/{+name}:resolve', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.create = (params) => this._makeRequest('v1/{+parent}/services', 'POST', params);

    /**
     * Lists all services belonging to a namespace.
     * @param {string} params.filter - Optional. The filter to list results by. General `filter` string syntax: ` ()` * `` can be `name` or `annotations.` for map field * `` can be `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:` means `HAS`, and is roughly the same as `=` * `` must be the same data type as field * `` can be `AND`, `OR`, `NOT` Examples of valid filters: * `annotations.owner` returns services that have a annotation with the key `owner`, this is the same as `annotations:owner` * `annotations.protocol=gRPC` returns services that have key/value `protocol=gRPC` * `name>projects/my-project/locations/us-east1/namespaces/my-namespace/services/service-c` returns services that have name that is alphabetically later than the string, so "service-e" is returned but "service-a" is not * `annotations.owner!=sd AND annotations.foo=bar` returns services that have `owner` in annotation key but value is not `sd` AND have key/value `foo=bar` * `doesnotexist.foo=bar` returns an empty list. Note that service doesn't have a field called "doesnotexist". Since the filter does not match any services, it returns no results For more information about filtering, see [API Filtering](https://aip.dev/160).
     * @param {string} params.orderBy - Optional. The order to list results by. General `order_by` string syntax: ` () (,)` * `` allows value: `name` * `` ascending or descending order by ``. If this is left blank, `asc` is used Note that an empty `order_by` string results in default order, which is order by `name` in ascending order.
     * @param {integer} params.pageSize - Optional. The maximum number of items to return.
     * @param {string} params.pageToken - Optional. The next_page_token value returned from a previous List request, if any.
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.list = (params) => this._makeRequest('v1/{+parent}/services', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.getIamPolicy = (params) => this._makeRequest('v1/{+resource}:getIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.setIamPolicy = (params) => this._makeRequest('v1/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.testIamPermissions = (params) => this._makeRequest('v1/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.endpoints.create = (params) => this._makeRequest('v1/{+parent}/endpoints', 'POST', params);

    /**
     * Lists all endpoints.
     * @param {string} params.filter - Optional. The filter to list results by. General `filter` string syntax: ` ()` * `` can be `name`, `address`, `port`, or `annotations.` for map field * `` can be `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:` means `HAS`, and is roughly the same as `=` * `` must be the same data type as field * `` can be `AND`, `OR`, `NOT` Examples of valid filters: * `annotations.owner` returns endpoints that have a annotation with the key `owner`, this is the same as `annotations:owner` * `annotations.protocol=gRPC` returns endpoints that have key/value `protocol=gRPC` * `address=192.108.1.105` returns endpoints that have this address * `port>8080` returns endpoints that have port number larger than 8080 * `name>projects/my-project/locations/us-east1/namespaces/my-namespace/services/my-service/endpoints/endpoint-c` returns endpoints that have name that is alphabetically later than the string, so "endpoint-e" is returned but "endpoint-a" is not * `annotations.owner!=sd AND annotations.foo=bar` returns endpoints that have `owner` in annotation key but value is not `sd` AND have key/value `foo=bar` * `doesnotexist.foo=bar` returns an empty list. Note that endpoint doesn't have a field called "doesnotexist". Since the filter does not match any endpoints, it returns no results For more information about filtering, see [API Filtering](https://aip.dev/160).
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.endpoints.list = (params) => this._makeRequest('v1/{+parent}/endpoints', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.endpoints.get = (params) => this._makeRequest('v1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.endpoints.patch = (params) => this._makeRequest('v1/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.namespaces.services.endpoints.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
  }
