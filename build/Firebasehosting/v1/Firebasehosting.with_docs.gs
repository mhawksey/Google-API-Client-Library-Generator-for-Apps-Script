...
class Firebasehosting {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.sites.customDomains.operations.delete = (params) => this._makeRequest('v1/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.sites.customDomains.operations.cancel = (params) => this._makeRequest('v1/{+name}:cancel', 'POST', params);
  }
