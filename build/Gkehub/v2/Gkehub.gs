...
class Gkehub {
  ...
  constructor(config = {}) {
    ...
    this.projects.locations.memberships.features.get = (params) => this._makeRequest('v2/{+name}', 'GET', params);
    this.projects.locations.memberships.features.list = (params) => this._makeRequest('v2/{+parent}/features', 'GET', params);
    this.projects.locations.memberships.features.create = (params) => this._makeRequest('v2/{+parent}/features', 'POST', params);
    this.projects.locations.memberships.features.delete = (params) => this._makeRequest('v2/{+name}', 'DELETE', params);
    this.projects.locations.memberships.features.patch = (params) => this._makeRequest('v2/{+name}', 'PATCH', params);
  }
