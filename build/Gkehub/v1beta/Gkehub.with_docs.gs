...
class Gkehub {
  ...
  constructor(config = {}) {
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.list = (params) => this._makeRequest('v1beta/{+parent}/memberships', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.create = (params) => this._makeRequest('v1beta/{+parent}/memberships', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.generateConnectManifest = (params) => this._makeRequest('v1beta/{+name}:generateConnectManifest', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.setIamPolicy = (params) => this._makeRequest('v1beta/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.getIamPolicy = (params) => this._makeRequest('v1beta/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.testIamPermissions = (params) => this._makeRequest('v1beta/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.bindings.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.bindings.create = (params) => this._makeRequest('v1beta/{+parent}/bindings', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.bindings.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.bindings.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.bindings.list = (params) => this._makeRequest('v1beta/{+parent}/bindings', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.rbacrolebindings.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.rbacrolebindings.create = (params) => this._makeRequest('v1beta/{+parent}/rbacrolebindings', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.rbacrolebindings.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.rbacrolebindings.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.rbacrolebindings.list = (params) => this._makeRequest('v1beta/{+parent}/rbacrolebindings', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.memberships.rbacrolebindings.generateMembershipRBACRoleBindingYAML = (params) => this._makeRequest('v1beta/{+parent}/rbacrolebindings:generateMembershipRBACRoleBindingYAML', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.listMemberships = (params) => this._makeRequest('v1beta/{+scopeName}:listMemberships', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.create = (params) => this._makeRequest('v1beta/{+parent}/scopes', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.list = (params) => this._makeRequest('v1beta/{+parent}/scopes', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.listPermitted = (params) => this._makeRequest('v1beta/{+parent}/scopes:listPermitted', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.setIamPolicy = (params) => this._makeRequest('v1beta/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.getIamPolicy = (params) => this._makeRequest('v1beta/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.testIamPermissions = (params) => this._makeRequest('v1beta/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.namespaces.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.namespaces.create = (params) => this._makeRequest('v1beta/{+parent}/namespaces', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.namespaces.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.namespaces.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.namespaces.list = (params) => this._makeRequest('v1beta/{+parent}/namespaces', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.rbacrolebindings.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.rbacrolebindings.create = (params) => this._makeRequest('v1beta/{+parent}/rbacrolebindings', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.rbacrolebindings.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.rbacrolebindings.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.scopes.rbacrolebindings.list = (params) => this._makeRequest('v1beta/{+parent}/rbacrolebindings', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.list = (params) => this._makeRequest('v1beta/{+parent}/features', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.create = (params) => this._makeRequest('v1beta/{+parent}/features', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.setIamPolicy = (params) => this._makeRequest('v1beta/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.getIamPolicy = (params) => this._makeRequest('v1beta/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.features.testIamPermissions = (params) => this._makeRequest('v1beta/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.fleets.create = (params) => this._makeRequest('v1beta/{+parent}/fleets', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.fleets.get = (params) => this._makeRequest('v1beta/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.fleets.patch = (params) => this._makeRequest('v1beta/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.fleets.delete = (params) => this._makeRequest('v1beta/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.fleets.list = (params) => this._makeRequest('v1beta/{+parent}/fleets', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.organizations.locations.fleets.list = (params) => this._makeRequest('v1beta/{+parent}/fleets', 'GET', params);
  }
