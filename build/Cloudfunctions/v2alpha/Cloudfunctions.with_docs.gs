...
class Cloudfunctions {
  ...
  constructor(config = {}) {
     ...
     */
    this.projects.locations.list = (params) => this._makeRequest('v2alpha/{+name}/locations', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.get = (params) => this._makeRequest('v2alpha/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.list = (params) => this._makeRequest('v2alpha/{+parent}/functions', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.create = (params) => this._makeRequest('v2alpha/{+parent}/functions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.patch = (params) => this._makeRequest('v2alpha/{+name}', 'PATCH', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.setupFunctionUpgradeConfig = (params) => this._makeRequest('v2alpha/{+name}:setupFunctionUpgradeConfig', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.abortFunctionUpgrade = (params) => this._makeRequest('v2alpha/{+name}:abortFunctionUpgrade', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.redirectFunctionUpgradeTraffic = (params) => this._makeRequest('v2alpha/{+name}:redirectFunctionUpgradeTraffic', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.rollbackFunctionUpgradeTraffic = (params) => this._makeRequest('v2alpha/{+name}:rollbackFunctionUpgradeTraffic', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.commitFunctionUpgrade = (params) => this._makeRequest('v2alpha/{+name}:commitFunctionUpgrade', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.delete = (params) => this._makeRequest('v2alpha/{+name}', 'DELETE', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.generateUploadUrl = (params) => this._makeRequest('v2alpha/{+parent}/functions:generateUploadUrl', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.generateDownloadUrl = (params) => this._makeRequest('v2alpha/{+name}:generateDownloadUrl', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.detachFunction = (params) => this._makeRequest('v2alpha/{+name}:detachFunction', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.setIamPolicy = (params) => this._makeRequest('v2alpha/{+resource}:setIamPolicy', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.getIamPolicy = (params) => this._makeRequest('v2alpha/{+resource}:getIamPolicy', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.functions.testIamPermissions = (params) => this._makeRequest('v2alpha/{+resource}:testIamPermissions', 'POST', params);
     ...
     * @return {object} The API response object.
     */
    this.projects.locations.runtimes.list = (params) => this._makeRequest('v2alpha/{+parent}/runtimes', 'GET', params);
  }
