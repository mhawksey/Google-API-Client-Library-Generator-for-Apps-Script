...
class Cloudasset {
  ...
  constructor(config = {}) {
     ...
     */
    this.operations.get = (params) => this._makeRequest('v1p7beta1/{+name}', 'GET', params);
     ...
     * @return {object} The API response object.
     */
    this.v1p7beta1.exportAssets = (params) => this._makeRequest('v1p7beta1/{+parent}:exportAssets', 'POST', params);
  }
